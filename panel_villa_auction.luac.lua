...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\auction\panel_villa_auction.luac 
...
Panel_Villa_Auction_ShowAni = function()
...
Panel_Villa_Auction_HideAni = function()
...
local Template = {BG = (UI.getChildControl)(Panel_Villa_Auction, "Template_Style_BG"), Area = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_Area"), Name = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_Name"), AucPrice = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_AucPrice"), MyPrice = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_MyPrice"), Edit_InGold = (UI.getChildControl)(Panel_Villa_Auction, "Template_Edit_InGold"), Btn_Cancel_Get = (UI.getChildControl)(Panel_Villa_Auction, "Template_Button_Cancel_Get"), Btn_Get = (UI.getChildControl)(Panel_Villa_Auction, "Template_Button_Get"), SpecialService = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_SpecialService"), RemainCount = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_RemainCount"), House_Image = (UI.getChildControl)(Panel_Villa_Auction, "Template_Static_Image"), Time = (UI.getChildControl)(Panel_Villa_Auction, "Template_StaticText_Time")}
local VillaAuction = {panelBG = (UI.getChildControl)(Panel_Villa_Auction, "Static_BackGround"), panelTitle = (UI.getChildControl)(Panel_Villa_Auction, "StaticText_Title"), btn_MyBidList = (UI.getChildControl)(Panel_Villa_Auction, "Button_MyBidList"), btn_Win_Close = (UI.getChildControl)(Panel_Villa_Auction, "Button_Win_Close"), btn_Question = (UI.getChildControl)(Panel_Villa_Auction, "Button_Question"), btn_Page_Prv = (UI.getChildControl)(Panel_Villa_Auction, "Button_List_Left"), btn_Page_Next = (UI.getChildControl)(Panel_Villa_Auction, "Button_List_Right"), nowPage = (UI.getChildControl)(Panel_Villa_Auction, "StaticText_List"), auctionGuideBG = (UI.getChildControl)(Panel_Villa_Auction, "Static_BottomNoticeBG"), auctionGuide = (UI.getChildControl)(Panel_Villa_Auction, "StaticText_AutionGuide"), btn_myBidList = (UI.getChildControl)(Panel_Villa_Auction, "Button_MyBidList"), 
auctionHouseDescFrame = {}
}
VillaAuction_InitControl = function()
  -- function num : 0_2 , upvalues : VillaAuction
...
HandleClicked_VillaAuctionPageChange = function()
  -- function num : 0_4 , upvalues : VillaAuctionManager, VillaAuction
  ...
  if auctionType == 14 then
    RequestBiddingPage()
    ;
    (VillaAuction.panelTitle):SetText("�\180 빌라 입찰 목록")
  else
...
HandleClickedAuctionPrevButtonVilla = function()
  -- function num : 0_5 , upvalues : VillaAuctionManager
  for key,value in pairs(VillaAuctionManager._houseAuctionList) do
    (value._editInGold):SetEditText("", true)
  end
  ClearFocusEdit()
...
HandleClickedAuctionNextButton = function()
  -- function num : 0_6 , upvalues : VillaAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
...
FGlobal_VillaAuctionWindow_Hide = function()
  -- function num : 0_7
...
FGlobal_VillaAuctionWindow_Show = function()
  -- function num : 0_8
  local isShow = Panel_Villa_Auction:IsShow()
...
VillaAuctionManager.initialize = function(self)
  -- function num : 0_9 , upvalues : maxYCount, maxXCount, Template, sizeX, startX, gapX, sizeY, startY, gapY, VillaAuction
  for y = 0, maxYCount - 1 do
    for x = 0, maxXCount - 1 do
      ...
      -- DECOMPILER ERROR at PC347: Confused about usage of register: R11 in 'UnsetPending'
...
HandleClickedAuctionBidVilla = function(index)
  -- function num : 0_10 , upvalues : VillaAuctionManager
...
VillaAuctionManager.updateHouseList = function(self)
  -- function num : 0_11 , upvalues : VillaAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
  local houseCount = myAuctionInfo:getHouseAuctionListCount()
  for index = 0, 3 do
...
VillaAuctionManager.setHouseData = function(self, index)
  -- function num : 0_12 , upvalues : auctionDisplayTime, UI_TM, VillaAuction
  local myAuctionInfo = RequestGetAuctionInfo()
...
VillaAuctionManager.updateBidList = function(self)
  -- function num : 0_13 , upvalues : VillaAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
...
VillaAuctionManager.setBidData = function(self, index)
  -- function num : 0_14 , upvalues : auctionDisplayTime, UI_TM, VillaAuction
  local myAuctionInfo = RequestGetAuctionInfo()
...
FromClient_ResponseAuction_UpdateVillaAuctionList = function()
  -- function num : 0_16 , upvalues : VillaAuction, VillaAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
  local auctionType = myAuctionInfo:getAuctionType()
...
FGlobal_VillaAuctionUpdate = function()
  -- function num : 0_17 , upvalues : VillaAuctionManager
  VillaAuctionManager:updateHouseList()
end
