...
local _classButtonUV = {
  [eClassType.ClassType_Warrior] = {
    x1 = 2,
    y1 = 1,
    x2 = 362,
    y2 = 84
  },
  [eClassType.ClassType_Ranger] = {
    x1 = 2,
    y1 = 169,
    x2 = 362,
    y2 = 252
  },
  [eClassType.ClassType_Sorcerer] = {
    x1 = 2,
    y1 = 85,
    x2 = 362,
    y2 = 168
  },
  [eClassType.ClassType_Giant] = {
    x1 = 2,
    y1 = 253,
    x2 = 362,
    y2 = 336
  },
  [eClassType.ClassType_Tamer] = {
    x1 = 2,
    y1 = 505,
    x2 = 362,
    y2 = 588
  },
  [eClassType.ClassType_WizardWomen] = {
    x1 = 2,
    y1 = 337,
    x2 = 362,
    y2 = 420
  },
  [eClassType.ClassType_Wizard] = {
    x1 = 2,
    y1 = 421,
    x2 = 362,
    y2 = 504
...
function ClassSelect:open()
  ...
  _panel:SetShow(true)
  InputMLUp_ClassSelect_SelectClassType(eClassType.ClassType_Warrior)
  for classIdx = 0, count - 1 do
    classType = getPossibleClassTypeFromIndex(classIdx)
    if nil ~= self:getClassButtonData(classType) then
...
function ClassSelect:getClassButtonData(classType)
  ...
  elseif classType == eClassType.ClassType_Tamer then
    ...
    buttonData.mainWeaponType = "Rapier"
    buttonData.subWeaponType = "Norigae"
    buttonData.manaType = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_CLASSSELECT_MPTYPE_MP")
