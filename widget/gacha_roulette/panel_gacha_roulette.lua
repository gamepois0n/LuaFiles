...
function gacha_Roulette:Initialize()
  ...
  self.bottomDesc:setPadding(UI_PD.ePadding_Left, 12)
  self.bottomDesc:setPadding(UI_PD.ePadding_Right, 12)
  self.bottomDesc:setPadding(UI_PD.ePadding_Top, 15)
  self.bottomDesc:setPadding(UI_PD.ePadding_Bottom, 15)
  ...
  Panel_RandomBoxSelect:SetSize(Panel_RandomBoxSelect:GetSizeX(), self.bottomDesc:GetTextSizeY() + 257)
