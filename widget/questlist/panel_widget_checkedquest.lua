...
local checkedQuestWidget = {
  _ui = {
    _static_GroupBG = UI.getChildControl(Panel_CheckedQuest, "Static_GroupBG"),
    _static_TitleBG = UI.getChildControl(Panel_CheckedQuest, "Static_TitleBG"),
    _staticText_Quest_Title = UI.getChildControl(Panel_CheckedQuest, "StaticText_Quest_Title"),
    _static_Eff_Complete_Eff1 = UI.getChildControl(Panel_CheckedQuest, "Static_Eff_Complete_Eff1"),
    _static_Quest_Type = UI.getChildControl(Panel_CheckedQuest, "Static_Quest_Type"),
    _staticText_WidgetGroupTitle = UI.getChildControl(Panel_CheckedQuest, "StaticText_WidgetGroupTitle"),
    _staticText_Quest_ClearNpc = UI.getChildControl(Panel_CheckedQuest, "StaticText_Quest_ClearNpc"),
    _staticText_Quest_Demand = UI.getChildControl(Panel_CheckedQuest, "StaticText_Quest_Demand"),
    _button_Hide = UI.getChildControl(Panel_CheckedQuest, "Checkbox_Quest_Hide"),
    _button_Quest_Giveup = UI.getChildControl(Panel_CheckedQuest, "Button_Quest_Giveup"),
    _checkbox_Quest_Navi = UI.getChildControl(Panel_CheckedQuest, "Checkbox_Quest_Navi"),
    _checkButton_AutoNavi = UI.getChildControl(Panel_CheckedQuest, "CheckButton_AutoNavi"),
    _button_Reward = UI.getChildControl(Panel_CheckedQuest, "Button_Reward"),
    _button_WantGuild = UI.getChildControl(Panel_CheckedQuest, "Button_WantGuild"),
    _button_Size = UI.getChildControl(Panel_CheckedQuest, "Button_Size"),
...
function checkedQuestWidget:initControl()
  ...
  for index = 0, self._config._maxQuestListCnt - 1 do
    ...
    elements._uiQuestIcon = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Static_Quest_Type", elements._uiGroupBG, "uiQuestIcon_" .. index)
    elements._uiCompleteNpc = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "StaticText_Quest_ClearNpc", elements._uiGroupBG, "uiCompleteNpc_" .. index)
    elements._uiCompleteEff = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Static_Eff_Complete_Eff1", elements._uiGroupBG, "uiCompleteEff_" .. index)
    elements._uiHideBtn = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Checkbox_Quest_Hide", elements._uiGroupBG, "uiCompleteBtn_" .. index)
    elements._uiAutoNaviBtn = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "CheckButton_AutoNavi", elements._uiGroupBG, "uiAutoNaviBtn_" .. index)
    elements._uiNaviBtn = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Checkbox_Quest_Navi", elements._uiGroupBG, "uiNaviBtn_" .. index)
    elements._uiGiveupBtn = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Button_Quest_Giveup", elements._uiGroupBG, "uiGiveupBtn_" .. index)
    elements._uiRewardBtn = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "Button_Reward", elements._uiGroupBG, "uiRewardBtn_" .. index)
    elements._questNo = {_groupId = 0, _questId = 0}
    elements._uiConditions = Array.new()
    for jj = 0, self._config._maxConditionCnt - 1 do
      elements._uiConditions[jj] = UI.createAndCopyBasePropertyControl(Panel_CheckedQuest, "StaticText_Quest_Demand", elements._uiGroupBG, "uiConditions_" .. index .. "_" .. jj)
...
function checkedQuestPanel_Init()
  ...
  if not haveServerPosotion then
    Panel_CheckedQuest:SetSize(Panel_CheckedQuest:GetSizeX(), 350)
    local newEquipGap = 0
    local posY = 0
...
function checkedQuestWidget:ProgressQuest(uiQuestInfo, isSingle, groupTitle, questGroupCount, questGroupIndex, questType)
  ...
  if not uiQuestInfo:isSatisfied() then
    questData.state = self._config._questState._progressing
  else
    questData.state = self._config._questState._complete
  end
...
function checkedQuestWidget:setQuestTitle(control, string, state)
  ...
  if state == self._config._questState._complete then
    ...
    if state == self._config._questState._acceptable then
...
function checkedQuestWidget:handleClicked_QuestWidgetPanelResize()
  ...
  if getScreenSizeY() - 50 < Panel_CheckedQuest:GetPosY() + Panel_CheckedQuest:GetSizeY() then
    Panel_CheckedQuest:SetSize(panelSizeX, getScreenSizeY() - 50 - Panel_CheckedQuest:GetPosY())
  end
