...
function raidParty:ClickButtonAction(index)
  ...
  self._ui._btn_Exile:SetPosX(self._uiPartyMemberList[index]._actionBtn:GetPosX() + 30 + gapX)
  self._ui._btn_Exit:SetPosX(self._uiPartyMemberList[index]._actionBtn:GetPosX() + 30 + gapX)
  self._ui._btn_Mandate:SetPosY((index - 1) % 10 * (self._ui._static_PartyBG:GetSizeY() + 11))
  self._ui._btn_Exile:SetPosY((index - 1) % 10 * (self._ui._static_PartyBG:GetSizeY() + 40))
  self._ui._btn_Exit:SetPosY((index - 1) % 10 * (self._ui._static_PartyBG:GetSizeY() + 11))
