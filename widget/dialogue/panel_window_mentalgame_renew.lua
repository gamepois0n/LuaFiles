local Window_MentalGameInfo = {
  _ui = {
    ...
    _bottom = {},
    _tooltip = {
      _static_Bg = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "Static_Tooltip_BG"),
      _staitcText_NpcName = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_NPC_Name"),
      _staticText_StatusTitle = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_StatusTitle"),
      _staticText_HitBase = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_Hit_Base"),
      _staticText_HitBonus = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_Hit_Bonus"),
      _staticText_DDBase = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_DD_Base"),
      _staticText_DDBonus = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_DD_Bonus"),
      _staticText_InterestComment = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_Comment_1"),
      _staticText_FavorityComment = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_Comment_2"),
      _staticText_Bonus = UI.getChildControl(Panel_Window_MentalGame_Tooltip, "StaticText_Bonus")
    },
    _static_Zodiac = {}
  },
  _config = {
...
function PaGlobalFunc_MentalGame_LClick_ReStart()
  local self = Window_MentalGameInfo
  self._gameStep = 0
...
function Window_MentalGameInfo:InitContorl()
...
function Window_MentalGameInfo:UpdateStageByStep()
  ...
  if self._config._gameStep_CardSelect == self._gameStep then
    ...
    self._ui._button_Select:addInputEvent("Mouse_LUp", "PaGlobalFunc_MentalGame_LClick_SlectCard()")
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_Y, "PaGlobalFunc_MentalGame_SelectClear()")
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_X, "")
  ...
  elseif self._config._gameStep_ReadyGame == self._gameStep then
    ...
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_X, "PaGlobalFunc_MentalGame_LClick_StartGame()")
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_Y, "PaGlobalFunc_MentalGame_SelectClear()")
    self._ui._top._staticText_CommentDesc:SetShow(true)
  ...
  elseif self._config._gameStep_StartGame == self._gameStep then
    ...
    self._ui._top._staticText_CommentDesc:SetShow(true)
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_Y, "")
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_X, "")
  ...
  elseif self._config._gameStep_EndGame == self._gameStep then
    ...
    self._ui._button_Back:SetShow(true)
    self._ui._button_Select:SetShow(mentalStage._isSuccess and playableNextGame)
    ...
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_X, "PaGlobalFunc_MentalGame_LClick_ReStart()")
    Panel_Window_MentalGame:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_Y, "")
