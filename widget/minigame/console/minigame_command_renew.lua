...
local checkIcon = UI.getChildControl(Panel_Command, "Static_Check_Icon")
local checkIconList = {}
...
function MiniGame_Command_keyPress(keyType)
  ...
  if commands[currentCommandIndex] == keyType then
    ...
    checkIconList[currentCommandIndex]:SetPosY(textControl:GetPosY() + (textControl:GetSizeY() + 5) - checkIconList[currentCommandIndex]:GetSizeY() / 2)
