...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\servant\guildstable\panel_window_guildstablelist.luac 
...
GuildStableListShowAni = function()
...
GuildStableListHideAni = function()
...
, slotCount = 4}
, _staticListBG = (UI.getChildControl)(Panel_Window_GuildStable_List, "Static_ListBG"), _staticButtonListBG = (UI.getChildControl)(Panel_Window_GuildStable_List, "Static_PopupBG"), _staticNotice = (UI.getChildControl)(Panel_Window_GuildStable_List, "StaticText_Notice"), _staticSlotCount = (UI.getChildControl)(Panel_Window_GuildStable_List, "StaticText_Slot_Count"), _scroll = (UI.getChildControl)(Panel_Window_GuildStable_List, "Scroll_Slot_List"), _slots = (Array.new)(), _selectSlotNo = nil, _startSlotIndex = 0, _selectSceneIndex = -1, 
_unseal = {}
, 
_taming = {}
, _servantMaxLevel = 30}
local sellCheck = true
guildStableList.init = function(self)
  -- function num : 0_2
...
guildStableList.clear = function(self)
  -- function num : 0_3
  self._selectSlotNo = nil
  self._startSlotIndex = 0
end

guildStableList.update = function(self)
  -- function num : 0_4 , upvalues : guildStableList
    ...
    for ii = self._startSlotIndex, servantCount - 1 do
      ...
      if servantInfo ~= nil then
        ...
        if slotNo <= (self._config).slotCount - 1 then
          ...
          if servantInfo:getHp() == 0 and ((CppEnums.VehicleType).Type_Elephant == vehicleType or (CppEnums.VehicleType).Type_Train == vehicleType) then
...
FGlobal_GuildStableList_CloseTamingBg = function()
  -- function num : 0_5 , upvalues : guildStableList
  local self = guildStableList
  ;
  ((self._taming)._bg):SetShow(false)
end

guildStableList.registEventHandler = function(self)
  -- function num : 0_6
...
guildStableList.registMessageHandler = function(self)
  -- function num : 0_7
...
GuildStableList_Resize = function()
  -- function num : 0_8 , upvalues : guildStableList
...
GuildStableList_ButtonOpen = function(eType, slotNo)
  -- function num : 0_9 , upvalues : guildStableList
...
GuildStableList_ButtonClose = function()
  -- function num : 0_10 , upvalues : guildStableList
  local self = guildStableList
...
GuildStableList_SlotSelect = function(slotNo)
  -- function num : 0_11 , upvalues : guildStableList
  local self = guildStableList
  if slotNo == nil then
    return 
  end
...
GuildStableList_Seal = function(isCompulsion)
  -- function num : 0_12 , upvalues : guildStableList
  local self = guildStableList
...
GuildStableList_Unseal = function()
  -- function num : 0_13 , upvalues : guildStableList
  local self = guildStableList
  GuildStableList_ButtonClose()
  audioPostEvent_SystemUi(0, 0)
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
...
GuildStableList_RecoveryUnseal = function()
  -- function num : 0_14 , upvalues : guildStableList
  GuildStableList_ButtonClose()
...
GuildStableList_Recovery = function()
  -- function num : 0_15
  GuildStableList_ButtonClose()
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
  if servantInfo == nil then
  ...
  local GuildStableList_RecoveryXXX = function()
    -- function num : 0_15_0 , upvalues : servantInfo
  ...
  local GuildStableList_ReviveXXX = function()
    -- function num : 0_15_1 , upvalues : servantInfo
    audioPostEvent_SystemUi(5, 7)
...
GuildStableList_Release = function()
  -- function num : 0_16 , upvalues : servantInvenAlert
  GuildStableList_ButtonClose()
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
  if servantInfo == nil then
    return 
...
GuildStableList_ReleaseXXX = function()
  -- function num : 0_17 , upvalues : sellCheck
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
  if servantInfo == nil then
    return 
  end
...
GuildStableList_Injury = function()
  -- function num : 0_18
  GuildStableList_ButtonClose()
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
  if servantInfo == nil then
...
GuildStableList_InjuryXXX = function()
  -- function num : 0_19
  local servantInfo = guildStable_getServant(GuildStableList_SelectSlotNo())
  if servantInfo == nil then
    return 
...
GuildStableList_RegisterCancel = function()
  -- function num : 0_20
  GuildStableList_ButtonClose()
  GuildStableMating_Cancel(GuildStableList_SelectSlotNo())
end

FGlobal_GuildStableList_Update = function()
  -- function num : 0_21 , upvalues : guildStableList
  guildStableList:update()
end

GuildStableList_SelectSlotNo = function()
  -- function num : 0_22 , upvalues : guildStableList
  local self = guildStableList
  return GuildStable_SortByWayPointKey(self._selectSlotNo)
end

GuildStableList_ScrollEvent = function(isScrollUp)
  -- function num : 0_23 , upvalues : guildStableList
  local self = guildStableList
...
GuildStable_SlotSound = function(slotNo)
  -- function num : 0_24
...
GuildStable_WindowOpenCheck = function()
  -- function num : 0_25
...
GuildStableList_RegisterFromTaming = function()
  -- function num : 0_26
  GuildStableList_ButtonClose()
  audioPostEvent_SystemUi(0, 0)
...
GuildStable_SortDataupdate = function()
  ...
  local sortByTerritory = function(territoryKey)
    -- function num : 0_28_2 , upvalues : maxStableServantCount, affiliatedTerritory, sortByExploreKey, temp, sIndex
  ...
  for i = 1, maxStableServantCount do
    -- DECOMPILER ERROR at PC182: Confused about usage of register: R15 in 'UnsetPending'

    sortByExploreKey[i] = temp[i - 1]
  end
end

GuildStable_SortByWayPointKey = function(index)
...
GuildStableList_UpdateSlotData = function()
  -- function num : 0_30 , upvalues : guildStableList
  ...
  if GuildStableList_SelectSlotNo() == nil then
...
GuildStableList_PopMessageBox = function(possibleTime_s64)
  -- function num : 0_31
...
GuildStableList_ServantToReward = function(servantNo, servantWhereType)
  -- function num : 0_32 , upvalues : UI_SW
  if not Panel_Window_GuildStable_List:GetShow() then
    return 
  end
...
GuildStableList_ServantUnseal = function(servantNo, servantWhereType)
  -- function num : 0_33 , upvalues : UI_SW
...
GuildStableList_ServantSeal = function(servantNo, regionKey, servantWhereType)
  -- function num : 0_34 , upvalues : guildStableList, UI_SW
  local self = guildStableList
  if UI_SW.ServantWhereTypeGuild ~= servantWhereType then
    return 
  end
...
GuildStableList_ServantRecovery = function(servantNo, servantWhereType)
  -- function num : 0_35 , upvalues : UI_SW
  if UI_SW.ServantWhereTypeGuild ~= servantWhereType then
    return 
  end
  GuildStableList_UpdateSlotData()
...
GuildStableList_Open = function()
  -- function num : 0_36 , upvalues : guildStableList
  local self = guildStableList
  self:clear()
  self:update()
  ;
...
GuildStableList_Close = function()
  -- function num : 0_37 , upvalues : guildStableList
  if not Panel_Window_GuildStable_List:GetShow() then
    return 
  end
  local self = guildStableList
