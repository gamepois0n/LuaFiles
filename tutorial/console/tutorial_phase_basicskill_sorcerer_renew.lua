...
function PaGlobal_TutorialPhase_BasicSkill_Sorcerer:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Socceror_0_Combo_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_SOCCEROR_1"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_07"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_SOCCEROR_3"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_Sorcerer:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_SORCERER_COMBO_1_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_SOCCEROR_2"))
end
