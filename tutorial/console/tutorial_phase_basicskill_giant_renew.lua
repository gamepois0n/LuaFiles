...
function PaGlobal_TutorialPhase_BasicSkill_Giant:changeStepTryBasicSkill()
  ...
  elseif 3 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "NEW_TUTORIAL_COMBO_05"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_GIANT_2"))
  elseif 4 == self._currentProgress then
    ...
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setTextPurposeText(PAGetString(Defines.StringSheet_GAME, "TUTORIAL_PURPOSE_BATTLE_STEP7") .. " ( " .. self._usedSkillCount .. " / " .. self._totalSkillCount .. " )", "")
    PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(self._currentProgress, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_COMBO_Giant_0_Combo_1"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_GIANT_1"))
  end
end
...
function PaGlobal_TutorialPhase_BasicSkill_Giant:changeStepTrySkillCombo()
  ...
  PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(1, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_GIANT_COMBO_0_2"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_GIANT_3"))
end
...
function PaGlobal_TutorialPhase_BasicSkill_Giant:eventCallUsedSkill_TrySkillCombo(skillWrapper)
  ...
  for key, value in pairs(self._skillNoList[listNo]) do
    if skillNo == value then
      ...
      PaGlobal_TutorialUiManager:getUiHeadlineMessage():setSkillText(2, PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIAL_BASECOMBO_GIANT_COMBO_1_3"), PAGetString(Defines.StringSheet_GAME, "LUA_TUTORIALXB_BASESKILLTUTORIAL_GIANT_4"))
