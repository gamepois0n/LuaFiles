...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\minigame\minigame_drag.luac 
...
local ui = {_dragPattern = (UI.getChildControl)(Panel_MiniGame_Drag, "Static_BarPattern"), _arrowBG = (UI.getChildControl)(Panel_MiniGame_Drag, "Static_ArrowBG"), _arrow = (UI.getChildControl)(Panel_MiniGame_Drag, "Static_Arrow"), _arrowHelpText = (UI.getChildControl)(Panel_MiniGame_Drag, "StaticText_ArrowHelp"), _cursor = (UI.getChildControl)(Panel_MiniGame_Drag, "Static_DragCursor"), _nowResult = (UI.getChildControl)(Panel_MiniGame_Drag, "Static_NowResult"), _purposeText = (UI.getChildControl)(Panel_MiniGame_Drag, "StaticText_Purpose"), _resultText = (UI.getChildControl)(Panel_MiniGame_Drag, "StaticText_Result")}
local arrowDirection = {[0] = nil, 
...
local randomPattern = {[0] = nil, 
[1] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_00.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[2] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_01.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[3] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_02.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[4] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_03.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[5] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_04.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[6] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_05.dds", x = 512, y = 256, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
, 
[7] = {texture = "New_UI_Common_forLua/Widget/Instance/DragGame_Bar/MiniGame_DragBar_06.dds", x = 128, y = 512, 
PathList = {float3(0, 0, 0), float3(100, 100, 0)}
, 
disList = {}
}
...
local calcAllDistance = function()
  -- function num : 0_1 , upvalues : randomPattern, getSize
  for index = 1, 7 do
...
local init = function()
  -- function num : 0_2 , upvalues : calcAllDistance
  Panel_MiniGame_Drag:SetShow(false, false)
...
local mouseAreaCheck = function()
  -- function num : 0_3 , upvalues : ui, cursorAreaLength, cursorCheckSize
...
ScreenSize_RePosition_DragGame = function()
  -- function num : 0_4
...
local movePass = function(deltaTime)
  -- function num : 0_5 , upvalues : currentDistance, randomPattern, randValue, currentIndex, ui
...
Panel_Minigame_Drag_PerFrame = function(deltaTime)
  -- function num : 0_6 , upvalues : playMode, movePass, isSuccess, mouseAreaCheck
  if playMode == 1 then
    movePass(deltaTime)
...
Panel_Minigame_Drag_Start = function()
  -- function num : 0_7 , upvalues : playMode, currentDistance, currentIndex, randValue, _math_random, randomPattern, ui
...
Panel_Minigame_Drag_End_UI = function(deltaTime)
  -- function num : 0_8 , upvalues : sumTime
...
Panel_Minigame_Drag_End = function()
  -- function num : 0_9
  Panel_MiniGame_Drag:SetShow(false, false)
end
