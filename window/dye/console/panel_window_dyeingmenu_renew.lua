...
function DyeingMenu:browseMenu(rootIndex, subIndex)
  ...
  if nil ~= subIndex then
    ...
    self._ui.txt_keyGuideA:SetPosX(rdo:GetParentPosX() + rdo:GetTextSizeX() + rdo:GetTextSpan().x + 10)
    self._ui.txt_keyGuideA:SetPosY(rdo:GetParentPosY() + rdo:GetSizeY() / 2 - self._ui.txt_keyGuideA:GetSizeY() / 2)
  else
