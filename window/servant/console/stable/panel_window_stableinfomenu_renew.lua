...
function Panel_Window_StableInfo_Menu_info:childControl()
  ...
  self._pos.buttonSizeY = self._ui.radioButton_Template:GetSizeY()
end
...
function Panel_Window_StableInfo_Menu_info:setBgSize()
  local newSizeY = self._value.currentButtonCount * (self._pos.buttonSizeY + self._pos.buttonSpaceY) + self._pos.startPosY * 2
