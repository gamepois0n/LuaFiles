...
function Slot:init(index, control)
  ...
  local receiveReturnButton = UI.getChildControl(control, "Button_HorseReturn")
...
function Slot:update(info, tabType)
  ...
  local showBuyRentFlag = CppEnums.AuctionTabType.AuctionTab_ServantRent == tabType
  local showBuyReturnFlag = CppEnums.AuctionTabType.AuctionTab_ServantReturn == tabType
  local showCancelRentFlag = info and CppEnums.AuctionTabType.AuctionTab_MyServantRent == tabType
  local showCancelReturnFlag = info and CppEnums.AuctionTabType.AuctionTab_MyServantReturn == tabType
  local showReceiveRentFlag = not info and CppEnums.AuctionTabType.AuctionTab_MyServantRent == tabType
  local showReceiveReturnFlag = not info and CppEnums.AuctionTabType.AuctionTab_MyServantReturn == tabType
  self._ui.buyRentButton:SetShow(showBuyRentFlag)
  self._ui.buyReturnButton:SetShow(showBuyReturnFlag)
  self._ui.cancelRentButton:SetShow(showCancelRentFlag)
  self._ui.receiveRentButton:SetShow(showReceiveRentFlag)
  self._ui.receiveReturnButton:SetShow(showReceiveReturnFlag)
end
...
function ServantRentPromoteMarket:open()
  ...
  return self:changeTabType(CppEnums.AuctionTabType.AuctionTab_ServantRent)
end
...
function ServantRentPromoteMarket:buyRent(slotIndex)
  ...
  MessageBox.showMessageBox({
    ...
    content = PAGetString(Defines.StringSheet_GAME, "LUA_STABLE_BUY_NOTIFY"),
...
function ServantRentPromoteMarket:receiveRent(slotIndex)
  ...
  local fromWhereType = self._useInventoryMoneyFlag and CppEnums.ItemWhereType.eInventory or CppEnums.ItemWhereType.eWarehouse
  stable_popServantPrice(goodsIndex, CppEnums.AuctionType.AuctionGoods_ServantRent, toWhereType)
end
...
function ServantRentPromoteMarket:receiveReturn(slotIndex)
  ...
  local fromWhereType = self._useInventoryMoneyFlag and CppEnums.ItemWhereType.eInventory or CppEnums.ItemWhereType.eWarehouse
  stable_popServantPrice(goodsIndex, CppEnums.AuctionType.AuctionGoods_ServantReturn, toWhereType)
end
