...
function workerManager:initContorl()
  ...
  workerManagerUI._pcUI._button_Restore = UI.getChildControl(workerManagerUI._static_ButtonBg, "Button_Restore")
  workerManagerUI._pcUI._button_Redo = UI.getChildControl(workerManagerUI._static_ButtonBg, "Button_Redo")
  workerManagerUI._pcUI._button_DoFire = UI.getChildControl(workerManagerUI._static_ButtonBg, "Button_DoFire")
  workerManagerUI._pcUI._button_ChangeSkill = UI.getChildControl(workerManagerUI._static_ButtonBg, "Button_ChangeSkill")
  workerManagerUI._pcUI._button_Upgrade = UI.getChildControl(workerManagerUI._static_ButtonBg, "Button_Upgrade")
  workerManagerUI._static_WorkerImage = UI.getChildControl(workerManagerUI._static_WorkerInformationBg, "Static_WorkerImage")
  ...
  workerManagerUI._xboxUI._staticText_AllRedo1_ConsoleUI = UI.getChildControl(workerManagerUI._static_BottomBg, "StaticText_AllRedo1_ConsoleUI")
  workerManagerUI._xboxUI._staticText_AllRedo2_ConsoleUI = UI.getChildControl(workerManagerUI._static_BottomBg, "StaticText_AllRedo2_ConsoleUI")
  workerManagerUI._xboxUI._staticText_AllRedo3_ConsoleUI = UI.getChildControl(workerManagerUI._static_BottomBg, "StaticText_AllRedo3_ConsoleUI")
