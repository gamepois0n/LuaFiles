...
local function workerManager_Initiallize()
  ...
  for slotIdx = 0, self.slotMaxCount - 1 do
    ...
    tempSlot.workerNodeName:SetPosX(155)
    tempSlot.workerNodeName:SetPosY(5)
    tempSlot.workerHpBG:SetPosX(5)
    tempSlot.workerHpBG:SetPosY(54)
    tempSlot.workerRestorePT:SetPosX(5)
    tempSlot.workerRestorePT:SetPosY(54)
    tempSlot.workerCurrentPT:SetPosX(5)
    tempSlot.workerCurrentPT:SetPosY(54)
    tempSlot.APValue:SetPosX(12)
    tempSlot.APValue:SetPosY(46)
    tempSlot.progressBg:SetPosX(83)
    tempSlot.progressBg:SetPosY(56)
    tempSlot.progress:SetPosX(84)
    tempSlot.progress:SetPosY(57)
    tempSlot.workingName:SetPosX(84)
    tempSlot.workingName:SetPosY(30)
    tempSlot.btn_Restore:SetPosX(tempSlot.progressBg:GetPosX() + tempSlot.progressBg:GetSizeX() + 15)
    tempSlot.btn_Restore:SetPosY(5)
    tempSlot.btn_Repeat:SetPosX(334)
    tempSlot.btn_Repeat:SetPosY(30)
    tempSlot.btn_ReloadIcon:SetPosX(337)
    tempSlot.btn_ReloadIcon:SetPosY(33)
    ...
    tempSlot.btn_Stop:SetPosY(tempSlot.btn_UnRepeat:GetPosY() - 11)
