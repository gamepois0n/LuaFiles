...
function ExtractCrystal:initialize()
  ...
  self._ui.txt_keyGuideExtract = UI.getChildControl(self._ui.stc_group, "StaticText_Extract_ConsoleUI")
  self._ui.txt_keyGuideRemove = UI.getChildControl(self._ui.stc_group, "StaticText_Remove_ConsoleUI")
end
...
function ExtractCrystal:updateHighlightPos()
  self._ui.stc_focusBox:SetPosY((self._currentIndex - 1) * 130 + 38)
