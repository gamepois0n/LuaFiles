...
function PaGlobal_Option._elements.ConsolePadKeyType:get(wrapper)
  return wrapper:getConsoleKeyType()
end
...
function PaGlobal_Option._elements.GammaValue:get(wrapper)
  return PaGlobal_Option:FromRealValueToSliderValue(wrapper:getGammaValue(), 0, 1)
end
...
function PaGlobal_Option._elements.ColorBlind:get(wrapper)
  return ToClient_getGameUIManagerWrapper():getLuaCacheDataListNumber(CppEnums.GlobalUIOptionType.ColorBlindMode)
end
