...
function InventoryPopup:registEventHandler()
  self._ui.stc_BG:addInputEvent("Mouse_Out", "PaGlobalFunc_InventoryPopup_CheckMouseAndClose()")
  _panel:registerPadUpEvent(__eCONSOLE_UI_INPUT_TYPE_B, "PaGlobalFunc_InventoryPopup_Close")
end
function PaGlobalFunc_InventoryPopup_Open(option, posX, posY)
...
function InventoryPopup:setPosition(posX, posY)
...
function PaGlobalFunc_InventoryPopup_ProcessFunc(index)
...
function PaGlobalFunc_InventoryPopup_CheckMouseAndClose()
...
function PaGlobalFunc_InventoryPopup_IsOpened()
end
function PaGlobalFunc_InventoryPopup_Close()
