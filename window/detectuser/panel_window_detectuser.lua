...
function PaGlobalFunc_DetectUser_Req()
  ...
  self._state = 1
  ToClient_DetectUser(self._ui._edit_UserNickName:GetEditText(), self._fromWhereType, self._fromSlotNo)
end
...
function PaGlobalFunc_DetectUser_Update(deltaTime)
  ...
  elseif self._curSec > 2 and 3 == self._state then
    ...
    if 0 ~= rv then
      Proc_ShowMessage_Ack("\235\132\136\235\172\180 \234\176\128\234\185\157\234\177\176\235\130\152, \234\184\184\236\176\190\234\184\176\234\176\128 \235\144\152\236\167\128 \236\149\138\235\138\148 \236\167\128\236\151\173\236\151\144 \236\158\136\236\138\181\235\139\136\235\139\164.")
    end
