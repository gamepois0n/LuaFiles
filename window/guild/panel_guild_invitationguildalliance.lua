...
function PaGlobal_Guild_InvitationGuildAlliance:initialize()
  ...
  for ii = 0, 9 do
    ...
    self._ui.guildName[ii]:SetPosX(self._listConfig.startX + 50)
    ...
    self._ui.guildLimitMemberCount[ii]:SetPosX(self._listConfig.startX + 190)
    ...
    self._ui.guildtaxRate[ii]:SetPosX(self._listConfig.startX + 270)
