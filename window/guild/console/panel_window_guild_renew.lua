...
function GuildMain:init()
  ...
  self._ui.txt_GuildMark = UI.getChildControl(self._ui.stc_InfoBg, "StaticText_GuildMark")
...
function FromClient_GuildMain_ResponseGuildUpdate()
...
function FromClient_GuildMain_ResponseUpdateGuildContract(notifyType, userNickName, characterName, strParam1, strParam2, s64_param1, s64_param2, s64_param3)
  ...
  FromClient_GuildMain_ResponseGuildUpdate()
end
