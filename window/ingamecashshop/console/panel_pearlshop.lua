...
function pearlShop:showDescXXX(index)
  ...
  UI.getChildControl(control, "Button_XboxBuy_ConsoleUI"):SetPosY(buttonPosY)
  UI.getChildControl(control, "Button_XboxProductSelect_ConsoleUI"):SetPosY(buttonPosY)
