...
function ArshaPvP_init()
  ...
  self.txt_LimitMinuteTitle:SetTextMode(CppEnums.TextMode.eTextMode_LimitText)
  self.txt_LimitSecondTitle:SetTextMode(CppEnums.TextMode.eTextMode_LimitText)
  self.txt_LimitLevelMore:SetTextMode(CppEnums.TextMode.eTextMode_LimitText)
  self.txt_LimitMinuteTitle:SetText(self.txt_LimitMinuteTitle:GetText())
  self.txt_LimitSecondTitle:SetText(self.txt_LimitSecondTitle:GetText())
  self.txt_LimitLevelMore:SetText(self.txt_LimitLevelMore:GetText())
  UI.checkLimitTextAndAddTooltip(self.txt_LimitMinuteTitle, self.txt_LimitMinuteTitle:GetText())
  UI.checkLimitTextAndAddTooltip(self.txt_LimitSecondTitle, self.txt_LimitSecondTitle:GetText())
  UI.checkLimitTextAndAddTooltip(self.txt_LimitLevelMore, self.txt_LimitLevelMore:GetText())
...
function HandleClicked_ArshaPvP_ModeChange(matchMode)
  ...
  if 0 == matchMode then
    ...
    self.txt_LimitMinute:SetPosX(235)
    self.txt_LimitMinute:SetPosY(80)
    self.txt_LimitMinuteTitle:SetPosX(270)
    ...
    self.txt_LimitLevel:SetPosX(235)
    self.txt_LimitLevel:SetPosY(110)
    self.txt_LimitLevelMore:SetPosX(270)
    self.txt_LimitLevelMore:SetPosY(110)
    self.txt_LimitSecond:SetPosX(270)
    self.txt_LimitSecond:SetPosY(110)
    self.txt_LimitSecondTitle:SetPosX(110)
