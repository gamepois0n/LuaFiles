...
function ArshaPvP_init()
  ...
  UI.setLimitTextAndAddTooltip(self.txt_LimitMinuteTitle, self.txt_LimitMinuteTitle:GetText())
  UI.setLimitTextAndAddTooltip(self.txt_LimitSecondTitle, self.txt_LimitSecondTitle:GetText())
  UI.setLimitTextAndAddTooltip(self.txt_LimitLevelMore, self.txt_LimitLevelMore:GetText())
