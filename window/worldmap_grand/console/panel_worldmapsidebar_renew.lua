...
function WorldMapSideBar:updateSearchList()
  ...
  for ii = 1, loopCount do
    if ii <= self._searchResultCount then
      if nil == self._ui.rdo_searchedItems[ii] then
        ...
        if nil == self._ui.rdo_searchedItems[ii] then
          ...
          _PA_LOG("\235\176\149\235\178\148\236\164\128", "control copied at " .. ii .. " : " .. self._ui.rdo_searchedItems[ii]:GetID())
        end
        _PA_LOG("\235\176\149\235\178\148\236\164\128", "control referenced at " .. ii .. " : " .. self._ui.rdo_searchedItems[ii]:GetID())
      end
    ...
    elseif nil ~= self._ui.rdo_searchedItems[ii] then
      _PA_LOG("\235\176\149\235\178\148\236\164\128", "turn off useless controls")
