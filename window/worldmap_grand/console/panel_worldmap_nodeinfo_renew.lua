...
function Window_WorldMap_NodeInfo:SetOtherInfo()
  ...
  self._ui._static_BottomBg:SetPosY(Panel_Worldmap_NodeInfo:GetPosY() + Panel_Worldmap_NodeInfo:GetSizeY() - 100)
end
...
function Window_WorldMap_NodeInfo:SetOccupyInfoFromTown()
  ...
  self:SetGuildIcon()
  self._ui._staticText_GuildName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_GUILD") .. " : " .. siegeWrapper:getGuildName())
  self._ui._staticText_GuildMasterName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_MASTER") .. " : " .. siegeWrapper:getGuildMasterName())
  ...
  self._ui._staticText_OccupyDate:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_TIME") .. " : " .. year .. month .. day .. hour)
...
function Window_WorldMap_NodeInfo:SetOccupyInfoFromNode()
  ...
  if true == hasOccupantExist then
    local isSet = setGuildTextureByGuildNo(siegeWrapper:getGuildNo(), self._ui._static_GuildIcon)
    if not isSet then
      self._ui._static_GuildIcon:ChangeTextureInfoName("New_UI_Common_forLua/Default/Default_Buttons.dds")
      local x1, y1, x2, y2 = setTextureUV_Func(self._ui._static_GuildIcon, 183, 1, 188, 6)
    ...
    self._ui._static_GuildIcon:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui._static_GuildIcon:setRenderTexture(self._ui._static_GuildIcon:getBaseTexture())
    self._ui._staticText_GuildName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_GUILD") .. " : " .. "<PAColor0xfff26a6a>" .. PAGetString(Defines.StringSheet_GAME, "LUA_GRAND_WORLDMAP_NODEOWNERINFO_NOWAR") .. "<PAOldColor>")
    self._ui._staticText_GuildMasterName:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_MASTER") .. " : " .. "<PAColor0xff515151>-<PAOldColor>")
    self._ui._staticText_OccupyDate:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_WORLD_MAP_SIEGE_TIME") .. " : " .. "<PAColor0xff515151>-<PAOldColor>")
    local nodeTaxLevel = 0
    if true == _ContentsGroup_SeigeSeason5 then
      nodeTaxLevel = nodeTaxType + 1
    else
