...
function PaGlobalFunc_WorldMapNodeInfo_Update(node)
  _PA_LOG("\235\176\149\235\178\148\236\164\128", "PaGlobalFunc_WorldMapNodeInfo_Update")
...
function WorldMapNodeInfo:update(node)
  ...
  if isExploreUpgradable(self._wayPointKey) then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update, isExploreUpgradable")
    if false == self._nodeIsMaxLevel then
      _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update, false == self._nodeIsMaxLevel")
      if ToClient_isAbleInvestnWithdraw(self._wayPointKey) then
        _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update case ____ 1")
        ...
        _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update case ____ 2")
    ...
    elseif isWithdrawablePlant(self._wayPointKey) then
      _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update case ____ 3")
    ...
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:update case ____ 4")
...
function WorldMapNodeInfo:updateCountryName()
  _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateCountryName")
...
function WorldMapNodeInfo:updateTerritoryName()
  _PA_LOG("\235\176\149\235\178\148\236\164\128", "WorldMapNodeInfo:updateTerritoryName")
  local nodeStaticStatus = self._nodeStaticStatus
  if nil == nodeStaticStatus then
    return
  end
...
function WorldMapNodeInfo:updateNodeOwner()
  ...
  if nil == regionInfo then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner, regionInfo is nil")
  ...
  if nil == minorSiegeWrapper then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner, minorSiegeWrapper is nil")
    self._ui.stc_occupyBG:SetShow(false)
    return
  end
  local siegeWrapper = ToClient_GetSiegeWrapperByRegionKey(regionKey:get())
  if nil == siegeWrapper then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner, siegeWrapper is nil")
    self._ui.stc_occupyBG:SetShow(false)
    return
  end
  ...
  if true == isSiegeBeing then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner ___ 2")
  ...
  elseif true == hasOccupantExist then
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner ___ 3")
    ...
    _PA_LOG("\235\176\149\235\178\148\236\164\128", "updateNodeOwner ___ 4")
    self._ui.stc_occupyIcon:ChangeTextureInfoName("New_UI_Common_forLua/Default/Default_Buttons.dds")
...
function Input_WorldMapNodeInfo_OnNearNode()
  ...
  _PA_LOG("\235\176\149\235\178\148\236\164\128", "OnNearNodeClick")
