...
local TitleInfo = {
  ...
  title_ListAllProgress = UI.getChildControl(Panel_Window_CharInfo_TitleInfo, "Progress_AllRound"),
  title_ListCombatProgress = UI.getChildControl(Panel_Window_CharInfo_TitleInfo, "Progress_Combat"),
  title_ListProductProgress = UI.getChildControl(Panel_Window_CharInfo_TitleInfo, "Progress_Product"),
  title_ListFishProgress = UI.getChildControl(Panel_Window_CharInfo_TitleInfo, "Progress_Fishing"),
