...
local CharacterInfo = {
  ...
  _battlePoint = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_BattlePoint"),
  _battlePointIcon = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "Static_BattlePointIcon"),
