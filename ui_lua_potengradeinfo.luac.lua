...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\potengradeinfo\ui_lua_potengradeinfo.luac 
...
local PotenGradeInfo = {attackSpeed_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_AttackSpeed"), castingSpeed_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_CastingSpeed"), moveSpeed_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_MoveSpeed"), criticalRate_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_CriticalRate"), fishingRate_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_FishingRate"), gatheringRate_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_GatheringRate"), dropRate_Icon = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Static_Icon_DropRate"), attackSpeed_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_AttackSpeed_Gauge"), castingSpeed_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_CastingSpeed_Gauge"), moveSpeed_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_MoveSpeed_Gauge"), criticalRate_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_CriticalRate_Gauge"), fishingRate_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_FishingRate_Gauge"), gatheringRate_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_GatheringRate_Gauge"), dropRate_Progress = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "Progress2_DropRate_Gauge"), attackSpeed_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_AttackSpeed_Value"), castingSpeed_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_CastingSpeed_Value"), moveSpeed_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_MoveSpeed_Value"), criticalRate_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_CriticalRate_Value"), fishingRate_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_FishingRate_Value"), gatheringRate_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_GatheringRate_Value"), dropRate_Text = (UI.getChildControl)(Panel_Widget_PotenGradeInfo, "StaticText_DropRate_Value")}
local potenType = {attackSpeed = 0, castingSpeed = 1, moveSpeed = 2, criticalRate = 3, fishingRate = 4, gatheringRate = 5, dropRate = 6, gradeText = PAGetString(Defines.StringSheet_GAME, "LUA_POTENCIAL_UP_2")}
PotenGradeInfo.registEventHandler = function(self)
  -- function num : 0_0
end

PotenGradeInfo.registMessageHandler = function(self)
  -- function num : 0_1
...
local PotenGradeInfo_Initialize = function()
  -- function num : 0_2 , upvalues : PotenGradeInfo
...
PotenGradeInfo_ShowAni = function()
...
PotenGradeInfo_HideAni = function()
...
PotenGradeInfo.Update = function(self)
  -- function num : 0_5 , upvalues : potenType
...
PotenGradeInfoUpdate = function()
  -- function num : 0_6 , upvalues : PotenGradeInfo
  local self = PotenGradeInfo
  self:Update()
end

PotenGradeInfo_MouseOver = function(isShow, _potenType)
  -- function num : 0_7 , upvalues : PotenGradeInfo, potenType, helpWidget
  local self = PotenGradeInfo
  ...
  if isShow == true then
    if potenType.attackSpeed == _potenType then
      ...
      if potenType.castingSpeed == _potenType then
        ...
        if potenType.moveSpeed == _potenType then
          ...
          if potenType.criticalRate == _potenType then
            ...
            if potenType.fishingRate == _potenType then
              ...
              if potenType.gatheringRate == _potenType then
                ...
                if potenType.dropRate == _potenType then
...
FromClient_PotenGradeInfo_OnScreenResize = function()
  -- function num : 0_8
  Panel_Widget_PotenGradeInfo:SetPosX(15)
  Panel_Widget_PotenGradeInfo:SetPosY(Panel_Widget_CraftLevInfo:GetPosY() - Panel_Widget_PotenGradeInfo:GetSizeY() + 10)
end

PotenGradeInfo_ShowToggle = function()
  -- function num : 0_9
  if Panel_Widget_PotenGradeInfo:IsShow() then
  end
end

PotenGradeInfo_Show = function()
  -- function num : 0_10
  if not Panel_Widget_PotenGradeInfo:GetShow() then
  end
end

PotenGradeInfo_Hide = function()
  -- function num : 0_11
