...
local INPUT_COUNT_END_UI = 35
local STATIC_INPUT_TITLE_UI = {}
local BUTTON_KEY_UI = {}
local BUTTON_PAD_UI = {}
local INPUT_TYPE_UI = nil
local keyConfigListShowCount_UI = 36
