...
, SCREENSHOT_BMP = 0, SCREENSHOT_JPG = 1, SCREENSHOT_PNG = 2, SCREENSHOTSIZE_DEFAULT = 0, SCREENSHOTSIZE_4k = 1, SCREENSHOTSIZE_8k = 2, EFFECTLOD_HIGH = 2, EFFECTLOD_NORMAL = 1, EFFECTLOD_LOW = 0, WATERMARK_ALPHA = 0, WATERMARK_BOLD = 1, WATERMARK_NONE = 2, WATERMARK_SERVICE_KR = 0, WATERMARK_SERVICE_JP = 1, WATERMARK_SERVICE_NA = 2, WATERMARK_SERVICE_RU = 3, WATERMARK_SERVICE_TW = 4, WATERMARK_SERVICE_SA = 5, WATERMARK_SERVICE_NONE = 6, WATERMARK_SERVICE_ID = 7, WATERMARK_POSITION_LT = 0, WATERMARK_POSITION_RT = 1, WATERMARK_POSITION_LB = 2, WATERMARK_POSITION_RB = 3, WATERMARK_SCALE_SMALL = 0, WATERMARK_SCALE_REGULAR = 1, WATERMARK_SCALE_LARGE = 2, COLORBLIND_NONE = 0, COLORBLIND_PROTANOPIA = 1, COLORBLIND_DEUTERANOP = 2, TEXTURE_QUALITY_HIGH = 0, TEXTURE_QUALITY_NORMAL = 1, TEXTURE_QUALITY_LOW = 2, TEXTURE_QUALITY_COUNT = 3, GRAPHIC_OPTION_HIGH0 = 0, GRAPHIC_OPTION_HIGH1 = 1, GRAPHIC_OPTION_NORMAL0 = 2, GRAPHIC_OPTION_NORMAL1 = 3, GRAPHIC_OPTION_LOW0 = 4, GRAPHIC_OPTION_LOW1 = 5, GRAPHIC_OPTION_VERYLOW = 6, GRAPHIC_OPTION_COUNT = 7, RESOLUTION_WIDTH = 1280, RESOLUTION_HEIGHT = 720, currentScreenModeIdx = 0, currentScreenShotFormat = 0, currentScreenShotSize = 0, currentEffectLOD = 0, currentColorBlind = 0, currentSelfPlayerOnlyEffect = false, currentSelfPlayerOnlyLantern = false, currentNearestPlayerOnlyEffect = false, currentLowPower = false, currentUpscaleEnable = false, currentCropModeEnable = false, currentCropModeScaleX = 0, currentCropModeScaleY = 0, currentLUT = 0, currentAutoOptimization = true, currentOptimizationFrame = 20, currentEffectOption = true, currentEffectOptionFrame = 1, currentPlayerEffectOption = true, currentPlayerEffectOptionFrame = 30, currentCharacterDistUpdate = true, currentPlayerHide = false, currentScreenResolutionIdx = 0, currentTextureQualityIdx = 0, currentGraphicOptionIdx = 0, currentGammaValue = 0, currentContrastValue = 0, currentCheckDof = true, currentCheckAA = true, currentCheckUltra = false, currentCheckLensBlood = true, currentCheckBloodEffect = true, currentCheckSSAO = true, currentCheckTessellation = true, currentCheckPostFilter = true, currentCheckCharacterEffect = true, currentCheckUIScale = 1, currentCheckRepresent = true, currentCheckSnowPoolOnlyInSafeZone = false, currentCheckWorkerVisible = true, currentMaster = 0, currentMusic = 0, currentFxSound = 0, currentEnvSound = 0, currentDlgSound = 0, currentHitFxWeight = 0, currentPlayerVolume = 0, currentCheckMusic = true, currentCheckSound = true, currentCheckEnvSound = true, currentCheckCombatMusic = (CppEnums.BattleSoundType).Sound_Nomal, currentCheckNpcVoice = getGameServiceResType(), currentCheckRiddingMusic = true, currentCheckWhisperMusic = true, currentCheckTraySoundOnOff = true, currentCheckNameTag = false, currentCheckShowSkillCmd = true, currentCheckShowComboGuide = true, currentCheckAutoAim = true, currentCheckHideWindowByAttacked = true, currentCheckShowGuildLoginMessage = true, currentCheckEnableSimpleUI = true, currentCheckRenderCharacterColor = true, currentCheckEnableOVR = true, currentCheckMiniMapRotation = false, currentCheckRejectInvitation = false, currentCheckEffectAlpha = 1, currentCheckCameraMasterPower = 1, currentCheckColorByPass = 1, currentCheckCameraShakePower = 0.5, currentCheckMotionBlurPower = 0.5, currentCheckCameraPosPower = 0.7, currentCheckCameraFovPower = 0.7, currentCheckMouseMove = false, currentCheckMouseInvertX = false, currentCheckMouseInvertY = false, currentCheckMouseSensitivityX = 1.05, currentCheckMouseSensitivityY = 1.05, currentCheckPadEnable = false, currentCheckPadVibration = false, currentCheckPadInvertX = false, currentCheckPadInvertY = false, currentCheckPadSensitivityX = 1.05, currentCheckPadSensitivityY = 1.05, currentCheckPadConsoleUIMode = false, currentCheckPadConsoleComboMode = false, currentCheckIsHideMast = true, currentCheckShowCashAlert = false, currentCheckShowHpRular = true, currentSelfPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, currentOtherPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, currentPartyPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, currentGuildPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, currentRankingPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, currentNavPathEffectType = (CppEnums.NavPathEffectType).eNavPathEffectType_Arrow, currentWorldMapOpenType = (CppEnums.WorldMapAnimationStyle).noAnimation, currentWorldMapCameraType = (CppEnums.WorldMapCameraPitchType).eWorldMapCameraPitchType_Default, currentServiceResourceType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, currentChatChannelType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, currentFovValue = 50, currentCheckIsUIModeMouseLock = false, currentCheckShowAttackEffect = true, currentCheckBlackSpiritAlert = true, currentCheckIsPvpRefuse = false, currentCheckIsExchangeRefuse = false, currentCheckIsNewUI = false, currentCheckIsOnScreenSaver = true, currentCheckUseNewQuickSlot = false, currentGuideLineZoneChange = false, currentGuideLineWarAlly = false, currentGuideLineGuild = false, currentGuideLineQuestLine = true, currentGuideLineNonWarPlayer = false, currentGuideLineParty = false, currentGuideLineHumanRelation = true, currentGuideLineEnemy = false, currentGuideLinePartyMemberEffect = false, currentAutoRunCamera = true, currentAutoRunCameraRotation = 1, appliedScreenModeIdx = 0, appliedScreenShotFormat = 0, appliedScreenShotSize = 0, appliedEffectLOD = 0, appliedColorBlind = 0, appliedSelfPlayerOnlyEffect = true, appliedSelfPlayerOnlyLantern = false, appliedLowPower = false, appliedUpscaleEnable = false, appliedCropModeEnable = false, appliedCropModeScaleX = 0, appliedCropModeScaleY = 0, appliedAutoOptimization = true, appliedOptimizationFrame = 20, appliedEffectOption = true, appliedEffectOptionFrame = 1, appliedPlayerEffectOption = true, appliedCharacterDistUpdate = true, appliedPlayerHide = false, appliedPlayerEffectOptionFrame = 30, appliedLUT = 0, appliedScreenResolutionIdx = 0, appliedTextureQualityIdx = 0, appliedGraphicOptionIdx = 0, appliedGammaValue = 0, appliedContrastValue = 0, appliedCheckDof = true, appliedCheckAA = true, appliedCheckUltra = false, appliedCheckLensBlood = true, appliedCheckBloodEffect = true, appliedCheckRepresent = true, appliedCheckSnowPoolOnlyInSafeZone = false, appliedCheckSSAO = true, appliedCheckTessellation = true, appliedCheckPostFilter = true, appliedCheckCharacterEffect = true, appliedCheckUIScale = 1, appliedCheckEffectAlpha = 1, appliedMaster = 0, appliedMusic = 0, appliedFxSound = 0, appliedEnvSound = 0, appliedDlgSound = 0, appliedHitFxWeight = 0, appliedPlayerVolume = 0, appliedCheckMusic = true, appliedCheckSound = true, appliedCheckEnvSound = true, appliedCheckCombatMusic = (CppEnums.BattleSoundType).Sound_Nomal, appliedCheckNpcVoice = getGameServiceResType(), appliedCheckRiddingMusic = true, appliedCheckWhisperMusic = true, appliedCheckTraySoundOnOff = true, appliedCheckNameTag = false, appliedCheckShowSkillCmd = true, appliedCheckShowComboGuide = true, appliedCheckAutoAim = true, appliedCheckHideWindowByAttacked = true, appliedCheckShowGuildLoginMessage = true, appliedCheckEnableSimpleUI = true, appliedCheckRenderCharacterColor = true, appliedCheckEnableOVR = true, appliedCheckMiniMapRotation = false, appliedCheckRejectInvitation = false, appliedCheckCameraMasterPower = 1, appliedCheckCameraShakePower = 0.5, appliedCheckMotionBlurPower = 0.5, appliedCheckCameraPosPower = 0.7, appliedCheckCameraFovPower = 0.7, appliedCheckColorByPass = 1, appliedCheckMouseMove = false, appliedCheckMouseInvertX = false, appliedCheckMouseInvertY = false, appliedCheckMouseSensitivityX = 1.05, appliedCheckMouseSensitivityY = 1.05, appliedCheckPadEnable = false, appliedCheckPadVibration = false, appliedCheckPadInvertX = false, appliedCheckPadInvertY = false, appliedCheckPadSensitivityX = 1.05, appliedCheckPadSensitivityY = 1.05, appliedCheckPadConsoleUIMode = false, appliedCheckPadConsoleComboMode = false, appliedCheckIsHideMast = true, appliedCheckShowCashAlert = false, appliedCheckShowHpRular = true, appliedCheckSelfNameShow = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, appliedOtherPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, appliedPartyPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, appliedGuildPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, appliedRankingPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, appliedPetObjectShow = (CppEnums.PetVisibleType).ePetVisibleType_All, appliedWatermarkPosition = (CppEnums.WatermarkPositionType).eWatermarkPositionType_RightDown, appliedWatermarkScale = (CppEnums.WatermarkScaleType).eWatermarkScaleType_Regular, appliedWatermarkService = (CppEnums.WatermarkServiceType).eWatermarkServiceType_KR, appliedWatermarkAlpha = 0.5, appliedFontResizeType = 0, appliedNavPathEffectType = (CppEnums.NavPathEffectType).eNavPathEffectType_Arrow, appliedWorldMapOpenType = (CppEnums.WorldMapAnimationStyle).noAnimation, appliedWorldMapCameraType = (CppEnums.WorldMapAnimationStyle).eWorldMapCameraPitchType_Default, appliedServiceResourceType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, appliedChatChannelType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, appliedFovValue = 50, appliedCheckWorkerVisible = true, appliedCheckIsUIModeMouseLock = false, appliedCheckShowAttackEffect = true, appliedCheckBlackSpiritAlert = true, appliedCheckIsPvpRefuse = false, appliedCheckIsExchangeRefuse = false, appliedCheckIsNewUI = false, appliedCheckIsOnScreenSaver = true, appliedCheckUseNewQuickSlot = false, appliedGuideLineZoneChange = false, appliedGuideLineWarAlly = false, appliedGuideLineGuild = false, appliedGuideLineQuestLine = true, appliedGuideLineNonWarPlayer = false, appliedGuideLineParty = false, appliedGuideLineHumanRelation = true, appliedGuideLineEnemy = false, appliedGuideLinePartyMemberEffect = false, appliedAutoRunCamera = true, appliedAutoRunCameraRotation = 1, savedScreenModeIdx = 0, savedScreenShotFormat = 0, savedScreenShotSize = 0, savedEffectLOD = 0, savedColorBlind = 0, savedSelfPlayerOnlyEffect = true, savedNearestPlayerOnlyEffect = true, savedSelfPlayerOnlyLantern = false, savedLowPower = false, savedUpscaleEnable = false, savedCropModeEnable = false, savedCropModeScaleX = 0, savedCropModeScaleY = 0, savedAutoOptimization = true, savedOptimizationFrame = 20, savedLUT = 0, savedScreenResolutionIdx = 0, savedTextureQualityIdx = 0, savedGraphicOptionIdx = 0, savedGammaValue = 0, savedContrastValue = 0, savedCheckDof = true, savedCheckAA = true, savedCheckUltra = false, savedCheckLensBlood = true, savedCheckBloodEffect = true, savedCheckRepresent = true, savedCheckSnowPoolOnlyInSafeZone = false, savedCheckSSAO = true, savedCheckTessellation = true, savedCheckPostFilter = true, savedCheckCharacterEffect = true, savedCheckUIScale = 1, savedCheckWorkerVisible = true, savedMaster = 0, savedMusic = 0, savedFxSound = 0, savedEnvSound = 0, savedDlgSound = 0, savedHitFxWeight = 0, savedPlayerVolume = 0, savedCheckMusic = true, savedCheckSound = true, savedCheckEnvSound = true, savedCheckCombatMusic = (CppEnums.BattleSoundType).Sound_Nomal, savedCheckNpcVoice = getGameServiceResType(), savedCheckRiddingMusic = true, savedCheckWhisperMusic = true, savedCheckTraySoundOnOff = true, savedCheckNameTag = false, savedCheckShowSkillCmd = true, savedCheckShowComboGuide = true, savedCheckAutoAim = true, savedCheckHideWindowByAttacked = true, savedCheckShowGuildLoginMessage = true, savedCheckEnableSimpleUI = true, savedCheckRenderCharacterColor = true, savedCheckEnableOVR = true, savedCheckMiniMapRotation = false, savedCheckRejectInvitation = false, savedCheckCameraMasterPower = 1, savedCheckColorByPass = 1, savedCheckCameraShakePower = 0.5, savedCheckMotionBlurPower = 0.5, savedCheckCameraPosPower = 0.7, savedCheckCameraFovPower = 0.7, savedCheckEffectAlpha = 1, savedCheckMouseMove = false, savedCheckMouseInvertX = false, savedCheckMouseInvertY = false, savedCheckMouseSensitivityX = 1.05, savedCheckMouseSensitivityY = 1.05, savedCheckPadEnable = false, savedCheckPadVibration = false, savedCheckPadInvertX = false, savedCheckPadInvertY = false, savedCheckPadSensitivityX = 1.05, savedCheckPadSensitivityY = 1.05, savedCheckPadConsoleUIMode = false, savedCheckPadConsoleComboMode = false, savedCheckIsHideMast = true, savedCheckShowCasheAlert = false, savedCheckShowHpRular = true, savedCheckSelfNameShow = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, savedOtherPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, savedPartyPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, savedGuildPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, savedRankingPlayerNameTagVisible = (CppEnums.VisibleNameTagType).eVisibleNameTagType_AllwaysShow, savedPetObjectShow = (CppEnums.PetVisibleType).ePetVisibleType_All, savedFontResizeType = 0, savedNavPathEffectType = (CppEnums.NavPathEffectType).eNavPathEffectType_Arrow, savedWorldMapOpenType = (CppEnums.WorldMapAnimationStyle).noAnimation, savedWorldMapCameraType = (CppEnums.WorldMapCameraPitchType).eWorldMapCameraPitchType_Default, savedServiceResourceType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, savedChatChannelType = (CppEnums.ServiceResourceType).eServiceResourceType_KR, savedFovValue = 50, savedCheckIsUIModeMouseLock = false, savedCheckShowAttackEffect = true, savedCheckBlackSpiritAlert = true, savedCheckIsPvpRefuse = false, savedCheckIsExchangeRefuse = false, savedCheckIsNewUI = false, savedCheckIsOnScreenSaver = true, savedCheckUseNewQuickSlot = false, savedCheckGuideLineZoneChange = false, savedCheckGuideLineWarAlly = false, savedCheckGuideLineGuild = false, savedCheckGuideLineQuestLine = true, savedCheckGuideLineNonWarPlayer = false, savedCheckGuideLineParty = false, savedCheckGuideLineHumanRelation = true, savedCheckGuideLineEnemy = false, savedCheckGuideLinePartyMemberEffect = false, petForSiegeOption = false, savedAutoRunCamera = true, savedAutoRunCameraRotation = 1}
  ...
  -- function num : 0_1 , upvalues : keyConfigData, configDataIndex
  ...
  -- function num : 0_5 , upvalues : keyConfigData
  -- DECOMPILER ERROR at PC2: Confused about usage of register: R2 in 'UnsetPending'
  ...
  -- function num : 0_6 , upvalues : keyConfigListShowCount, getKeyConfigData, STATIC_INPUT_TITLE, BUTTON_KEY, BUTTON_PAD
  ...
  -- function num : 0_11 , upvalues : setKeyConfigData_UI
  setKeyConfigData_UI(index, nil, nil, pad)
end

  local updateKeyConfig_UI = function()
  -- function num : 0_12 , upvalues : keyConfigListShowCount_UI, getKeyConfigData_UI, STATIC_INPUT_TITLE_UI, BUTTON_KEY_UI, BUTTON_PAD_UI
...
, 
[simpleToolTipIdx._btn_EffectOption] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_EFFECTOPTION"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_EFFECTOPTION"), control = (PaGlobal_GameOption_Optimization._ui)._btn_EffectOption}
, 
[simpleToolTipIdx._btn_PlayerEffectOption] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_PLAYEREFFECTOPTION"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_PLAYEREFFECTOPTION"), control = (PaGlobal_GameOption_Optimization._ui)._btn_PlayerEffectOption}
, 
[simpleToolTipIdx._btn_CharacterDistUpdate] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_CHARACTERDISTUPDATE"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_CHARACTERDISTUPDATE"), control = (PaGlobal_GameOption_Optimization._ui)._btn_CharacterDistUpdate}
, 
[simpleToolTipIdx._btn_PlayerHide] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_PLAYERHIDE"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_DESC_PLAYERHIDE"), control = (PaGlobal_GameOption_Optimization._ui)._btn_playerHide}
, 
...
, 
[simpleToolTipIdx._btn_RankingNameShow] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_NAMETAGRANK_NAME"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_NAMETAGRANK_DESC"), control = frame_Game._btn_RankingNameShow}
, 
...
, 
[simpleToolTipIdx._btn_NewUI] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_NEWUI"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_DESC_REJECTEXCHANGE"), control = frame_Game._btn_NewUI}
, 
...
, 
[simpleToolTipIdx._btn_ConsoleMode] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_NAME_PADY"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_OPTION_TOOLTIP_PADY"), control = frame_Game._btn_ConsoleMode}
, 
...
[simpleToolTipIdx._btn_showHpRular] = {name = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_HPRULER_TOOLTIP_NAME"), desc = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_HPRULER_TOOLTIP_DESC"), control = frame_Game._btn_showHpRular}
  ...
  -- function num : 0_13 , upvalues : chk_Option, gamePanel_Main, UI_TM, GetStr_Option, frame_Display, frame_Game, frame_Sound
  HideAllFrame_Func()
...
[(CppEnums.GameServiceType).eGameServiceType_DEV] = {(CppEnums.ServiceResourceType).eServiceResourceType_EN, (CppEnums.ServiceResourceType).eServiceResourceType_FR, (CppEnums.ServiceResourceType).eServiceResourceType_ID}
, 
...
, 
[(CppEnums.GameServiceType).eGameServiceType_ID_ALPHA] = {(CppEnums.ServiceResourceType).eServiceResourceType_ID, (CppEnums.ServiceResourceType).eServiceResourceType_EN}
, 
...
, 
[(CppEnums.GameServiceType).eGameServiceType_NA_ALPHA] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_English, (CppEnums.LangType).LangType_French, (CppEnums.LangType).LangType_German}
, 
[(CppEnums.GameServiceType).eGameServiceType_NA_REAL] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_English, (CppEnums.LangType).LangType_French, (CppEnums.LangType).LangType_German}
, 
[(CppEnums.GameServiceType).eGameServiceType_SA_ALPHA] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_Pt, (CppEnums.LangType).LangType_Es}
, 
[(CppEnums.GameServiceType).eGameServiceType_SA_REAL] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_Pt, (CppEnums.LangType).LangType_Es}
, 
[(CppEnums.GameServiceType).eGameServiceType_ID_ALPHA] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_English, (CppEnums.LangType).LangType_ID}
, 
...
[(CppEnums.GameServiceType).eGameServiceType_TR_REAL] = {(CppEnums.LangType).LangType_International, (CppEnums.LangType).LangType_TR, (CppEnums.LangType).LangType_English}
  ...
  -- function num : 0_14 , upvalues : isOnServiceResourceTypeList, _btn_ServiceResourceType, isOnServiceResourceTypeTag, serviceResEnumsNumber, serviceResCount, UI_TM, _ServiceResComputePosY, _txt_LanguageOption, _frameContent_Game
  ...
  -- function num : 0_15 , upvalues : isOnServiceChatTypeList, _btn_ChatLanguageType, _ServiceResComputePosY, isOnServiceChatTypeTag, ChatChannelEnumsNumber, UI_TM, _txt_ChatChannelOption
  ...
  if resTable ~= nil then
    for _,index in pairs(resTable) do
      ...
      -- DECOMPILER ERROR at PC69: Confused about usage of register: R14 in 'UnsetPending'
  ...
  -- function num : 0_17 , upvalues : _frame_Language, _frameContent_Language, _frame_Game, _frameContent_Game, _txt_LanguageOption, createServiceResOption, createChatChannelOption, eraseChatChannelOption
  ...
  -- function num : 0_20 , upvalues : gamePanel_Main, UI_TM, GetStr_Option, _static_KeySetBG, _static_PadSetBG, _static_ResetKeyConfig, _static_KeySetTitle, _static_KeySetBG_UI, _static_PadSetBG_UI, _static_ResetKeyConfig_UI, _static_ResetPositionConfig_UI, _static_KeySetTitle_UI
  if (gamePanel_Main._btn_Display):IsCheck() then
    (gamePanel_Main._txt_Comment):SetTextMode(UI_TM.eTextMode_AutoWrap)
    ;
    (gamePanel_Main._txt_Comment):SetText(GetStr_Option[0])
        ...
        if (gamePanel_Main._btn_KeyConfig):IsCheck() then
          ...
          if (gamePanel_Main._btn_KeyConfig_UI):IsCheck() then
            ...
            if (gamePanel_Main._btn_Language):IsCheck() then
              ...
              if (gamePanel_Main._btn_Optimization):IsCheck() then
                (gamePanel_Main._txt_Comment):SetTextMode(UI_TM.eTextMode_AutoWrap)
                ;
  ...
  -- function num : 0_21 , upvalues : _frame_Display, _frame_Sound, _frame_Game
  local updateList = {}
  ...
  -- function num : 0_22 , upvalues : gamePanel_Main, _frame_Display, isKeyConfig_Open, isKeyConfig_UI_Open, _frame_Sound, _frame_Game, _frame_KeyConfig, configDataIndex, updateKeyConfig, _frame_KeyConfig_UI, configDataIndex_UI, updateKeyConfig_UI, _frame_Language
  ...
  -- function num : 0_23 , upvalues : gamePanel_Main
  showGameOption()
  ;
  (gamePanel_Main._btn_Display):SetCheck(index == 0)
  ;
  (gamePanel_Main._btn_Sound):SetCheck(index == 1)
  ;
  (gamePanel_Main._btn_Game):SetCheck(index == 2)
  ;
  (gamePanel_Main._btn_KeyConfig):SetCheck(index == 3)
  ;
  (gamePanel_Main._btn_KeyConfig_UI):SetCheck(index == 4)
  ;
  (gamePanel_Main._btn_Optimization):SetCheck(index == 5)
  ShowFrame_Func()
  -- DECOMPILER ERROR: 6 unprocessed JMP targets
end

  FGlobal_GameOptionOpen = function()
  -- function num : 0_24 , upvalues : gamePanel_Main, _game_sld, _frame_Game
  ...
  -- function num : 0_25 , upvalues : _frame_Display, UI_ANI_ADV, _display_sld, _sound_sld, _game_sld, _keyConfig_sld, _keyConfigUI_sld, _frame_Game
  ...
  -- function num : 0_31 , upvalues : chk_Option, currentResolutionX, currentResolutionY, isFirst
  ...
  -- function num : 0_33 , upvalues : frame_Game, gamePanel_Main, currentLUT
  ...
  -- function num : 0_34 , upvalues : currentLUT
  return currentLUT
end

  Option_Init_KeyConfig = function()
  -- function num : 0_35 , upvalues : frame_Key, UI_TM, keyConfigListShowCount, STATIC_INPUT_TITLE, _frameContent_KeyConfig, BUTTON_KEY, BUTTON_PAD, INPUT_COUNT_START, INPUT_COUNT_END, setKeyConfigDataTitle, setKeyConfigDataConfigOnlyPad, _frame_KeyConfig
  local adderPosY = 35
  ...
  -- function num : 0_36 , upvalues : frame_Key_UI, UI_TM, keyConfigListShowCount_UI, STATIC_INPUT_TITLE_UI, _frameContent_KeyConfig_UI, BUTTON_KEY_UI, BUTTON_PAD_UI, INPUT_COUNT_START_UI, INPUT_COUNT_END_UI, setKeyConfigData_UITitle, _frame_KeyConfig_UI
  local adderPosY = 35
  ...
  -- function num : 0_37 , upvalues : chk_Option
  ...
  -- function num : 0_38 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_39 , upvalues : chk_Option, frame_Display
  ...
  -- function num : 0_40 , upvalues : scaleRangeTable, const_UiScaleValue, chk_Option
  ...
  -- function num : 0_41 , upvalues : scaleRangeTable, const_UiScaleValue, chk_Option
  ...
  GameOption_InitEffectLODLevel = function(lodLevel)
  ...
  -- function num : 0_46 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_47 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_48 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_51 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_52 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_53 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_63 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_64 , upvalues : chk_Option
  local self = chk_Option
  ...
  GameOption_SetEffectLOD = function(lodLevel)
  -- function num : 0_65 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_69 , upvalues : chk_Option
  local self = chk_Option
  ...
  GameOption_CheckEffectLODLevel = function(lodLevel)
  -- function num : 0_72
end

  GameOption_CheckColorBlind = function(Format)
  -- function num : 0_73 , upvalues : frame_Display, chk_Option
  if Format == 0 then
  ...
  -- function num : 0_77 , upvalues : frame_Display, chk_Option
  ...
  -- function num : 0_78 , upvalues : frame_Display, chk_Option
  ...
  -- function num : 0_79 , upvalues : frame_Display, chk_Option
  ...
  -- function num : 0_80 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_81 , upvalues : chk_Option
  local self = chk_Option
  self.currentWatermarkAlpha = watermarkAlpha
  ...
  -- function num : 0_82 , upvalues : frame_Display
  ...
  -- function num : 0_83 , upvalues : _btn_WatermarkAlpha, frame_Display
  ...
  -- function num : 0_85 , upvalues : chk_Option
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'
  ...
  -- function num : 0_86 , upvalues : chk_Option, frame_Display, scaleRangeTable, const_UiScaleValue
  local self = chk_Option
  if screenResolutionIdx > 0 and screenResolutionIdx <= self.SCREEN_RESOLUTION_COUNT then
  ...
  -- function num : 0_87 , upvalues : chk_Option
  ...
  -- function num : 0_88 , upvalues : frame_Display
  ...
  -- function num : 0_89 , upvalues : chk_Option, isFindScreenResolution, screenResolutionIndex
  local self = chk_Option
  ...
  -- function num : 0_91 , upvalues : frame_Display, chk_Option
  if not isOptionVariableAction() then
    local messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_ISOPTIONVARIABLEACTION_MEMO")
    local messageBoxData = {title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"), content = messageBoxMemo, functionYes = MessageBox_Empty_function, priority = (CppEnums.PAUIMB_PRIORITY).PAUIMB_PRIORITY_LOW}
    ;
  ...
  -- function num : 0_93 , upvalues : LUTRecommandation, LUTRecommandationName, frame_Display
  ...
  -- function num : 0_94 , upvalues : LUTRecommandation2, LUTRecommandationName2, frame_Display
  ...
  -- function num : 0_95 , upvalues : chk_Option, currentLUT
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R1 in 'UnsetPending'
  ...
  GameOption_GetFilterName = function(filterName)
  -- function num : 0_96
  ...
  -- function num : 0_97 , upvalues : LUTRecommandationName, LUTRecommandationName2, frame_Display
  ...
  -- function num : 0_98 , upvalues : frame_Display, chk_Option
  ...
  -- function num : 0_99 , upvalues : frame_Display, chk_Option
  (frame_Display._btn_LUT):EraseAllEffect()
  ;
  ...
  -- function num : 0_100 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_101 , upvalues : chk_Option
  local self = chk_Option
  if textureQualityIdx >= 0 and textureQualityIdx < self.TEXTURE_QUALITY_COUNT then
    self.currentTextureQualityIdx = textureQualityIdx
  ...
  -- function num : 0_103 , upvalues : frame_Display, chk_Option
  if not isOptionVariableAction() then
    local messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_ISOPTIONVARIABLEACTION_MEMO")
    local messageBoxData = {title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"), content = messageBoxMemo, functionYes = MessageBox_Empty_function, priority = (CppEnums.PAUIMB_PRIORITY).PAUIMB_PRIORITY_LOW}
    ;
  ...
  -- function num : 0_104 , upvalues : frame_Display, chk_Option
  if not isOptionVariableAction() then
    local messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEOPTION_ISOPTIONVARIABLEACTION_MEMO")
    local messageBoxData = {title = PAGetString(Defines.StringSheet_GAME, "LUA_COMMON_ALERT_NOTIFICATIONS"), content = messageBoxMemo, functionYes = MessageBox_Empty_function, priority = (CppEnums.PAUIMB_PRIORITY).PAUIMB_PRIORITY_LOW}
    ;
  ...
  -- function num : 0_105 , upvalues : chk_Option
  local self = chk_Option
  local texQuality = self.currentTextureQualityIdx - 1
  GameOption_SetCurrentTextureQuality(texQuality)
end
  ...
  -- function num : 0_107 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_108 , upvalues : chk_Option
  local self = chk_Option
  if graphicOptionIdx >= 0 and graphicOptionIdx < self.GRAPHIC_OPTION_COUNT then
    self.currentGraphicOptionIdx = graphicOptionIdx
    GameOption_SetGraphicOptionText(graphicOptionIdx)
  ...
  -- function num : 0_112 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_115 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_119 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_120 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_121 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_122 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_123 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_124 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_125 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_127 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_128 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  local check = false
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_129 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_130 , upvalues : frame_Display
  ...
  -- function num : 0_131 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_132 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_135 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_137 , upvalues : _btn_CropModeScaleX, frame_Display
  local ratio = 0
  ...
  -- function num : 0_138 , upvalues : chk_Option
  local self = chk_Option
  local convertedScale = 0.5 + scale * 0.5
  ...
  -- function num : 0_139 , upvalues : frame_Display
  local ratio = 0
  ...
  -- function num : 0_140 , upvalues : _btn_CropModeScaleY, frame_Display
  local ratio = 0
  ...
  -- function num : 0_142 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_143 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_144 , upvalues : gamePanel_Main, frame_Display
  local ratio = 0
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  GameOption_EffectOptionToSliderPos = function(value)
  -- function num : 0_145
  return value * 4
end

  GameOption_SliderPosToEffectOption = function(value)
  -- function num : 0_146
  return value * 24.9 + 0.1
end

  GameOption_InitEffectOption = function(isEnable, frame)
  -- function num : 0_147 , upvalues : chk_Option
  local self = chk_Option
  ;
  ...
  GameOption_EffectOption = function()
  -- function num : 0_148 , upvalues : chk_Option, gamePanel_Main
  local self = chk_Option
  local check = false
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  GameOption_EffectOptionSetFrame = function(ratio)
  -- function num : 0_149 , upvalues : chk_Option
  local self = chk_Option
  ...
  GameOption_EffectOption_slider = function()
  -- function num : 0_150
  local ratio = 0
  ...
  GameOption_PlayerEffectOptionToSliderPos = function(value)
  -- function num : 0_151
  return (value - 10) * 2.5
end

  GameOption_SliderPosToPlayerEffectOption = function(value)
  -- function num : 0_152
  return value * 40 + 10
end

  GameOption_InitPlayerEffectOption = function(isEnable, frame)
  ...
  GameOption_PlayerEffectOption = function()
  -- function num : 0_154 , upvalues : chk_Option
  local self = chk_Option
  local check = false
  ...
  GameOption_PlayerEffectOptionSetFrame = function(ratio)
  -- function num : 0_155 , upvalues : chk_Option
  local self = chk_Option
  ...
  GameOption_PlayerEffectOption_slider = function()
  -- function num : 0_156
  local ratio = 0
  ...
  GameOption_InitCharacterDistUpdateOption = function(isEnable)
  -- function num : 0_157 , upvalues : chk_Option
  local self = chk_Option
  ;
  ...
  GameOption_CharacterDistUpdate = function()
  -- function num : 0_158 , upvalues : chk_Option, gamePanel_Main
  local self = chk_Option
  local check = false
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  GameOption_InitPlayerHide = function(isEnable)
  -- function num : 0_159 , upvalues : chk_Option
  local self = chk_Option
  do
    local isShow = isEnable == false
    ;
  ...
  GameOption_PlayerHide = function()
  -- function num : 0_160 , upvalues : chk_Option, gamePanel_Main
  local self = chk_Option
  local check = false
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_161 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_162 , upvalues : frame_Display, GetStr_Option
  ...
  -- function num : 0_163 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_164 , upvalues : frame_Display, GetStr_Option
  local value = (math.floor)(posPowerValue * 100 + 0.5 - 50)
  ;
  ...
  -- function num : 0_165 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_166 , upvalues : frame_Display, GetStr_Option
  ...
  -- function num : 0_167 , upvalues : chk_Option
  local self = chk_Option
  self.currentGammaValue = gammaValue
  GameOption_SetGammaValueText(gammaValue)
  ...
  -- function num : 0_170 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_171 , upvalues : frame_Display, GetStr_Option
  ...
  -- function num : 0_172 , upvalues : chk_Option
  local self = chk_Option
  self.currentContrastValue = contrastValue
  GameOption_SetContrastValueText(contrastValue)
  ...
  -- function num : 0_173 , upvalues : frame_Display
  ...
  -- function num : 0_174 , upvalues : _btn_Contrast, frame_Display
  ...
  -- function num : 0_175 , upvalues : chk_Option, frame_Display
  local self = chk_Option
  ...
  -- function num : 0_176 , upvalues : frame_Display, GetStr_Option
  ...
  -- function num : 0_177 , upvalues : chk_Option
  local self = chk_Option
  self.currentFovValue = fovValue
  GameOption_SetFovValueText(fovValue)
  setFov(fovValue)
  ...
  -- function num : 0_178 , upvalues : gamePanel_Main, frame_Display
  local ratio = 0
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_179 , upvalues : gamePanel_Main, frame_Display, _btn_Fov
  local ratio = 0
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_180 , upvalues : scaleRangeTable, frame_Display, GetStr_Option
  ...
  -- function num : 0_181 , upvalues : frame_Display, scaleRangeTable, chk_Option, GetStr_Option
  ...
  -- function num : 0_182 , upvalues : frame_Game, initAlertType
  ...
  for index = 0, 11 do
    ...
    initAlertType[index] = ToClient_GetMessageFilter(R6_PC91)
  end
end
  ...
  -- function num : 0_183 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_184 , upvalues : frame_Sound, GetStr_Option
  ...
  -- function num : 0_185 , upvalues : chk_Option, _volumeParam
  local self = chk_Option
  self.currentMaster = masterVolume
  self.currentMusic = musicVolume
  self.currentFxSound = fxVolume
  ...
  -- function num : 0_186 , upvalues : chk_Option
  local self = chk_Option
  self.currentCheckMusic = enableMusic
  self.currentCheckSound = enableSound
  self.currentCheckEnvSound = enableEnvSound
  ...
  -- function num : 0_187 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_188 , upvalues : chk_Option, _btn_TotalVol, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_189 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_190 , upvalues : chk_Option, _btn_MusicVol, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_191 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_192 , upvalues : chk_Option, _btn_FxVol, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_193 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_194 , upvalues : chk_Option, _btn_EnvFxVol, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_195 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_196 , upvalues : chk_Option, _btn_VoiceVol, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_197 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_198 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_199 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_200 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_201 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_202 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_203 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_204 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_206 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_207 , upvalues : chk_Option, _btn_hitFxWeightVolume, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_208 , upvalues : chk_Option, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_209 , upvalues : chk_Option, _btn_otherPlayerVolume, frame_Sound
  local self = chk_Option
  ...
  -- function num : 0_210 , upvalues : randerPlayerColorStr, serviceResCount, serviceResEnumsNumber, ChatChannelEnumsNumber, chk_Option, frame_Game, _btn_ServiceResourceType, _btn_ChatLanguageType, frame_Display, frame_Sound, effectAlphaRangeTable, GetStr_Option
  ...
  -- function num : 0_213 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_214 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_215 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_218 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_219 , upvalues : chk_Option
  local self = chk_Option
  return self.appliedCheckEnableSimpleUI
end

  GameOption_CheckEnableOVR = function()
  -- function num : 0_220 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_221 , upvalues : chk_Option
  local self = chk_Option
  return self.appliedCheckEnableOVR
end

  Panel_KeyViewer_MainFunc = function()
  -- function num : 0_222 , upvalues : isChecked_KeyViewer
  ...
  -- function num : 0_223 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_224 , upvalues : chk_Option
  local self = chk_Option
  ...
  -- function num : 0_226 , upvalues : frame_Game
  local tempCheck = (frame_Game._btn_SpiritGuide):IsCheck()
end

  GameOption_EffectAlpha_slider = function()
  -- function num : 0_227 , upvalues : chk_Option, frame_Display, effectAlphaRangeTable, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_228 , upvalues : chk_Option, _btn_EffectAlpha, frame_Display, effectAlphaRangeTable, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_229 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_230 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_231 , upvalues : chk_Option, _btn_ColorByPass, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_232 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_233 , upvalues : chk_Option, gamePanel_Main, frame_Display, GetStr_Option
  local self = chk_Option
  local volume = 0
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_234 , upvalues : chk_Option, gamePanel_Main, frame_Display, _btn_CameraMaster, GetStr_Option
  local self = chk_Option
  local volume = 0
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_235 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_236 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_237 , upvalues : chk_Option, _btn_CameraShake, frame_Display, GetStr_Option
  local self = chk_Option
  local volume = 0
  ...
  -- function num : 0_238 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_239 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_240 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  local volume = 0
  ...
  -- function num : 0_241 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_242 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  local volume = 0
  ...
  -- function num : 0_243 , upvalues : chk_Option, _btn_CameraPos, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_244 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_245 , upvalues : chk_Option, frame_Display, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_246 , upvalues : chk_Option, _btn_CameraFov, frame_Display, GetStr_Option
  local self = chk_Option
  local volume = 0
  ...
  -- function num : 0_247 , upvalues : chk_Option, frame_Display, GetStr_Option
  ...
  -- function num : 0_250 , upvalues : chk_Option, gamePanel_Main, frame_Game
  local self = chk_Option
  local check = false
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
  ...
  -- function num : 0_251 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  GameOption_CheckNewUI = function()
  ...
  -- function num : 0_259 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_262 , upvalues : chk_Option
  ...
  -- function num : 0_264 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_265 , upvalues : chk_Option, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_266 , upvalues : chk_Option, _btn_MouXSen, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_267 , upvalues : chk_Option, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_268 , upvalues : chk_Option, _btn_MouYSen, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_269 , upvalues : chk_Option, _btn_hitFxVolume, frame_Sound, _volumeParam, GetStr_Option
  local self = chk_Option
  ...
  GameOption_CheckAutoRunCamera = function()
  ...
  GameOption_AutoRunCamera_Slider = function()
  -- function num : 0_273 , upvalues : chk_Option, _btn_AutoRunCamera_Slider, frame_Game
  local self = chk_Option
  ...
  GameOption_AutoRunCamera_Slider_Btn = function()
  -- function num : 0_274 , upvalues : chk_Option, _btn_AutoRunCamera_Slider, frame_Game
  local self = chk_Option
  local fValue = _btn_AutoRunCamera_Slider:GetPosX() / ((frame_Game._slider_AutoRunCamera):GetSizeX() - _btn_AutoRunCamera_Slider:GetSizeX())
  self.currentAutoRunCameraRotation = fValue
  GameOption_UpdateOptionChanged()
  ...
  GameOption_SetAutoRunCameraSlider = function(fValue)
  ...
  -- function num : 0_276 , upvalues : chk_Option, gamePanel_Main, frame_Game
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
    if ((PaGlobal_GameOption_Optimization._ui)._btn_PetAll):IsCheck() then
      ...
      if ((PaGlobal_GameOption_Optimization._ui)._btn_PetMine):IsCheck() then
  ...
  -- function num : 0_277 , upvalues : chk_Option, gamePanel_Main, frame_Display
  local self = chk_Option
  if (gamePanel_Main._btn_Optimization):IsCheck() == true then
    if ((PaGlobal_GameOption_Optimization._ui)._btn_WorkerVisible):IsCheck() then
      ...
      if ((PaGlobal_GameOption_Optimization._ui)._btn_WorkerInvisible):IsCheck() then
    ...
    if (frame_Display._btn_WorkerVisible):IsCheck() then
      self.currentCheckWorkerVisible = true
      ;
      ...
      if (frame_Display._btn_WorkerInvisible):IsCheck() then
        self.currentCheckWorkerVisible = false
        ;
  ...
  -- function num : 0_282 , upvalues : chk_Option, serviceResCount, _btn_ServiceResourceType, serviceResEnumsNumber, _btn_ChatLanguageType, ChatChannelEnumsNumber
  local self = chk_Option
  for index = 0, serviceResCount - 1 do
  ...
  -- function num : 0_283 , upvalues : chk_Option, serviceResCount, _btn_ChatLanguageType, ChatChannelEnumsNumber
  local self = chk_Option
  for index = 0, serviceResCount do
  ...
  -- function num : 0_292 , upvalues : randerPlayerColorStr, chk_Option, frame_Game
  ...
  -- function num : 0_293 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_294 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_295 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_296 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_297 , upvalues : chk_Option, frame_Game
  local self = chk_Option
  ...
  -- function num : 0_298 , upvalues : frame_Game
  if alertType == 0 then
  ...
  -- function num : 0_299 , upvalues : chk_Option, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_300 , upvalues : chk_Option, _btn_PadXSen, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_301 , upvalues : chk_Option, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_302 , upvalues : chk_Option, _btn_PadYSen, frame_Game, GetStr_Option
  local self = chk_Option
  ...
  -- function num : 0_303 , upvalues : chk_Option, _btn_hitFxVolume, frame_Sound, _volumeParam, GetStr_Option
  local self = chk_Option
  local volume = _btn_hitFxVolume:GetPosX() / ((frame_Sound._slide_hitFxVolume):GetSizeX() - _btn_hitFxVolume:GetSizeX())
  self.currentHitFxVolume = volume * 100
  -- DECOMPILER ERROR at PC17: Confused about usage of register: R2 in 'UnsetPending'
  ...
  -- function num : 0_304 , upvalues : configDataIndex, INPUT_TYPE
  ...
  -- function num : 0_305 , upvalues : configDataIndex, INPUT_TYPE
  local inputType = configDataIndex + inputTypeIndex - 2
  if inputType >= 0 then
    INPUT_TYPE = inputType
  ...
  -- function num : 0_308 , upvalues : INPUT_COUNT_START, INPUT_COUNT_END, setKeyConfigDataConfigButton, updateKeyConfig
  ...
  -- function num : 0_309 , upvalues : keyConfigData, INPUT_COUNT_START, INPUT_COUNT_END, setKeyConfigDataConfigPad, updateKeyConfig
  ...
  -- function num : 0_315 , upvalues : configDataIndex_UI, INPUT_TYPE_UI
  ...
  -- function num : 0_316 , upvalues : configDataIndex_UI, INPUT_TYPE_UI
  local inputType = configDataIndex_UI + inputTypeIndex
  INPUT_TYPE_UI = inputType
  ...
  -- function num : 0_317 , upvalues : INPUT_COUNT_START_UI, INPUT_COUNT_END_UI, setKeyConfigData_UIConfigButton, updateKeyConfig_UI
  ...
  -- function num : 0_318 , upvalues : INPUT_COUNT_START_UI, INPUT_COUNT_END_UI, setKeyConfigData_UIConfigPad, updateKeyConfig_UI
  for ii = INPUT_COUNT_START_UI, INPUT_COUNT_END_UI do
  ...
  -- function num : 0_324 , upvalues : gamePanel_Main, frame_Game, isKeyConfig_Open, isKeyConfig_UI_Open
  ...
  -- function num : 0_325 , upvalues : chk_Option, currentLUT, isFindScreenResolution, _volumeParam, initAlertType, gamePanel_Main
  local self = chk_Option
  ...
  if self.appliedEffectLOD == self.currentEffectLOD or self.currentWatermarkPosition ~= self.appliedWatermarkPosition then
  ...
  if self.appliedPlayerHide ~= false then
    do
      setUseOtherPlayerUpdate(self.appliedPlayerHide == self.currentPlayerHide)
  ...
  -- function num : 0_328 , upvalues : chk_Option, frame_Display, _volumeParam, frame_Game, randerPlayerColorStr, initAlertType, gamePanel_Main
  ...
  do
    ...
    do
      ...
      for index = 0, 11 do
        -- DECOMPILER ERROR at PC1616: Confused about usage of register: R8 in 'UnsetPending'
  ...
  -- function num : 0_330 , upvalues : chk_Option
  if isNeedGameOptionFromServer() == true then
    FGlobal_QuestWindowRateSetting()
  end
  saveGameOption(true)
  ...
  -- function num : 0_331 , upvalues : chk_Option, currentResolutionX, currentResolutionY, screenResolutionIndex, scaleRangeTable
  local self = chk_Option
  ...
  -- function num : 0_338 , upvalues : chk_Option, randerPlayerColorStr, frame_Game
  ...
  -- function num : 0_339 , upvalues : chk_Option, scaleRangeTable, frame_Display, GetStr_Option, gamePanel_Main
  resetDisplayOption()
  GameOption_SetScreenModeButtons(chk_Option.currentScreenModeIdx)
  ...
  -- function num : 0_340 , upvalues : frame_Sound, chk_Option, gamePanel_Main
  resetSoundOption()
  ;
  ...
  -- function num : 0_341 , upvalues : chk_Option, frame_Game, GetStr_Option, gamePanel_Main
  resetGameOption()
  ...
  local updatePetTarget2 = {[(CppEnums.PetVisibleType).ePetVisibleType_All] = (PaGlobal_GameOption_Optimization._ui)._btn_PetAll, [(CppEnums.PetVisibleType).ePetVisibleType_Mine] = (PaGlobal_GameOption_Optimization._ui)._btn_PetMine, [(CppEnums.PetVisibleType).ePetVisibleType_Hide] = (PaGlobal_GameOption_Optimization._ui)._btn_PetHide}
  ...
  -- function num : 0_342 , upvalues : chk_Option, frame_Display, frame_Game
  resetDisplayOption()
  resetGameOption()
  GameOption_SetTextureQualityText(chk_Option.currentTextureQualityIdx)
  GameOption_SetGraphicOptionText(chk_Option.currentGraphicOptionIdx)
  ...
  -- function num : 0_344 , upvalues : gamePanel_Main, frame_Sound
  if optionType == 1 then
  ...
  -- function num : 0_345 , upvalues : toolTipIdxValue
  if isShow == true then
  ...
  -- function num : 0_346 , upvalues : frame_Display
  ...
  -- function num : 0_347 , upvalues : scaleRangeTable
  local uiScale = {}
  ...
  -- function num : 0_348 , upvalues : chk_Option
  return chk_Option.currentCheckUIScale
end

  FGlobal_saveUIScale = function(scale)
  -- function num : 0_349 , upvalues : chk_Option
  ...
  -- function num : 0_350 , upvalues : scaleRangeTable, chk_Option, frame_Display, GetStr_Option
  local interval = scaleRangeTable.maxScaleValue - scaleRangeTable.minScaleValue
  ...
  -- function num : 0_353 , upvalues : simpleUI_Check
  ...
  -- function num : 0_355 , upvalues : frame_Display
  if not isShow then
    TooltipSimple_Hide()
    return 
  end
  ...
  -- function num : 0_356 , upvalues : getKeyConfigData, STATIC_INPUT_TITLE, getKeyConfigData_UI, STATIC_INPUT_TITLE_UI
  if not isShow then
    TooltipSimple_Hide()
    return 
  end
  ...
  -- function num : 0_357 , upvalues : getKeyConfigData, BUTTON_PAD, getKeyConfigData_UI, BUTTON_PAD_UI
  if not isShow then
    TooltipSimple_Hide()
    return 
  end
  ...
  -- function num : 0_358 , upvalues : chk_Option
  local screenSizeX = getScreenSizeX()
  local screenSizeY = getScreenSizeY()
  Panel_Window_Option:SetPosX((screenSizeX - Panel_Window_Option:GetSizeX()) / 2)
  Panel_Window_Option:SetPosY((screenSizeY - Panel_Window_Option:GetSizeY()) / 2)
  ...
  -- function num : 0_359 , upvalues : frame_Game
  return (frame_Game._btn_Alert_NearMonster):IsCheck()
end

  FromClient_ChangePetOptionForSiege = function(visibleType)
  -- function num : 0_360 , upvalues : chk_Option
  self = chk_Option
  -- DECOMPILER ERROR at PC7: Confused about usage of register: R1 in 'UnsetPending'

  if self.petForSiegeOption == true then
    self.petForSiegeOption = false
  else
    -- DECOMPILER ERROR at PC10: Confused about usage of register: R1 in 'UnsetPending'
  ...
  -- function num : 0_361 , upvalues : chk_Option
  local self = chk_Option
  do
    local isShow = false
    if isOption then
