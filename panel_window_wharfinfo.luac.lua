...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\servant\wharf\panel_window_wharfinfo.luac 
...
wharfInfo.update = function(self)
  -- function num : 0_3
...
wharfInfo.registMessageHandler = function(self)
  -- function num : 0_5
  registerEvent("onScreenResize", "WharfInfo_Resize")
end

WharfInfo_Resize = function()
  -- function num : 0_6
  Panel_Window_WharfInfo:SetSpanSize(20, 30)
  Panel_Window_WharfInfo:ComputePos()
end

WharfInfo_Open = function()
  -- function num : 0_7 , upvalues : wharfInfo
