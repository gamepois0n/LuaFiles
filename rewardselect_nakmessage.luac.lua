...
NakMessageUpdate_For_RewardSelect = function(updateTime)
  ...
  if Panel_IngameCashShop:GetShow() or Panel_Cash_Customization:GetShow() or Panel_IngameCashShop_Controller:GetShow() or Panel_Dye_New:GetShow() or Panel_DyeNew_CharacterController:GetShow() then
    return 
  end
                                                              ...
                                                              do
                                                                ...
                                                                do
                                                                  ...
                                                                  if processIndex < curIndex and tempMsg == ((MessageData._Msg)[processIndex + 1]).msg then
                                                                    ...
                                                                    ;
                                                                    ((MessageData._Msg)[processIndex]).msg = nil
                                                                    -- DECOMPILER ERROR at PC1948: Confused about usage of register: R1 in 'UnsetPending'
...
FromClient_RegistGuildServant = function(vehicleType, guildName)
  -- function num : 0_22 , upvalues : UI_VT
...
FromClient_notifyRegisterServantAtAuction = function(characterkey, servantStateType, servantTier, isStallion, price, iconPath)
  -- function num : 0_23 , upvalues : isServantStallion, stallionIcon, messageType
...
FromClient_notifyRegisterWorkerAtAuction = function(workerKey, gradeType, price, iconPath, workerName)
  -- function num : 0_24 , upvalues : messageType
