...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\customization\panel_action_expression.luac 
...
createExpressionList = function()
  -- function num : 0_2 , upvalues : clearContentList, selectedClassType, Frame_ContentImage, textureColumnCount, ColumnCount, columnWidth, contentsOffsetX, columnHeight, contentsOffsetY, ContentImage
  clearContentList()
...
UpdateExpression = function(index)
  -- function num : 0_3 , upvalues : UpdateMarkPosition
  UpdateMarkPosition(index)
  applyExpression(index, 1)
end

openExpressionUI = function(classType)
  -- function num : 0_4 , upvalues : selectedClassType, UpdateMarkPosition
