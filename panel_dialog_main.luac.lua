...
Dialog_updateMainDialog = function()
  -- function num : 0_20 , upvalues : _dialogIndex, _mainDialog, _currentLine, _uiNpcDialog, _maxLine, _uiNextButton, _SpacebarIcon, _rBtnPosX, _rBtnPosY
  _dialogIndex = 0
...
FromClient_ShowDialog = function()
  ...
  while 1 do
    ...
    -- DECOMPILER ERROR at PC268: Confused about usage of register: R13 in 'UnsetPending'
    ...
    if strFirst ~= nil and strSecond ~= nil then
      ...
      if strFirst == nil then
        ...
        -- DECOMPILER ERROR at PC277: Confused about usage of register: R13 in 'UnsetPending'
  ...
  for idx = 1, baseCount do
    ...
    _baseReward[idx] = {}
    -- DECOMPILER ERROR at PC302: Confused about usage of register: R21 in 'UnsetPending'
          ...
          if intimacyInformationData ~= nil then
            ...
            if percent >= 0 and percent <= 1 and ToClient_checkIntimacyInformationFixedState(intimacyInformationData) then
              ...
              if target == nil then
                ...
                -- DECOMPILER ERROR at PC237: Confused about usage of register: R29 in 'UnsetPending'
              ...
              -- DECOMPILER ERROR at PC301: Confused about usage of register: R35 in 'UnsetPending'
                                                                                                                                      ...
                                                                                                                                      if funcButtonType == (CppEnums.ContentsType).Contents_Join then
                                                                                                                                        ...
                                                                                                                                        do
                                                                                                                                          if funcButtonType == (CppEnums.ContentsType).Contents_Improve then
                                                                                                                                            ...
                                                                                                                                            do
                                                                                                                                              if funcButtonType == (CppEnums.ContentsType).Contents_WeakenEnchant then
                                                                                                                                                ...
                                                                                                                                                do
                                                                                                                                                  if funcButtonType == (CppEnums.ContentsType).Contents_NpcGift then
                                                                                                                                                    (_uiFuncButton[index]):ChangeTextureInfoName("New_UI_Common_forLua/Widget/Dialogue/Dialogue_Btn_13.dds")
                                                                                                                                                    local x1, y1, x2, y2 = setTextureUV_Func(_uiFuncButton[index], 1, 133, 155, 165)
                                                                                                                                                    ;
                                                                                                                                                    ((_uiFuncButton[index]):getBaseTexture()):setUV(x1, y1, x2, y2)
                                                                                                                                                  ...
                                                                                                                                                  do
                                                                                                                                                    do
                                                                                                                                                      ...
                                                                                                                                                      -- DECOMPILER ERROR at PC4963: LeaveBlock: unexpected jumping out DO_STMT

                                                                                                                                                      -- DECOMPILER ERROR at PC4963: LeaveBlock: unexpected jumping out DO_STMT

                                                                                                                                                      -- DECOMPILER ERROR at PC4963: LeaveBlock: unexpected jumping out IF_ELSE_STMT

                                                                                                                                                      -- DECOMPILER ERROR at PC4963: LeaveBlock: unexpected jumping out IF_STMT
                                                                                                                                                      ...
                                                                                                                                                      -- DECOMPILER ERROR at PC4963: LeaveBlock: unexpected jumping out IF_THEN_STMT
            ...
            do
              ...
              for i = 0, 5 do
                if true == handleClickedQuestComplete and true == nextQuestFunctionBtnClick[i] then
                  ...
                  -- DECOMPILER ERROR at PC5732: Confused about usage of register: R41 in 'UnsetPending'
                                                            ...
                                                            if tipType == (CppEnums.ContentsType).Contents_GuildSupplyShop then
                                                              ...
                                                              if tipType == (CppEnums.ContentsType).Contents_Join then
                                                                ...
                                                                if tipType == (CppEnums.ContentsType).Contents_Improve then
                                                                  ...
                                                                  if tipType == (CppEnums.ContentsType).Contents_NpcGift then
                                                                    name = funcButton:getText()
                                                                    control = _uiFuncButton[index]
                                                                  else
                                                                    if tipType == (CppEnums.ContentsType).Contents_WeakenEnchant then
                                                                      name = funcButton:getText()
                                                                      control = _uiFuncButton[index]
                                                                    end
                                                                  end
