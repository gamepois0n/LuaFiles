...
function createAccessory(enchantLeve1)
  ...
  elseif enchantLeve1 == 20 then
    ...
    Proc_ShowMessage_Ack("16~20 \234\185\140\236\167\128 \235\178\148\236\156\132\235\167\140 \236\158\165\236\139\160\234\181\172 \236\131\157\236\132\177\236\157\180 \234\176\128\235\138\165\237\149\169\235\139\136\235\139\164.")
  end
end
function cjready()
...
function QAAutomonster(inPutmonsterCnt)
  currnetmonsterCnt = 0
  maxmonsterCnt = inPutmonsterCnt
  QAmonsterC()
end
function QAmonsterC()
  if currnetmonsterCnt > maxmonsterCnt then
    return
  end
  QAcreatemonster()
  luaTimer_AddEvent(QAkillMonster, 500, false, 0)
  currnetmonsterCnt = currnetmonsterCnt + 1
end
function QAkillMonster()
  QAkillnearall()
  luaTimer_AddEvent(QALootall, 1500, false, 0)
end
function QALootall()
  QAlootnearall()
  luaTimer_AddEvent(QAmonsterC, 500, false, 0)
end
function QAcreatemonster()
  chatting_sendMessage("", "/create monster 20003 50", CppEnums.ChatType.Private)
end
function QAkillnearall()
  chatting_sendMessage("", "/killnearallmonster", CppEnums.ChatType.Private)
end
function QAlootnearall()
  chatting_sendMessage("", "/lootnearall", CppEnums.ChatType.Private)
end
...
function siegeinst()
  ...
  Proc_ShowMessage_Ack("\236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56039 - \234\177\176\236\160\144 \236\130\172\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56060 - \234\177\176\236\160\144 \235\139\168\235\139\168\237\149\156 \236\130\172\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56061 - \234\177\176\236\160\144 \234\178\172\234\179\160\237\149\156 \236\130\172\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56005 - \236\160\144\235\160\185 \236\130\172\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56010 - \236\160\144\235\160\185 \235\139\168\235\139\168\237\149\156 \236\130\172\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56011 - \236\160\144\235\160\185 \234\178\172\234\179\160\237\149\156 \237\140\148\234\176\129 \236\132\177\236\177\132")
  Proc_ShowMessage_Ack("56006 - \236\160\144\235\160\185 \236\167\128\237\156\152\236\134\140")
  Proc_ShowMessage_Ack("56073 - \236\160\144\235\160\185 \236\149\188\236\160\132 \236\130\172\235\160\185\235\182\128")
  Proc_ShowMessage_Ack("=============================")
  Proc_ShowMessage_Ack("\236\132\164\236\185\152\235\172\188")
  Proc_ShowMessage_Ack("56033 - \234\184\176\236\160\136 \237\149\168\236\160\149")
  Proc_ShowMessage_Ack("56034 - \237\153\148\236\151\188 \237\149\168\236\160\149")
  Proc_ShowMessage_Ack("56035 - \235\167\185\235\143\133 \237\149\168\236\160\149")
  Proc_ShowMessage_Ack("56036 - \235\176\156\235\170\169 \237\149\168\236\160\149")
  Proc_ShowMessage_Ack("56037 - \235\176\148\235\166\172\236\188\128\236\157\180\235\147\156")
  Proc_ShowMessage_Ack("56038 - \234\179\181\236\132\177 \235\176\169\236\150\180\237\131\145")
  Proc_ShowMessage_Ack("56041 - \236\189\148\235\129\188\235\166\172 \237\149\168\236\160\149")
  Proc_ShowMessage_Ack("56044 - \237\154\140\235\179\181\236\134\140")
  Proc_ShowMessage_Ack("56045 - \235\140\128\237\143\172 \234\180\128\236\184\161\236\134\140")
  Proc_ShowMessage_Ack("56046 - \236\189\148\235\129\188\235\166\172 \236\130\172\236\156\161\236\134\140")
  Proc_ShowMessage_Ack("56053 - \237\153\148\236\151\188\237\131\145")
  Proc_ShowMessage_Ack("56054 - \236\139\160\234\184\176\236\160\132")
  Proc_ShowMessage_Ack("56062 - \235\179\180\234\184\137\236\134\140")
  Proc_ShowMessage_Ack("56070 - \235\170\169\236\177\133 \235\172\184")
  Proc_ShowMessage_Ack("56071 - \235\170\169\236\177\133")
  Proc_ShowMessage_Ack("56076 - \236\164\145\237\152\149 \234\179\181\236\132\177\237\131\145 \236\160\156\236\158\145\236\134\140")
  Proc_ShowMessage_Ack("56077 - \235\140\128\237\152\149 \234\179\181\236\132\177\237\131\145 \236\160\156\236\158\145\236\134\140")
  Proc_ShowMessage_Ack("56079 - \235\182\136\237\135\180\236\157\152 \234\185\131\235\176\156 \236\182\149\236\161\176\235\140\128")
  Proc_ShowMessage_Ack("=============================")
  Proc_ShowMessage_Ack("\236\134\140\235\170\168\237\146\136")
  Proc_ShowMessage_Ack("56003 - \235\140\128\237\143\172\237\131\132")
  Proc_ShowMessage_Ack("56051 - \236\139\160\234\184\176\236\160\132\236\154\169 \237\153\148\236\130\180")
  Proc_ShowMessage_Ack("56052 - \237\153\148\236\151\188\237\131\145\236\154\169 \234\184\176\235\166\132")
  Proc_ShowMessage_Ack("=============================")
  Proc_ShowMessage_Ack("\235\170\168\235\147\160 \235\182\128\236\134\141\234\177\180\235\172\188 \236\131\157\236\132\177 : /dolua siegeready(\236\160\144\235\160\185:0 \234\177\176\236\160\144:1)")
end
...
function uniform()
  ...
  item(19)
  createBossArmor(19)
  createUniformAccessory()
  luaTimer_AddEvent(fuseCrystalToItem, 5000, false, 0)
  luaTimer_AddEvent(fuseCrystalToItem, 7000, false, 0)
  luaTimer_AddEvent(equipUniformWeapon, 9000, false, 0)
  luaTimer_AddEvent(equipUniformArmor, 11000, false, 0)
  luaTimer_AddEvent(equipUniformArmor, 13000, false, 0)
end
function createUniformAccessory()
  ToClient_qaCreateItem(12230, 3, 1)
  ToClient_qaCreateItem(12031, 3, 2)
  ToClient_qaCreateItem(11828, 3, 2)
  ToClient_qaCreateItem(11607, 3, 1)
  ...
  ToClient_qaCreateItem(15616, 0, 2)
  ToClient_qaCreateItem(15127, 0, 1)
  ToClient_qaCreateItem(15128, 0, 1)
  ToClient_qaCreateItem(15654, 0, 4)
  ToClient_qaCreateItem(60, 0, 200)
end
function fuseCrystalToItem()
  PushJewelToItem(11101, 15801, 19)
  PushJewelToItem(11101, 15801, 19)
  PushJewelToItem(11017, 15804, 19)
  PushJewelToItem(11017, 15804, 19)
  PushJewelToItem(11015, 15807, 19)
  PushJewelToItem(11015, 15807, 19)
  PushJewelToItem(11103, 15616, 19)
  PushJewelToItem(11103, 15616, 19)
  local selfPlayer = getSelfPlayer()
  if nil == selfPlayer then
    return
  ...
  local isClassType = getSelfPlayer():getClassType()
  if isClassType == UI_CT.ClassType_Warrior then
    PushJewelToItem(10010, 15127, 19)
    PushJewelToItem(10010, 15128, 19)
    PushJewelToItem(10138, 15654, 19)
    PushJewelToItem(10138, 15654, 19)
    PushJewelToItem(10140, 15654, 19)
    PushJewelToItem(10140, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Ranger then
    PushJewelToItem(10210, 15127, 19)
    PushJewelToItem(10210, 15128, 19)
    PushJewelToItem(10338, 15654, 19)
    PushJewelToItem(10338, 15654, 19)
    PushJewelToItem(10340, 15654, 19)
    PushJewelToItem(10340, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Sorcerer then
    PushJewelToItem(10410, 15127, 19)
    PushJewelToItem(10410, 15128, 19)
    PushJewelToItem(10538, 15654, 19)
    PushJewelToItem(10538, 15654, 19)
    PushJewelToItem(10540, 15654, 19)
    PushJewelToItem(10540, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Giant then
    PushJewelToItem(10610, 15127, 19)
    PushJewelToItem(10610, 15128, 19)
    PushJewelToItem(10738, 15654, 19)
    PushJewelToItem(10738, 15654, 19)
    PushJewelToItem(10740, 15654, 19)
    PushJewelToItem(10740, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Tamer then
    PushJewelToItem(13210, 15127, 19)
    PushJewelToItem(13210, 15128, 19)
    PushJewelToItem(13038, 15654, 19)
    PushJewelToItem(13038, 15654, 19)
    PushJewelToItem(13040, 15654, 19)
    PushJewelToItem(13040, 15654, 19)
  elseif isClassType == UI_CT.ClassType_BladeMaster then
    PushJewelToItem(13310, 15127, 19)
    PushJewelToItem(13310, 15128, 19)
    PushJewelToItem(13138, 15654, 19)
    PushJewelToItem(13138, 15654, 19)
    PushJewelToItem(13140, 15654, 19)
    PushJewelToItem(13140, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Valkyrie then
    PushJewelToItem(10010, 15127, 19)
    PushJewelToItem(10010, 15128, 19)
  ...
  elseif isClassType == UI_CT.ClassType_NinjaWomen then
    PushJewelToItem(13210, 15127, 19)
    PushJewelToItem(13210, 15128, 19)
    PushJewelToItem(14538, 15654, 19)
    PushJewelToItem(14538, 15654, 19)
    PushJewelToItem(14540, 15654, 19)
    PushJewelToItem(14540, 15654, 19)
  elseif isClassType == UI_CT.ClassType_NinjaMan then
    PushJewelToItem(13210, 15127, 19)
    PushJewelToItem(13210, 15128, 19)
    PushJewelToItem(14638, 15654, 19)
    PushJewelToItem(14638, 15654, 19)
    PushJewelToItem(14640, 15654, 19)
    PushJewelToItem(14640, 15654, 19)
  elseif isClassType == UI_CT.ClassType_WizardWomen then
    PushJewelToItem(14410, 15127, 19)
    PushJewelToItem(14410, 15128, 19)
    PushJewelToItem(10338, 15654, 19)
    PushJewelToItem(10338, 15654, 19)
    PushJewelToItem(10340, 15654, 19)
    PushJewelToItem(10340, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Wizard then
    ...
    PushJewelToItem(10340, 15654, 19)
  elseif isClassType == UI_CT.ClassType_DarkElf then
    PushJewelToItem(11360, 15127, 19)
    PushJewelToItem(11360, 15128, 19)
    PushJewelToItem(10738, 15654, 19)
    PushJewelToItem(10738, 15654, 19)
    PushJewelToItem(10740, 15654, 19)
    PushJewelToItem(10740, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Combattant then
    PushJewelToItem(11910, 15127, 19)
    PushJewelToItem(11910, 15128, 19)
    PushJewelToItem(11338, 15654, 19)
    PushJewelToItem(11338, 15654, 19)
    PushJewelToItem(11340, 15654, 19)
    PushJewelToItem(11340, 15654, 19)
  elseif isClassType == UI_CT.ClassType_CombattantWomen then
    PushJewelToItem(11910, 15127, 19)
    PushJewelToItem(11910, 15128, 19)
    ...
    PushJewelToItem(11340, 15654, 19)
  elseif isClassType == UI_CT.ClassType_Lahn then
    PushJewelToItem(13410, 15127, 19)
    PushJewelToItem(13410, 15128, 19)
    PushJewelToItem(13538, 15654, 19)
    PushJewelToItem(13538, 15654, 19)
    PushJewelToItem(13540, 15654, 19)
    PushJewelToItem(13540, 15654, 19)
  end
end
