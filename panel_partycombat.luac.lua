...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\party\panel_partycombat.luac 
...
local returnTime = 0
local partyMemberCount, isLeader, registerState = nil, nil, nil
local matchType = 0
local regionInfo = getRegionInfoByPosition(((getSelfPlayer()):get()):getPosition())
local regionName = regionInfo:getAreaName()
local matchInfo = {_Button_Info = (UI.getChildControl)(Panel_Party, "Match_Button_MatchInfo"), _Button_Combat = (UI.getChildControl)(Panel_Party, "Match_Button_Combat"), _BG = (UI.getChildControl)(Panel_Party, "Match_BG"), _Party_Icon = (UI.getChildControl)(Panel_Party, "Match_Party_Icon"), _Party_Text = (UI.getChildControl)(Panel_Party, "Match_Party_Text"), _Party_Value = (UI.getChildControl)(Panel_Party, "Match_Party_Value"), _Time_Icon = (UI.getChildControl)(Panel_Party, "Match_Time_Icon"), _RemainTime_Text = (UI.getChildControl)(Panel_Party, "Match_RemainTime_Text"), _RemainTime_Value = (UI.getChildControl)(Panel_Party, "Match_RemainTime_Value"), _State_BG = (UI.getChildControl)(Panel_Party, "Match_State_BG"), _State = (UI.getChildControl)(Panel_Party, "Match_State"), _RegStatus_Text = (UI.getChildControl)(Panel_Party, "Match_RegStatus_Text"), 
config = {sizeX = 170, sizeY = 75, bgX = 3, stateBGminiX = 1, stateBGminiY = 0, stateminiX = 1, stateminiY = 6}
}
local matchResult = {_Button_Close = (UI.getChildControl)(Panel_MatchResult, "Button_Close"), _Ace = (UI.getChildControl)(Panel_MatchResult, "Icon_Ace"), _Title = (UI.getChildControl)(Panel_MatchResult, "Text_Title"), _Result_Title_Back_Win = (UI.getChildControl)(Panel_MatchResult, "Result_Title_Back_Win"), _Result_Title_Back_Lose = (UI.getChildControl)(Panel_MatchResult, "Result_Title_Back_Lose"), _Line_Top_Win = (UI.getChildControl)(Panel_MatchResult, "Line_Top_Win"), _Line_Bottom_Win = (UI.getChildControl)(Panel_MatchResult, "Line_Bottom_Win"), _Line_Top_Lose = (UI.getChildControl)(Panel_MatchResult, "Line_Top_Lose"), _Line_Bottom_Lose = (UI.getChildControl)(Panel_MatchResult, "Line_Bottom_Lose"), _Back_Actor = (UI.getChildControl)(Panel_MatchResult, "Back_Actor"), _TotalPoint_Ali = (UI.getChildControl)(Panel_MatchResult, "TotalPoint_Ali"), _TotalPoint_Ene = (UI.getChildControl)(Panel_MatchResult, "TotalPoint_Ene"), _EndInfo_Sec = (UI.getChildControl)(Panel_MatchResult, "Text_EndInfo_Sec"), 
_Icon_Class = {[0] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ali_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ali_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ali_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ene_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ene_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Icon_Class_Ene_3")}
, 
_Name = {[0] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Name_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Name_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Name_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Name_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Name_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Name_3")}
, 
_Kill = {[0] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Kill_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Kill_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Kill_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Kill_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Kill_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Kill_3")}
, 
_Point = {[0] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Point_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Point_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Text_Ali_Point_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Point_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Point_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Text_Ene_Point_3")}
, 
_Icon_Kill = {[0] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ali_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ali_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ali_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ene_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ene_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Icon_Kill_Ene_3")}
, 
_Icon_Point = {[0] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ali_1"), [1] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ali_2"), [2] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ali_3"), [3] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ene_1"), [4] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ene_2"), [5] = (UI.getChildControl)(Panel_MatchResult, "Icon_Point_Ene_3")}
, 
_acePosX = {[0] = 145, [1] = 145, [2] = 145, [3] = 438, [4] = 438, [5] = 438}
, 
_acePosY = {[0] = 132, [1] = 185, [2] = 238, [3] = 132, [4] = 185, [5] = 238}
, _selfBackPosX = 16, 
_selfBackPosY = {[0] = 143, [1] = 196, [2] = 249, [3] = 143, [4] = 196, [5] = 249}
}
matchInfo.init = function(self, isEnableChannel)
  -- function num : 0_0 , upvalues : matchInfo, UI_color
  ...
  if isEnableChannel == nil or isEnableChannel == true then
...
matchInfo.setPosition = function(self)
  -- function num : 0_1 , upvalues : matchInfo, isLeader
...
FromClient_UpdateMatchInfo = function(matchType, matchState)
  -- function num : 0_2 , upvalues : matchInfo, UI_color
  ...
  if (CppEnums.MatchType).Pvp == matchType then
    if matchState == 0 then
      ...
      if matchState == -2 then
        messages = {main = PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_MATCHSTATUS_NAK_NOTEAM"), sub = "", addMsg = ""}
        ;
        (matchInfo._Button_Info):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_BUTTON_INFO"))
        ;
        (matchInfo._Button_Info):SetEnable(true)
        ...
        if matchState == 1 then
          ...
          if matchState == 2 then
            messages = {main = PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_MATCHSTATUS_NAK_WAITWARP"), sub = "", addMsg = ""}
            ;
            ...
            if matchState == 3 then
              messages = {main = PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_MATCHSTATUS_NAK_WAITFIGHT"), sub = "", addMsg = ""}
              ;
    ...
    if matchState == 5 then
      Proc_ShowMessage_Ack_For_RewardSelect(messages, 10, 31)
      if (CppEnums.MatchType).Race == matchType then
        local messages = {main = "", sub = "", addMsg = ""}
        if matchState == 2 then
...
FromClient_MatchPvpResult = function(isWin)
  -- function num : 0_3 , upvalues : matchResult, UI_color, matchInfo
  local messages = {main = "", sub = "", addMsg = ""}
  if isWin then
    messages = {main = PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_MATCHRESULT_NAK_WIN"), sub = "", addMsg = ""}
    ;
    ...
    messages = {main = PAGetString(Defines.StringSheet_GAME, "LUA_PARTYCOMBAT_MATCHRESULT_NAK_LOOSE"), sub = "", addMsg = ""}
    ;
...
HandleClicked_MatchOpen = function(compactInfo)
  -- function num : 0_4 , upvalues : matchInfo
  matchInfo:setPosition()
...
HandleClicked_MatchClose = function()
  -- function num : 0_5 , upvalues : matchInfo
  (matchInfo._BG):SetShow(false)
  ;
  (matchInfo._State_BG):SetShow(false)
  ;
...
Party_MatchClose = function()
  -- function num : 0_6 , upvalues : matchInfo
  (matchInfo._BG):SetShow(false)
  ;
  (matchInfo._State_BG):SetShow(false)
  ;
...
HandleClicked_MatchResultClose = function()
  -- function num : 0_7
  Panel_MatchResult:SetShow(false)
end

matchInfo.RequestInfo = function(self)
  -- function num : 0_8 , upvalues : matchType, matchInfo
  ToClient_RequestMatchInfo(matchType)
  matchInfo:setPosition()
  matchInfo:updateRegisterState()
end

HandleClicked_RequestMatchInfoOpen = function()
  -- function num : 0_9 , upvalues : matchInfo
...
HandleClicked_RegisterMatch = function()
  -- function num : 0_10 , upvalues : registerState, matchInfo
...
matchInfo.updateRegisterState = function(self)
  -- function num : 0_11 , upvalues : registerState, matchInfo, UI_color
  registerState = ToClient_IsRequestedPvP()
...
FromClient_MatchInfo = function(matchType, isRegister, registerCount, remainedMinute, matchState, param1)
  -- function num : 0_12 , upvalues : matchInfo
  matchInfo:updateRegisterState()
  if (CppEnums.MatchType).Pvp == matchType then
    if isRegister then
...
FromClient_PvPRegisterComplete = function(matchType)
  -- function num : 0_13 , upvalues : matchInfo
  if (CppEnums.MatchType).Pvp == matchType then
...
FromClient_PvPUnRegisterComplete = function(matchType)
  -- function num : 0_14 , upvalues : matchInfo
  if (CppEnums.MatchType).Pvp == matchType then
...
matchInfoJoinBTSimpletooltips = function(isShow, contolNo)
  -- function num : 0_15
...
matchResultTimeCount = function(deltaTime)
  -- function num : 0_16 , upvalues : returnTime, matchResult
...
FGlobal_UpdatePartyState = function(inPartyMemberCount, inisLeader)
  -- function num : 0_17 , upvalues : partyMemberCount, isLeader, registerState, matchInfo
  if inPartyMemberCount == nil or inisLeader == nil then
    return 
  end
  if inPartyMemberCount ~= partyMemberCount or inisLeader ~= isLeader then
    partyMemberCount = inPartyMemberCount
    isLeader = inisLeader
    if partyMemberCount >= 4 and registerState == true then
      ToClient_UnRequestMatchInfo()
    end
    if (matchInfo._BG):GetShow() then
...
matchInfo.registEventHandler = function(self)
  -- function num : 0_18 , upvalues : matchInfo, matchResult
...
matchInfo.registMessageHandler = function(self)
  -- function num : 0_19
...
isShow_PartyMatchBg = function()
  -- function num : 0_21 , upvalues : matchInfo
  local sizeY = 0
  if (matchInfo._BG):GetShow() then
