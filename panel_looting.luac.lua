...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\x86\window\looting\panel_looting.luac 
...
Panel_Looting_Update = function(empty)
  ...
  if looting_isPickItemToServant() then
    ...
    Panel_Looting:addConsoleUIControl(0, 1, 1, _buttonLootAllToServant)
    Panel_Looting:addConsoleUIControl(1, 1, 1, _buttonLootAll)
    Panel_Looting:addConsoleUIControl(2, 1, 1, _buttonCancel)
  else
    Panel_Looting:deleteConsoleUIGroup(1)
    Panel_Looting:addConsoleUIControl(1, 1, 1, _buttonLootAll)
    Panel_Looting:addConsoleUIControl(2, 1, 1, _buttonCancel)
  ...
  for ii = 1, looting.MAX_LOOTING_SLOT_COUNT do
    ...
    if itemWrapper ~= nil then
      ...
      Panel_Looting:addConsoleUIControl(ii - 1, 4, 0, _buttonLootAll)
    else
