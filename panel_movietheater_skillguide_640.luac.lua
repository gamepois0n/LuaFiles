...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\movie\panel_movietheater_skillguide_640.luac 
...
Panel_MovieTheater_SkillGuide_640_Initialize = function()
  -- function num : 0_2 , upvalues : _movieTheater_640, messageUI
...
FGlobal_Panel_MovieTheater_SkillGuide_640_UrlReset = function()
  -- function num : 0_4 , upvalues : _movieTheater_640
  _movieTheater_640:ResetUrl()
end

Panel_MovieTheaterSkillGuide640_ShowToggle = function(classNo, titleNo)
  -- function num : 0_5 , upvalues : messageUI, _movieTheater_640, helpBubble, helpMsg, _comboList, UI_TM, playedNo, _txt_Title, warriorText, comboDesc, rangerText, sorcererText, giantText, tamerText, combattantText, bladerText, bladerWomenText, valkyrieText, ninjaWomenText, ninjaManText, wizardText, wizardWomenText, darkelfText, combattantWomenText, _btn_Replay, _btn_Close
  Panel_MovieTheater_MessageBox:SetShow(false)
  for _,v in pairs(messageUI) do
    v:SetShow(false)
  end
...
Panel_MovieTheater_SkillGuide_640_Replay = function()
  -- function num : 0_6 , upvalues : _movieTheater_640, playedNo
  if not _movieTheater_640:isReadyView() then
    return 
  end
                                                                                                                            ...
                                                                                                                            if playedNo == 1301 then
                                                                                                                              ...
                                                                                                                              if playedNo == 1302 then
                                                                                                                                ...
                                                                                                                                if playedNo == 1303 then
                                                                                                                                  ...
                                                                                                                                  if playedNo == 1304 then
                                                                                                                                    _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                  else
                                                                                                                                    if playedNo == 1400 then
                                                                                                                                      _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                    else
                                                                                                                                      if playedNo == 1401 then
                                                                                                                                        _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                      else
                                                                                                                                        if playedNo == 1402 then
                                                                                                                                          _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                        else
                                                                                                                                          if playedNo == 1403 then
                                                                                                                                            _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                          else
                                                                                                                                            if playedNo == 1404 then
                                                                                                                                              _movieTheater_640:TriggerEvent("PlayMovie", "coui://UI_Movie/Movie_Pc_Skill/11_Common_ComboGuide/" .. playedNo .. ".webm")
                                                                                                                                            end
                                                                                                                                          end
                                                                                                                                        end
...
Panel_MovieTheater_SkillGuide_640_ShowControl = function()
  -- function num : 0_8 , upvalues : _movieTheater_640
  _movieTheater_640:TriggerEvent("ShowControl", "true")
end

Panel_MovieTheater_SkillGuide_640_HideControl = function()
