...
Panel_MovieTheaterSkillGuide640_ShowToggle = function(classNo, titleNo)
  -- function num : 0_5 , upvalues : messageUI, _movieTheater_640, helpBubble, helpMsg, _comboList, UI_TM, playedNo, _txt_Title, warriorText, comboDesc, rangerText, sorcererText, giantText, tamerText, combattantText, bladerText, bladerWomenText, valkyrieText, ninjaWomenText, ninjaManText, wizardText, wizardWomenText, darkelfText, _btn_Replay, _btn_Close
  Panel_MovieTheater_MessageBox:SetShow(false)
  for _,v in pairs(messageUI) do
    v:SetShow(false)
  end
