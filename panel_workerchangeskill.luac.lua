...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\workermanager\panel_workerchangeskill.luac 
...
ui = {panelBG = (UI.getChildControl)(Panel_WorkerChangeSkill, "Static_BG"), btn_Confirm = (UI.getChildControl)(Panel_WorkerChangeSkill, "Button_Confirm"), btn_Cancel = (UI.getChildControl)(Panel_WorkerChangeSkill, "Button_Cancel"), btn_Close = (UI.getChildControl)(Panel_WorkerChangeSkill, "Button_Close")}
, 
config = {maxSkillCount = 7}
, selectedWorkerNoRaw = nil, selectedSkillKeyRaw = nil, 
uiPool = {}
}
workerChangeSkill.Init = function(self)
...
workerChangeSkill.Update = function(self)
...
WorkerChangeSkill_SimpleTooltip = function(isShow, skillIndex)
  -- function num : 0_2 , upvalues : workerChangeSkill
  if not isShow then
    TooltipSimple_Hide()
    return 
  end
...
HandleClicked_WorkerChangeSkill_Select = function(skillKeyRaw)
  -- function num : 0_3 , upvalues : workerChangeSkill
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R1 in 'UnsetPending'

  workerChangeSkill.selectedSkillKeyRaw = skillKeyRaw
end

HandleClicked_WorkerChangeSkill_Do = function()
  -- function num : 0_4 , upvalues : workerChangeSkill
  local prevWorkerSkillKeyRaw = workerChangeSkill.selectedSkillKeyRaw
  local workerNoRaw = workerChangeSkill.selectedWorkerNoRaw
  if prevWorkerSkillKeyRaw == nil or workerNoRaw == nil then
...
HandleClicked_WorkerChangeSkill_Close = function()
  -- function num : 0_5 , upvalues : workerChangeSkill
  Panel_WorkerChangeSkill:SetShow(false)
...
FGlobal_workerChangeSkill_Close = function()
  -- function num : 0_8 , upvalues : workerChangeSkill
...
workerChangeSkill_Open = function(worker_Index)
  -- function num : 0_9 , upvalues : workerChangeSkill
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R1 in 'UnsetPending'
...
workerChangeSkill.registEventHandler = function(self)
  -- function num : 0_10
...
workerChangeSkill.registMessageHandler = function(self)
  -- function num : 0_11
