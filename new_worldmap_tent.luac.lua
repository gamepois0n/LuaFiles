...
FromClient_TentTooltipHide = function(tentIcon, householdDataWithInstallationWrapper)
  -- function num : 0_2 , upvalues : tooltipTentUI
...
Panel_Worldmap_TentInfo_UpdateFrame = function(deltaTime)
  -- function num : 0_3 , upvalues : tentInformationMouseOverActorKey, createList, _workingListBg, _workingText, defaultWorkingListSize, _workingDataBg, defaultWorkingDataSizeWithoutList, defaultWorkingPanelSizeWithoutList, workingRawSizeY
