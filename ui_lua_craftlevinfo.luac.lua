...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\craftlevinfo\ui_lua_craftlevinfo.luac 
...
local CraftLevInfo = {gathering_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Gathering"), manufacture_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Manufacture"), cook_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Cook"), training_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Training"), alchemy_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Alchemy"), fishing_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Fishing"), hunting_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Hunting"), trade_Icon = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Static_Icon_Trade"), gathering_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_GatheringLevel_Gauge"), manufacture_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_ManufactureLevel_Gauge"), cook_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_CookLevel_Gauge"), training_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_TrainingLevel_Gauge"), alchemy_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_AlchemyLevel_Gauge"), fishing_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_FishingLevel_Gauge"), hunting_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_HuntingLevel_Gauge"), trade_Progress = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "Progress2_TradeLevel_Gauge"), gathering_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_GatheringLevel_Value"), manufacture_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_ManufactureLevel_Value"), cook_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_CookLevel_Value"), training_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_TrainingLevel_Value"), alchemy_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_AlchemyLevel_Value"), fishing_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_FishingLevel_Value"), hunting_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_HuntingLevel_Value"), trade_LevText = (UI.getChildControl)(Panel_Widget_CraftLevInfo, "StaticText_TradeLevel_Value")}
local craftType = {gather = 0, fishing = 1, hunting = 2, cooking = 3, alchemy = 4, manufacture = 5, training = 6, trade = 7, levelText = PAGetString(Defines.StringSheet_GAME, "LUA_CHARACTERINFO_TEXT_CRAFTLEVEL")}
CraftLevInfo.registEventHandler = function(self)
  -- function num : 0_0
end

CraftLevInfo.registMessageHandler = function(self)
  -- function num : 0_1
...
local CraftLevInfo_Initialize = function()
  -- function num : 0_2 , upvalues : CraftLevInfo
...
CraftLevInfo.Update = function(self)
  -- function num : 0_5 , upvalues : craftType
...
FromClient_CraftLevInfoUpdate = function()
  -- function num : 0_6 , upvalues : CraftLevInfo
  local self = CraftLevInfo
  self:Update()
end

CraftLevInfo_RollOver = function(show, type)
  -- function num : 0_7 , upvalues : CraftLevInfo, craftType, helpWidget
  local self = CraftLevInfo
  local text, posX, posY = nil, nil, nil
  if show == true then
    if craftType.gather == type then
      ...
      if craftType.manufacture == type then
        ...
        if craftType.cooking == type then
          ...
          if craftType.alchemy == type then
            ...
            if craftType.fishing == type then
              ...
              if craftType.hunting == type then
                ...
                if craftType.training == type then
...
FromClient_CraftLevInfo_OnScreenResize = function()
  -- function num : 0_8
  Panel_Widget_CraftLevInfo:SetPosX(15)
  Panel_Widget_CraftLevInfo:SetPosY(getScreenSizeY() - Panel_Widget_CraftLevInfo:GetSizeY())
end

CraftLevInfo_Show = function()
  -- function num : 0_9
...
Panel_Widget_CraftLevInfo_ShowToggle = function()
  -- function num : 0_11
end
