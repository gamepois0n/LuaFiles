...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tutorial\panel_arousaltutorial_uiblackspirit.luac 

-- params : ...
-- function num : 0
PaGlobal_ArousalTutorial_UiBlackSpirit = {
_ui = {_obsidian = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Obsidian"), _obsidian_B = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Obsidian_B"), _obsidian_B_Left = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Obsidian_B_Left"), _obsidian_Text = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Obsidian_B"), _obsidian_Text_2 = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Obsidian_B_2"), _bubbleKey_W = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_W"), _bubbleKey_A = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_A"), _bubbleKey_S = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_S"), _bubbleKey_D = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_D"), _bubbleKey_I = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_I"), _bubbleKey_R = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_R"), _bubbleKey_T = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_T"), _bubbleKey_Shift = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_Shift"), _bubbleKey_Ctrl = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_BubbleKey_Ctrl"), _mouseBody_L = (UI.getChildControl)(Panel_ArousalTutorial, "Static_MouseBody_L"), _mouseLButton_L = (UI.getChildControl)(Panel_ArousalTutorial, "Static_L_Btn_L"), _mouseLButton_R = (UI.getChildControl)(Panel_ArousalTutorial, "Static_L_Btn_R"), _mouseBody_R = (UI.getChildControl)(Panel_ArousalTutorial, "Static_MouseBody_R"), _mouseRButton_L = (UI.getChildControl)(Panel_ArousalTutorial, "Static_R_Btn_L"), _mouseRButton_R = (UI.getChildControl)(Panel_ArousalTutorial, "Static_R_Btn_R")}
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setShowMouseL = function(self, bShow)
  -- function num : 0_0
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setPosMouseL = function(self, posX, posY)
  -- function num : 0_1
...
PaGlobal_ArousalTutorial_UiBlackSpirit.initialize = function(self)
  -- function num : 0_2
...
PaGlobal_ArousalTutorial_UiBlackSpirit.getBubbleKeyMargin = function(self)
  -- function num : 0_3
...
PaGlobal_ArousalTutorial_UiBlackSpirit.eraseEffect = function(self, key)
  -- function num : 0_4
...
PaGlobal_ArousalTutorial_UiBlackSpirit.addEffect = function(self, key, effectName, isLoop, posX, posY)
  -- function num : 0_5
...
PaGlobal_ArousalTutorial_UiBlackSpirit.addEffectBlackSpirit = function(self, effectName, isLoop, posX, posY)
  -- function num : 0_6
...
PaGlobal_ArousalTutorial_UiBlackSpirit.eraseEffectBlackSpirit = function(self)
  -- function num : 0_7
...
PaGlobal_ArousalTutorial_UiBlackSpirit.resetPosition = function(self)
  -- function num : 0_8
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setShow = function(self, key, isShow)
  -- function num : 0_9
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setPosX = function(self, key, posX)
  -- function num : 0_10
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setPosY = function(self, key, posY)
  -- function num : 0_11
...
PaGlobal_ArousalTutorial_UiBlackSpirit.getPosX = function(self, key, posX)
  -- function num : 0_12
...
PaGlobal_ArousalTutorial_UiBlackSpirit.getPosY = function(self, key, posY)
  -- function num : 0_13
...
PaGlobal_ArousalTutorial_UiBlackSpirit.getSizeY = function(self, key, sizeY)
  -- function num : 0_14
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setShowBubbleKey = function(self, key, isShow)
  -- function num : 0_15
  ((self._ui)[key]):SetShow(isShow)
end
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setShowBlackSpirit = function(self, isShow)
  -- function num : 0_16
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setShowAll = function(self, isShow)
  -- function num : 0_17
...
PaGlobal_ArousalTutorial_UiBlackSpirit.hideBubbleKey = function(self)
  -- function num : 0_18
...
PaGlobal_ArousalTutorial_UiBlackSpirit.changeBubbleKeyByKeySetting = function(self)
  -- function num : 0_19
...
PaGlobal_ArousalTutorial_UiBlackSpirit.showSuggestCallSpiritUi = function(self)
  -- function num : 0_20
...
PaGlobal_ArousalTutorial_UiBlackSpirit.resetSpiritUiForTutorial = function(self)
  -- function num : 0_21
  self:resetPosition()
  ;
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setSpiritUiForTutorial = function(self, text1, text2, isLeftSideBubble, spiritPosX, spiritPosY, isIgnore)
  -- function num : 0_22
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setSpiritUiForTutorialFunctor = function(self, functor)
  -- function num : 0_23
...
PaGlobal_ArousalTutorial_UiBlackSpirit.doSpiritUiForTutorialFunctor = function(self)
  -- function num : 0_24
  if PaGlobal_ArousalTutorial_UiBlackSpirit._blackSpiritRestorFunctor == nil then
    return 
  end
  ;
...
PaGlobal_ArousalTutorial_UiBlackSpirit.addBubbleKey = function(self, ...)
  -- function num : 0_25
...
PaGlobal_ArousalTutorial_UiBlackSpirit.addOverBubbleKey = function(self, destKey, targetKey)
  -- function num : 0_26
...
PaGlobal_ArousalTutorial_UiBlackSpirit.getCurrentObsidianBubble = function(self)
  -- function num : 0_27
...
PaGlobal_ArousalTutorial_UiBlackSpirit.setIgnoreBubble = function(self, bIgnore)
  -- function num : 0_28
...
PaGlobal_ArousalTutorial_UiBlackSpirit.handleMouseOnBubble = function(self)
  -- function num : 0_29
  local currentBubble = self:getCurrentObsidianBubble()
...
PaGlobal_ArousalTutorial_UiBlackSpirit.handleMouseOutBubble = function(self)
  -- function num : 0_30
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
PaGlobal_ArousalTutorial_UiBlackSpirit.handleMouseLDownBubble = function(self)
  -- function num : 0_31
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
PaGlobal_ArousalTutorial_UiBlackSpirit.handleMouseLUpBubble = function(self)
  -- function num : 0_32
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
FromClient_luaLoadComplete_ArousalTutorial_UiBlackSpirit = function()
  -- function num : 0_33
  PaGlobal_ArousalTutorial_UiBlackSpirit:initialize()
end

OnResize_ArousalTutorial_UiBlackSpirit = function()
  -- function num : 0_34
...
PaGlobal_ArousalTutorial_UiBlackSpirit.changeBubbleTextureForAni = function(self, bWhite)
  -- function num : 0_35
  if Panel_ArousalTutorial:isPlayAnimation() == true then
