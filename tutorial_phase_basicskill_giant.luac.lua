...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\tutorial\tutorial_phase_basicskill_giant.luac 
...
PaGlobal_TutorialPhase_BasicSkill_Giant.startPhaseXXX = function(self, stepNo, typeNo)
  ...
  _PA_LOG("곽민�\176", "PaGlobal_TutorialPhase_BasicSkill_Giant:startStep() typeNo : " .. tostring(typeNo))
