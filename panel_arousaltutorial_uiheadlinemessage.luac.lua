...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tutorial\panel_arousaltutorial_uiheadlinemessage.luac 

-- params : ...
-- function num : 0
PaGlobal_ArousalTutorial_UiHeadlineMessage = {
_ui = {_purposeText = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Purpose"), _nextStep_1 = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Step_1"), _nextStep_2 = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Step_2"), _nextStep_3 = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Step_3"), _nextStep_4 = (UI.getChildControl)(Panel_ArousalTutorial, "StaticText_Step_4"), _nextArrow_0 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_NextArrow_0"), _nextArrow_1 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_NextArrow_1"), _nextArrow_2 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_NextArrow_2"), _clearStep_1 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Clear_Step1"), _clearStep_2 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Clear_Step2"), _clearStep_3 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Clear_Step3"), _clearStep_4 = (UI.getChildControl)(Panel_ArousalTutorial, "Static_Clear_Step4"), _mainBG = (UI.getChildControl)(Panel_ArousalTutorial, "Static_MainBG")}
}
-- DECOMPILER ERROR at PC84: Confused about usage of register: R0 in 'UnsetPending'

PaGlobal_ArousalTutorial_UiHeadlineMessage.setPurposeText = function(self, string)
  -- function num : 0_0
  if string == nil then
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.setShow = function(self, key, isShow)
  -- function num : 0_1
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.setAlpha = function(self, key, value)
  -- function num : 0_2
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.addEffect = function(self, key, effectName, isLoop, posX, posY)
  -- function num : 0_3
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.setShowAll = function(self, isShow)
  -- function num : 0_4
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.setAlphaAll = function(self, value)
  -- function num : 0_5
  for key,value in pairs(self._ui) do
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.setTextPurposeText = function(self, text)
  -- function num : 0_6
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.mainBGShow = function(self)
  -- function num : 0_7
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.computePosAll = function(self)
  -- function num : 0_8
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.resetShowAll = function(self)
  -- function num : 0_9
  self:computePosAll()
  ;
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.addClearStepEffect = function(self, clearCount)
  -- function num : 0_10
...
PaGlobal_ArousalTutorial_UiHeadlineMessage.resetClearStepEffect = function(self)
  -- function num : 0_11
  self:computePosAll()
  ;
  ((self._ui)._nextStep_1):SetFontColor((Defines.Color).C_FFFFFFFF)
