...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\x86\widget\enduarance\ship_endurance_main.luac 

-- params : ...
-- function num : 0
PaGlobalShipEnduranceList = {panel = Panel_ShipEndurance, enduranceTypeCount = 4, 
enduranceInfo = {}
, effectBG = (UI.getChildControl)(Panel_ShipEndurance, "Static_ShipEffect"), noticeEndurance = (UI.getChildControl)(Panel_ShipEndurance, "StaticText_NoticeEndurance"), repair_AutoNavi = (UI.getChildControl)(Panel_ShipEndurance, "CheckButton_Repair_AutoNavi"), repair_Navi = (UI.getChildControl)(Panel_ShipEndurance, "Checkbox_Repair_Navi")}
...
Panel_ShipEndurance_Position = function()
  ...
  if FGlobal_Panel_Radar_GetShow() then
    if (PaGlobalHorseEnduranceList.panel):GetShow() or (PaGlobalCarriageEnduranceList.panel):GetShow() then
      (self.panel):SetPosX(getScreenSizeX() - FGlobal_Panel_Radar_GetSizeX() - (self.panel):GetSizeX() * 3.1)
    else
      ;
      (self.panel):SetPosX(getScreenSizeX() - FGlobal_Panel_Radar_GetSizeX() - (self.panel):GetSizeX() * 1.9)
    end
    ;
