...
CharacterInfo_changedBattlePoint = function(battlePoint, tier)
  -- function num : 0_52 , upvalues : CharacterInfo, setTierIcon
  if Panel_Window_CharInfo_Status:GetShow() == false then
    return 
  end
...
CharacterInfo_updatePlayerTotalStat = function()
  -- function num : 0_53
  local selfPlayer = getSelfPlayer()
  if selfPlayer == nil then
    return 
...
CharacterInfo_PopUp_ShowIconToolTip = function(isShow)
  -- function num : 0_55 , upvalues : CharacterInfo
  if isShow then
    local self = CharacterInfo
