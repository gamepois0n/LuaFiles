...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\option\panel_gameoption_optimization.luac 
...
PaGlobal_GameOption_Optimization = {_frame_Optimization = (UI.getChildControl)(Panel_GameOption_Optimization, "Frame_Optimization")}
-- DECOMPILER ERROR at PC1322: Confused about usage of register: R3 in 'UnsetPending'

PaGlobal_GameOption_Optimization.Init = function(self)
  -- function num : 0_0
  self._frameContent_Optimization = (UI.getChildControl)(self._frame_Optimization, "Frame_1_Content")
  self._ui = {_optimization_sld = (UI.getChildControl)(self._frame_Optimization, "Frame_1_VerticalScroll"), _btn_Reset = (UI.getChildControl)(self._frameContent_Optimization, "Button_Reset"), _btn_Trxt = (UI.getChildControl)(self._frameContent_Optimization, "Button_TexQuality"), _btn_Trxt_L = (UI.getChildControl)(self._frameContent_Optimization, "Button_Txtr_L"), _btn_Trxt_R = (UI.getChildControl)(self._frameContent_Optimization, "Button_Txtr_R"), _btn_Rndr = (UI.getChildControl)(self._frameContent_Optimization, "Button_RenderQuality"), _btn_Rndr_L = (UI.getChildControl)(self._frameContent_Optimization, "Button_Rndr_L"), _btn_Rndr_R = (UI.getChildControl)(self._frameContent_Optimization, "Button_Rndr_R"), _btn_AntiAlli = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_Anti"), _btn_SSAO = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_SSAO"), _btn_PostFilter = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_PostFilter"), _btn_DOF = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_DOF"), _btn_Tessellation = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_Tessellation"), _btn_Ultra = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_Ultra"), _btn_CharacterEffect = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_CharacterEffect"), _btn_Represent = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_Representativepartmodel"), _btn_WorkerVisible = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_WorkerVisible"), _btn_SnowPoolOnlyInSafeZone = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_SnowPoolOnlyInSafeZone"), _txt_FPS = (UI.getChildControl)(self._frameContent_Optimization, "StaticText_FPS"), _slideText_FrameRate = (UI.getChildControl)(self._frameContent_Optimization, "StaticText_FPS_MID"), _btn_AutoOptimization = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_AutoOptimization"), _slide_AutoOptimization = (UI.getChildControl)(self._frameContent_Optimization, "Slider_AutoOptimization"), _btn_EffectOption = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_EffectOption"), _slide_AutoOptimization = (UI.getChildControl)(self._frameContent_Optimization, "Slider_AutoOptimization"), _slide_EffectOption = (UI.getChildControl)(self._frameContent_Optimization, "Slider_EffectOption"), _btn_PlayerEffectOption = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_PlayerEffectOption"), _slide_PlayerEffectOption = (UI.getChildControl)(self._frameContent_Optimization, "Slider_PlayerEffectOption"), _slideText_PlayerEffectFrame = (UI.getChildControl)(self._frameContent_Optimization, "StaticText_PlayerEffectFrame"), _btn_CharacterDistUpdate = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_useCharacterDistUpdate"), _btn_playerHide = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_playerHide"), _btn_UpscaleEnable = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_Upscale"), _btn_LowPower = (UI.getChildControl)(self._frameContent_Optimization, "CheckButton_LowPower"), _btn_ShowAttackEffect = (UI.getChildControl)(self._frameContent_Optimization, "CheckBox_ShowAttackEffect"), _txt_CameraMaster = (UI.getChildControl)(self._frameContent_Optimization, "StaticText_CameraMaster"), _slide_CameraMaster = (UI.getChildControl)(self._frameContent_Optimization, "Slider_CameraMasterControl"), _txt_Fov = (UI.getChildControl)(self._frameContent_Optimization, "StaticText_FovControl"), _slide_Fov = (UI.getChildControl)(self._frameContent_Optimization, "Slider_FovControl"), _btn_PetAll = (UI.getChildControl)(self._frameContent_Optimization, "RadioButton_PetVisualAll"), _btn_PetMine = (UI.getChildControl)(self._frameContent_Optimization, "RadioButton_PetVisualMine"), _btn_PetHide = (UI.getChildControl)(self._frameContent_Optimization, "RadioButton_PetVisualHide")}
  self._sld_btn = {_btn_AutoOptimizationSlide = (UI.getChildControl)((self._ui)._slide_AutoOptimization, "Slider_AutoOptimization_Button"), _btn_CameraMaster = (UI.getChildControl)((self._ui)._slide_CameraMaster, "Slider_CameraMaster_Button"), _btn_Fov = (UI.getChildControl)((self._ui)._slide_Fov, "Slider_FovControl_Button"), _btn_EffectOptionSlide = (UI.getChildControl)((self._ui)._slide_EffectOption, "Slider_EffectOption_Button"), _btn_PlayerEffectOptionSlide = (UI.getChildControl)((self._ui)._slide_PlayerEffectOption, "Slider_PlayerEffectOption_Button"), _btn_optimizationSlide = (UI.getChildControl)((self._ui)._optimization_sld, "Frame_1_VerticalScroll_CtrlButton")}
  self._pictureTooltip = {[0] = (UI.getChildControl)(self._frameContent_Optimization, "Static_trxt"), [1] = (UI.getChildControl)(self._frameContent_Optimization, "Static_AntiAlli"), [2] = (UI.getChildControl)(self._frameContent_Optimization, "Static_Dof"), [3] = (UI.getChildControl)(self._frameContent_Optimization, "Static_Tesselation"), [4] = (UI.getChildControl)(self._frameContent_Optimization, "Static_Ssao"), [5] = (UI.getChildControl)(self._frameContent_Optimization, "Static_NpcDetail")}
...
-- DECOMPILER ERROR at PC1326: Confused about usage of register: R3 in 'UnsetPending'

PaGlobal_GameOption_Optimization.Show_PictureTooltips = function(self, isShow, tooltipType)
  -- function num : 0_1
...
-- DECOMPILER ERROR at PC1331: Confused about usage of register: R3 in 'UnsetPending'

PaGlobal_GameOption_Optimization.RegistEvnetHandler = function(self)
  -- function num : 0_2 , upvalues : simpleToolTipIdx
  ...
  ;
  ((self._ui)._btn_WorkerVisible):addInputEvent("Mouse_LUp", "GameOption_CheckWorkerVisible()")
  ;
...
-- DECOMPILER ERROR at PC1335: Confused about usage of register: R3 in 'UnsetPending'

PaGlobal_GameOption_Optimization.SetShow = function(self, isShow)
  -- function num : 0_3
  (self._frame_Optimization):SetShow(isShow)
end

GameOption_OptimizationReset = function()
  -- function num : 0_4 , upvalues : chk_Option
