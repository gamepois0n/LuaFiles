...
GuildListInfoPage = {_scrollBar, _textBusinessFunds, _btnGiveIncentive, _btnDeposit, _btnPaypal, decoIcon_Guild, decoIcon_Clan, _frameGuildList, _contentGuildList; _frameDefaultBG = (UI.getChildControl)(Panel_Window_Guild, "Static_Frame_ListBG"), _buttonListBG = (UI.getChildControl)(Panel_Guild_List, "Static_FunctionBG"), 
_list = {}
, 
_buttonList = {}
}
...
-- DECOMPILER ERROR at PC451: Confused about usage of register: R55 in 'UnsetPending'
...
HandleClicked_VoiceChatListeningVolume = function()
  ...
  if myGuildMemberInfo:isSelf() then
    ...
    if prevVoiceChatListen ~= isListening then
      _PA_LOG("asdf", "ì˜µì…˜ì\180 ë³\128ê²\189 ë©ë‹ˆë‹\164.")
      ToClient_VoiceChatChangeState((CppEnums.VoiceChatType).eVoiceChatType_Guild, myGuildMemberInfo:getUserNo(), isSaying, isListening, false)
    end
    FGlobal_VoiceChatState()
  else
...
HandleClick_GuildMemberList_Listening = function(index)
  ...
  local myGuildMemberInfo = myGuildListInfo:getMember(dataIdx)
  if myGuildMemberInfo == nil then
    _PA_LOG("asdf", " ê¸¸ë“œì›ì„ ì°¾ì„ ìˆ\152 ì—†ìŠµë‹ˆë‹¤. index : " .. tostring(index) .. " dataIdx : " .. tostring(dataIdx))
    return 
  end
