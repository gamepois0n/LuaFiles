...
authorityCheck = function(memberType, gradeType, buttonType, isProtect)
  ...
  if memberType == 0 then
    if gradeType == 0 then
      ...
      if gradeType == 1 and (buttonType == 0 or buttonType == 2 or buttonType == 3 or buttonType == 6 or buttonType == 7 or buttonType == 8) then
        returnValue = true
      end
    end
    if gradeType == 2 then
      ...
      if gradeType == 3 and (buttonType == 0 or buttonType == 1 or buttonType == 2 or buttonType == 6 or buttonType == 8) then
        returnValue = true
      end
    end
  ...
  if gradeType == 3 and (buttonType == 0 or buttonType == 6 or buttonType == 8) then
    returnValue = true
  end
  if memberType == 2 and (buttonType == 0 or buttonType == 6) then
    returnValue = true
  end
  return returnValue
end
...
HandleClickedGuildMemberMenuButton = function(index)
  -- function num : 0_5 , upvalues : tempGuildList, _constCollectionY, _UI_Menu_Button, _selectIndex
...
HandleClickedGuildMemberContractButton = function(index)
  -- function num : 0_6 , upvalues : tempGuildList
...
HandleCLicked_GuildListIncentive_Open = function()
  -- function num : 0_8 , upvalues : _incentivePanelType, incentive_InputMoney, txt_incentive_Title, txt_incentive_Deposit, txt_incentive_Notify
...
HandleCLicked_GuildListIncentive_Deposit = function()
  -- function num : 0_9 , upvalues : _incentivePanelType, inputGuildDepositMaxNum_s64, incentive_InputMoney, txt_incentive_Title, txt_incentive_Deposit, txt_incentive_Notify
...
checkVoiceChatListenOtherTexture = function(onOff)
  -- function num : 0_13 , upvalues : listening_VolumeButton
                              ...
                              if index == _UI_Menu_Button.Type_Supply then
                                ...
                                if index == _UI_Menu_Button.Type_Whisper then
                                  ...
                                  if _UI_Menu_Button.Type_PriceLimit == index then
                                    ...
                                    ;
                                    (UI.ASSERT)(false, "ÏûëÏóÖÌï¥ÏïºÌï©ÎãàÎã\164!")
                                    return 
                                  end
                                end
                              end
...
HandleClicked_GuildListSort = function(sortType)
  ...
  if sortType == 0 then
    if _listSort.grade == false then
      staticText_Grade:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_POSITION") .. "‚ñ\178")
      -- DECOMPILER ERROR at PC21: Confused about usage of register: R1 in 'UnsetPending'

      _listSort.grade = true
    else
      staticText_Grade:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_POSITION") .. "‚ñ\188")
    ...
    if sortType == 1 then
      if _listSort.level == false then
        staticText_Level:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_LEVEL") .. "‚ñ\178")
        -- DECOMPILER ERROR at PC58: Confused about usage of register: R1 in 'UnsetPending'

        _listSort.level = true
      else
        staticText_Level:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_LEVEL") .. "‚ñ\188")
      ...
      if sortType == 2 then
        if _listSort.class == false then
          staticText_Class:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CLASS") .. "‚ñ\178")
          -- DECOMPILER ERROR at PC95: Confused about usage of register: R1 in 'UnsetPending'

          _listSort.class = true
        else
          staticText_Class:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CLASS") .. "‚ñ\188")
        ...
        if sortType == 3 then
          if _listSort.name == false then
            staticText_charName:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CHARNAME") .. "‚ñ\178")
            -- DECOMPILER ERROR at PC132: Confused about usage of register: R1 in 'UnsetPending'

            _listSort.name = true
          else
            staticText_charName:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_CHARNAME") .. "‚ñ\188")
          ...
          if sortType == 4 then
            if _listSort.ap == false then
              staticText_activity:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_ACTIVITY") .. "‚ñ\178")
              -- DECOMPILER ERROR at PC169: Confused about usage of register: R1 in 'UnsetPending'

              _listSort.ap = true
            else
              staticText_activity:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_ACTIVITY") .. "‚ñ\188")
            ...
            if sortType == 5 then
              if _listSort.expiration == false then
                staticText_contract:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_HIRE") .. "‚ñ\178")
                -- DECOMPILER ERROR at PC206: Confused about usage of register: R1 in 'UnsetPending'

                _listSort.expiration = true
              else
                staticText_contract:SetText(PAGetString(Defines.StringSheet_RESOURCE, "GUILD_TEXT_HIRE") .. "‚ñ\188")
              ...
              if sortType == 6 then
                if _listSort.wp == false then
                  staticText_contributedTendency:SetText(text_contributedTendency .. "‚ñ\178")
                  ...
                  if _listSort.kp == false then
                    ...
                    staticText_contributedTendency:SetText(text_contributedTendency .. "‚ñ\188")
                ...
                if sortType == 7 then
                  if _listSort.siegegrade == false then
                    staticText_WarGrade:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GUILDLIST_WARGRADETITLE") .. "‚ñ\178")
                    -- DECOMPILER ERROR at PC287: Confused about usage of register: R1 in 'UnsetPending'

                    _listSort.siegegrade = true
                  else
                    staticText_WarGrade:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_GUILDLIST_WARGRADETITLE") .. "‚ñ\188")
                                                ...
                                                if UI_Class.ClassType_CombattantWomen == classType then
                                                  ...
                                                  if UI_Class.ClassType_Lahn == classType then
                                                    ...
                                                    if UI_Class.ClassType_Orange == classType then
                                                      (((self._list)[index])._class):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_GLOBAL_CLASSTYPE_RAN") .. "ÎèôÎ¨ò")
                                                    end
                                                  end
                                                end
                                              end
...
FromClient_ChangedSiegeGrade = function(isNotify, userName, grade)
  ...
  if isNotify == true then
    Proc_ShowMessage_Ack("Í∏∏Îìú Îå\128Ïû•Ïù¥ " .. userName .. " Î™®ÌóòÍ∞\128ÎãòÏùò Ï†êÎ†π Í∏∞ÌöåÎ•\188 " .. tostring(6 - grade) .. "ÌöåÎ°ú Î≥\128Í≤ΩÌñàÏäµÎãàÎã\164.")
  end
  GuildListInfoPage:UpdateData()
end
