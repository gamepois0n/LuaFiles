...
local Panel_Control = {_win_Close = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Button_Win_Close"), _buttonQuestion = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Button_Question"), _txt_House_Title = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_Title")}
local HouseInfo_Control = {_BG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_HouseInfo_BG"), _Name = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_HouseInfo_Name"), _Desc = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_HouseInfo_Desc"), _UseType_Icon = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_HouseInfo_UseType_Icon"), _UseType_Name = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_HouseInfo_UseType_Name"), _UseType_Desc = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_HouseInfo_UseType_Desc"), _houseKeyRaw = nil}
local HouseUseType_Control = {_txt_UseType_Title = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_UseType_Title"), _controlBG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_HouseControl_BG"), _scrollBar = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Scroll_ScrollBar"), listCount = 8, gradeCount = 5, 
uiList = {}
}
local HouseUseTypeState_Control = {_BG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_CostBG"), _WorkName = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_WorkName"), _Icon_BG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_Working_IconBG"), _Icon_Working = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_Working_Icon"), _OnGoingText = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_OnGoing_Text"), _OnGoingText_Vlaue = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_OnGoing_Value"), _Btn_LargCraft = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Button_LargeCraft")}
...
local WorkList_Control = {_Title = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_WorkList_Title"), _controlBG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_WorkList_BG"), _scrollButton = nil, _iconBG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Button_WorkList"), _iconBorder = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_WorkList_Border"), _iconOver = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_WorkList_Over"), _level = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_WorkList_Level"), _level_nonCraft = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_WorkList_Level_nonCraft"), _guide = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_WorkList_Guide"), _guide_MyHouse = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_MyHouse_Guide"), _icon = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_WorkList_Icon"), _scroll = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "WorkList_ScrollBar"), _startSlotIndex = 0, _maxRow = 4, _totalRow = 4, _selecthouseKeyRaw = nil, _selectRecipeKeyRaw = nil, maxPoolNo = 4, maxIconRow = 5, 
titlePool = {}
, 
iconPool = {}
}
local HouseImage_Control = {_Title = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "StaticText_HouseImage_Title"), _BG = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_HouseImage_BG"), _Image = (UI.getChildControl)(Worldmap_Grand_GuildHouseControl, "Static_HouseImage_Image")}
local guildHouse_Img = {[2110] = "icon/new_icon/03_etc/06_housing/2110.dds", [2140] = "icon/new_icon/03_etc/06_housing/2140.dds", [2183] = "icon/new_icon/03_etc/06_housing/2183.dds", [2188] = "icon/new_icon/03_etc/06_housing/2188.dds", [2228] = "icon/new_icon/03_etc/06_housing/2228.dds", [2427] = "icon/new_icon/03_etc/06_housing/2427.dds", [2503] = "icon/new_icon/03_etc/06_housing/2503.dds", [2569] = "icon/new_icon/03_etc/06_housing/2569.dds", [2608] = "icon/new_icon/03_etc/06_housing/2608.dds", [2647] = "icon/new_icon/03_etc/06_housing/2647.dds", [2691] = "icon/new_icon/03_etc/06_housing/2691.dds", [2704] = "icon/new_icon/03_etc/06_housing/2704.dds", [2858] = "icon/new_icon/03_etc/06_housing/2858.dds", [2880] = "icon/new_icon/03_etc/06_housing/2880.dds", [2905] = "icon/new_icon/03_etc/06_housing/2905.dds", [3351] = "icon/new_icon/03_etc/06_housing/3351.dds", [3352] = "icon/new_icon/03_etc/06_housing/3352.dds", [3353] = "icon/new_icon/03_etc/06_housing/3353.dds", [3354] = "icon/new_icon/03_etc/06_housing/3354.dds", [3355] = "icon/new_icon/03_etc/06_housing/3355.dds", [3356] = "icon/new_icon/03_etc/06_housing/3356.dds", [3357] = "icon/new_icon/03_etc/06_housing/3357.dds", [3358] = "icon/new_icon/03_etc/06_housing/3358.dds"}
local guildHouseButton, ownerGuildNoRaw = nil, nil
local recipeData = {}
local WorkDataRow = {}
local isMyGuildHouse = false
Panel_Control.Init = function(self)
  -- function num : 0_0 , upvalues : HouseInfo_Control
...
Panel_Control:Init()
HouseUseType_Control.Init = function(self)
  -- function num : 0_1
...
HouseUseTypeState_Control.Init = function(self)
  -- function num : 0_2
...
GuildHouse_WorkList_ScrollEvent = function(isScrollUp)
  -- function num : 0_4 , upvalues : WorkList_Control
...
HouseImage_Control.Init = function(self)
  -- function num : 0_5
end

HouseImage_Control:Init()
GuildHouse_WorkList_SetData = function()
  -- function num : 0_6 , upvalues : WorkDataRow, WorkList_Control
  WorkDataRow = {}
  ...
  for recipeIdx = 0, recipeCount - 1 do
    ...
    if recipeKeyRaw == WorkList_Control._selectRecipeKeyRaw then
      ...
      for level = 1, maxLevel do
        ...
        WorkDataRow[WorkList_Control._totalRow] = {isTitle = true, level = level, value1 = nil, value2 = nil, receipeKey = recipeKeyRaw}
        ...
        for exchangeColIdx = 0, exchangeCol - 1 do
          ...
          WorkDataRow[WorkList_Control._totalRow] = {isTitle = false, level = level, value1 = startIdx, value2 = endIdx, receipeKey = recipeKeyRaw}
...
GuildHouse_WorkList_ItemToolTip = function(isShow, rowNo, dataIdx, uiSlotNo, Idx)
  -- function num : 0_8 , upvalues : WorkDataRow, WorkList_Control
  if isShow == true then
    local dataArray = WorkDataRow[rowNo]
    local guildHouseInfoSSW = ToClient_GetGuildHouseInfoStaticStatusWrapper(WorkList_Control._selecthouseKeyRaw)
...
HouseUseType_Control.Update = function(self)
  -- function num : 0_9 , upvalues : recipeData, HouseInfo_Control, HouseUseType_Control
  recipeData = {}
  ...
  if guildHouseInfoSSW ~= nil then
      ...
      if (CppEnums.eHouseUseType).Depot ~= groupType then
        ...
        for gradeIdx = 0, maxLevel - 1 do
          ...
          if gradeIdx + 1 <= currentLevel then
            x1 = setTextureUV_Func(upgradeBtn.BG, 1, 52, 19, 70)
          else
            -- DECOMPILER ERROR at PC139: Overwrote pending register: R26 in 'AssignReg'

            -- DECOMPILER ERROR at PC140: Overwrote pending register: R25 in 'AssignReg'

            -- DECOMPILER ERROR at PC141: Overwrote pending register: R24 in 'AssignReg'

            x1 = setTextureUV_Func(upgradeBtn.BG, 1, 33, 19, 51)
          end
          ;
    ...
    if HouseUseType_Control.listCount < uiCount then
...
HouseUseTypeState_Control.Update = function(self)
  -- function num : 0_10 , upvalues : HouseInfo_Control, ownerGuildNoRaw, isMyGuildHouse, HouseUseTypeState_Control
  ...
  if isSet == false then
    ...
    do
      ...
      ;
      (self._Icon_Working):setRenderTexture((self._Icon_Working):getBaseTexture())
      if myGuildNoRaw == ownerGuildNoRaw and myGuildWrapper ~= nil then
        isMyGuildHouse = true
      else
...
FGlobal_HouseUseTypeState_Update = function(guildNoRaw)
  -- function num : 0_11 , upvalues : ownerGuildNoRaw, HouseUseTypeState_Control
...
HouseImage_Control.Update = function(self)
  -- function num : 0_12 , upvalues : HouseInfo_Control, guildHouse_Img
  local guildHouseInfoSSW = ToClient_GetGuildHouseInfoStaticStatusWrapper(HouseInfo_Control._houseKeyRaw)
  local getKeyRaw = HouseInfo_Control._houseKeyRaw
  if guildHouse_Img[getKeyRaw] ~= nil then
...
Worldmap_Grand_GuildHouseControl_Close = function()
  -- function num : 0_13 , upvalues : HouseInfo_Control, guildHouseButton
  local guildHouseInfoSSW = ToClient_GetGuildHouseInfoStaticStatusWrapper(HouseInfo_Control._houseKeyRaw)
  ...
  if regionInfoWrapper ~= nil and regionInfoWrapper:hasWarehouseManager() then
    warehouse_requestInfo(wayPointKey)
  end
  guildHouseButton = nil
end

Worldmap_Grand_GuildCraft_Open = function()
  -- function num : 0_14 , upvalues : WorkList_Control
  if WorkList_Control._selecthouseKeyRaw == nil or WorkList_Control._selectRecipeKeyRaw == nil then
...
Worldmap_Grand_GuildCraftControl_Update = function()
  -- function num : 0_15 , upvalues : HouseUseType_Control, HouseUseTypeState_Control, HouseImage_Control, HouseInfo_Control, Panel_Control
...
FromClient_WorldMapGuildHouseLClick = function(guildUIButton)
  -- function num : 0_16 , upvalues : isContentsEnable, HouseInfo_Control
...
GuildCraftControl_onScreenResize = function()
  -- function num : 0_17
