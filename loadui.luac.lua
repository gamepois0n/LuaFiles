...
preLoadGameUI = function()
  ...
  loadUI("UI_Data/Window/Auction/Panel_Masterpiece_Auction.XML", "Panel_Masterpiece_Auction", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({RenderMode.eRenderMode_Dialog, RenderMode.eRenderMode_Default}))
  ...
  basicLoadUI("UI_Data/Window/Arsha/Panel_Window_ArshaTeamNameChange.XML", "Panel_Window_ArshaTeamNameChange", UIGroup.PAGameUIGroup_Windows)
