...
preLoadGameUI = function()
  ...
  basicLoadUI("UI_Data/Window/Profile/Panel_Window_Profile.xml", "Panel_Window_Profile", UIGroup.PAGameUIGroup_Windows)
...
loadGameUI = function()
  ...
  runLua("UI_Data/Script/Window/Profile/Panel_Window_Profile.lua")
