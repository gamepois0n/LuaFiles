...
preLoadGameUI = function()
  ...
  loadUI("UI_Data/Window/IngameCashShop/Panel_IngameCashShop_EasyPayment.XML", "Panel_IngameCashShop_EasyPayment", UIGroup.PAGameUIGroup_WorldMap_Contents, RenderModeAllModeOpen)
...
loadGameUI = function()
  ...
  runLua("UI_Data/Script/Widget/RightTopIcons/Panel_PersonalIcon_AutoTraining.lua")
