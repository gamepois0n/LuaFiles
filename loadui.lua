...
function loadLoadingUI()
  ...
  loadUI("UI_Data/Widget/Tooltip/UI_Tooltip_SimpleText.XML", "Panel_Tooltip_SimpleText", UIGroup.PAGameUIGroup_SimpleTooltip, RenderModeAllModeOpen)
  runLua("UI_Data/Script/Widget/ToolTip/Panel_Tooltip_SimpleText.lua")
...
function loadLobbyUI()
  ...
  loadCustomizationUI()
  if _ContentsGroup_NakMessage then
...
function preLoadGameUI()
  ...
  if _ContentsGroup_RenewUI_MiniGame then
    ...
    basicLoadUI("UI_Data/Widget/Fishing/Console/Panel_Fishing_Renew.xml", "Panel_Fishing", UIGroup.PAGameUIGroup_MainUI)
  else
  ...
  if true == _ContentsGroup_RenewUI_Quest then
  ...
  if true == _ContentsGroup_RenewUI_TopWidgetIcon then
  ...
  if _ContentsGroup_ProgressBar then
  ...
  if true == _ContentsGroup_RenewUI_Warehouse then
  ...
  if true == _ContentsGroup_RenewUI_WorldMap then
    ...
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_HouseManagement.XML", "Panel_Worldmap_HouseManagement", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    ...
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_RingMenu_Renew.XML", "Panel_Worldmap_RingMenu", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_TopMenu_Renew.XML", "Panel_Worldmap_TopMenu", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_BottomMenu_Renew.XML", "Panel_Worldmap_BottomMenu", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_NodeInfo_Renew.XML", "Panel_Worldmap_NodeInfo", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_NodeManagement_Renew.XML", "Panel_Worldmap_NodeManagement", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_RightMenu_Renew.XML", "Panel_Worldmap_RightMenu", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_StableList_Renew.XML", "Panel_Worldmap_Stable", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_HouseFilter_Renew.XML", "Panel_Worldmap_HouseFilter", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
    ...
    loadUI("UI_Data/Window/Worldmap_Grand/Console/Panel_Worldmap_SellBuyCondition.XML", "Panel_Worldmap_SellBuyCondition", UIGroup.PAGameUIGroup_WorldMap_Popups, RenderModeWorldMapBitSet)
  else
  ...
  if _ContentsGroup_GuardGauge then
  ...
  if _ContentsGroup_NakMessage then
    loadUI("UI_Data/Widget/NakMessage/Console/Panel_Widget_NakMessage_Renew.XML", "Panel_NakMessage", UIGroup.PAGameUIGroup_ModalDialog, RenderModeAllModeOpen)
  else
  ...
  if false == _ContentsGroup_RenewUI_Detect then
  ...
  elseif _ContentsGroup_ProgressBar then
  ...
  if _ContentsGroup_RenewUI_Alchemy or _ContentsGroup_RenewUI_Manufacture then
  ...
  if _ContentsGroup_RenewUI_MiniGame then
    ...
    basicLoadUI("UI_Data/Widget/MiniGame/Console/MiniGame_SinGauge_Renew.xml", "Panel_SinGauge", UIGroup.PAGameUIGroup_MainUI)
    basicLoadUI("UI_Data/Widget/MiniGame/Console/MiniGame_Command_Renew.xml", "Panel_Command", UIGroup.PAGameUIGroup_MainUI)
  ...
  if _ContentsGroup_RenewUI_PearlShop then
    ...
    loadUI("UI_Data/Window/IngameCashShop/Console/Panel_PearlShop_ProductInfo_Renew.XML", "Panel_PearlShop_ProductInfo", UIGroup.PAGameUIGroup_Windows, RenderModeBitSetInGameCashShop)
    loadUI("UI_Data/Window/IngameCashShop/Console/Panel_PearlShop_ProductBuy_Renew.XML", "Panel_PearlShop_ProductBuy", UIGroup.PAGameUIGroup_Windows, RenderModeBitSetInGameCashShop)
  end
  ...
  if true == _ContentsGroup_RenewUI_GachaRoulette then
  ...
  basicLoadUI("UI_Data/Window/Subjugation/Panel_Subjugation_SelectCharacter.xml", "Panel_Subjugation_SelectCharacter", UIGroup.PAGameUIGroup_Windows)
  ...
  if _ContentsGroup_RenewUI then
    loadUI("UI_Data/Widget/UIcontrol/Panel_PadSnapTargetEffect.XML", "Panel_PadSnapTargetEffect", UIGroup.PAGameUIGroup_ModalDialog, RenderModeAllModeOpen)
  end
end
