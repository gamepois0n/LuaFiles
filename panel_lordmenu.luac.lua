...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\lordmenu\panel_lordmenu.luac 
...
Panel_LordMenu_ShowAni = function()
  -- function num : 0_0
...
Panel_LordMenu_HideAni = function()
  -- function num : 0_1
...
local ui_Main = {_btn_WinClose = (UI.getChildControl)(Panel_LordMenu, "Button_Close"), _buttonQuestion = (UI.getChildControl)(Panel_LordMenu, "Button_Question"), _btn_TerInfo = (UI.getChildControl)(Panel_LordMenu, "RadioButton_TerInfo"), _btn_PayInfo = (UI.getChildControl)(Panel_LordMenu, "RadioButton_PayInfo"), _btn_TaxInfo = (UI.getChildControl)(Panel_LordMenu, "RadioButton_TaxInfo"), _FrameBG = (UI.getChildControl)(Panel_LordMenu, "Static_Background"), panel_desc = (UI.getChildControl)(Panel_LordMenu, "Static_DescBG")}
...
local ui_Ter = {_title_0 = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_Terr_Title_0"), _M_GuildName = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_M_GuildName"), _M_LordName = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_M_LordName"), _M_Occupation = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_M_Occupation"), _M_Residence = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_M_Residence"), _M_Week = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_M_Week"), _R_GuildName = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_R_GuildName"), _R_LordName = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_R_LordName"), _R_Occupation = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_R_Occupation"), _R_Residence = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_R_Residence"), _R_Week = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_R_Week"), _guildIconBG = (UI.getChildControl)(Panel_LordMenu_Territory, "Static_GuildIcon_BG"), _guildIcon = (UI.getChildControl)(Panel_LordMenu_Territory, "Static_GuildIcon"), _txt_TerrHelp = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_TerrInfo_Help"), _title_1 = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_Terr_Title_1"), _happyBG = (UI.getChildControl)(Panel_LordMenu_Territory, "Static_HappyGaugeBG"), _happyGauge = (UI.getChildControl)(Panel_LordMenu_Territory, "Progress2_HappyGauge"), _happyComment = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_HappyComment"), _happy_Help = (UI.getChildControl)(Panel_LordMenu_Territory, "StaticText_HappyRate_Help")}
local ui_Pay = {_title_0 = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Pay_Title_0"), _transferTax_Now_BG = (UI.getChildControl)(Panel_LordMenu_PayInfo, "Static_TransferTax_Now_BG"), _transferTax_Bef_BG = (UI.getChildControl)(Panel_LordMenu_PayInfo, "Static_TransferTax_Bef_BG"), _transferTax_Now_Gauge = (UI.getChildControl)(Panel_LordMenu_PayInfo, "Progress2_TransferTax_Now"), _transferTax_Bef_Gauge = (UI.getChildControl)(Panel_LordMenu_PayInfo, "Progress2_TransferTax_Bef"), _txt_TransferTax = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_TransferTax"), _txt_TransferTax_Gold = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_TransferTax_Gold"), _txt_TaxNow_Help = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_TaxNow_Help"), _txt_TaxBef_Help = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_TaxBef_Help"), _tax_Help = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Tax_Help"), _title_1 = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Pay_Title_1"), _txt_Balance = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Balance"), _txt_LocalTax = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_LocalTax"), _txt_Balance_Gold = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Balance_Gold"), _txt_LocalTax_Gold = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_LocalTax_Gold"), _txt_PolicingCost = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_PolicingCost"), _txt_PolicingCost_Gold = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_PolicingCostValue"), _btn_GetMoney = (UI.getChildControl)(Panel_LordMenu_PayInfo, "Button_GetMoney"), _txt_Balance_Help = (UI.getChildControl)(Panel_LordMenu_PayInfo, "StaticText_Balance_Help")}
local ui_Tax = {_title_0 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Tax_Title_0"), _txt_TransferTax = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Tax_TransferTax"), _slide_TransferTax = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_TransferTax"), _slideBtn_TransferTax = nil, _txt_TransferTax_Help = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_TransferTax_Help"), _txt_TransferTax_Ref_Min = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_TransferTax_Ref_Min"), _txt_TransferTax_Ref_Max = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_TransferTax_Ref_Max"), _title_1 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Tax_Title_1"), _txt_Territory_1 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_1"), _txt_Territory_2 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_2"), _txt_Territory_3 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_3"), _txt_Territory_4 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_4"), _txt_Territory_5 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_5"), _txt_Territory_6 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Territory_6"), _slide_Territory_1 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_1"), _slideBtn_Territory_1 = nil, _slide_Territory_2 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_2"), _slideBtn_Territory_2 = nil, _slide_Territory_3 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_3"), _slideBtn_Territory_3 = nil, _slide_Territory_4 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_4"), _slideBtn_Territory_4 = nil, _slide_Territory_5 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_5"), _slideBtn_Territory_5 = nil, _slide_Territory_6 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Slider_Territory_6"), _slideBtn_Territory_6 = nil, _txt_min_1 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_1"), _txt_min_2 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_2"), _txt_min_3 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_3"), _txt_min_4 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_4"), _txt_min_5 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_5"), _txt_min_6 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Min_6"), _txt_max_1 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_1"), _txt_max_2 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_2"), _txt_max_3 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_3"), _txt_max_4 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_4"), _txt_max_5 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_5"), _txt_max_6 = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_Max_6"), _txt_DutyTax_Help = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_DutyTax_Help"), _btn_Tax_Reset = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Button_Title_0_Reset"), _btn_Tax_Accpet = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Button_Title_0_Accept"), _btn_Duty_Reset = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Button_Title_1_Reset"), _btn_Duty_Accpet = (UI.getChildControl)(Panel_LordMenu_TaxControl, "Button_Title_1_Accept"), _noTax = (UI.getChildControl)(Panel_LordMenu_TaxControl, "StaticText_NoTax")}
local tapIndex = 0
local Panel_LordMenu_Initialize = function()
  -- function num : 0_4 , upvalues : moveChildElements, ui_Main, ui_Ter, ui_Pay, ui_Tax, showToggleElements
...
Panel_LordMenu_TerInfoUpdate = function()
  -- function num : 0_5 , upvalues : ui_Ter, UI_color, UI_TM, ui_Pay, ui_Main
...
Panel_LordMenu_PayInfoUpdate = function()
  -- function num : 0_6 , upvalues : ui_Pay, UI_TM, ui_Main
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_Withdraw_Money = function()
  -- function num : 0_7
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
...
LordMenu_Withdraw_Money_Message = function(inputNumber, param)
...
LordMenu_Withdraw_Money_Confirm = function()
...
LordMenu_PayInfo_Update = function()
  -- function num : 0_10
...
Panel_LordMenu_TaxInfoUpdate = function()
  -- function num : 0_11 , upvalues : transferTaxRate, ui_Tax, taxForSiegeList, UI_TM, ui_Main
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
  ...
  local isDutyShow = not isKing or isKingTerritoryOnly
  ;
  ...
  local territorysInNationalCount = siegeWrapper:getTerritorysCountInNational()
  local territoryKeyInNational = 10
  local territorySiege, siegeName = nil, nil
  ...
  for ii = 0, territorysInNationalCount - 1 do
    ...
    if regionInfoWrapper:getTerritoryKeyRaw() ~= territoryKeyInNational then
      ...
      -- DECOMPILER ERROR at PC406: Confused about usage of register: R20 in 'UnsetPending'

      if taxForSiegeList[indexCount] == nil then
        taxForSiegeList[indexCount] = {}
      end
      -- DECOMPILER ERROR at PC409: Confused about usage of register: R20 in 'UnsetPending'

      ;
      (taxForSiegeList[indexCount]).territoryKey = territoryKeyInNational
      -- DECOMPILER ERROR at PC412: Confused about usage of register: R20 in 'UnsetPending'
...
LordMenu_SlideControl_TransferTax = function()
  -- function num : 0_12 , upvalues : transferTaxRate, ui_Tax
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_SlideControl_TaxForSiegeTerritory_1 = function()
  -- function num : 0_13 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_SlideControl_TaxForSiegeTerritory_2 = function()
  -- function num : 0_14 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_SlideControl_TaxForSiegeTerritory_3 = function()
  -- function num : 0_15 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_SlideControl_TaxForSiegeTerritory_4 = function()
  -- function num : 0_16 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_SlideControl_TaxForSiegeTerritory_5 = function()
  -- function num : 0_17 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_SlideControl_TaxForSiegeTerritory_6 = function()
  -- function num : 0_18 , upvalues : ui_Tax, taxForSiegeList
...
LordMenu_MouseEvent_ResetTaxForFortress = function()
  -- function num : 0_19 , upvalues : transferTaxRate, ui_Tax
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_MouseEvent_ChangeTaxForFortress = function()
  -- function num : 0_20 , upvalues : transferTaxRate
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_MouseEvent_ResetTaxForSiege = function()
  -- function num : 0_21 , upvalues : taxForSiegeList, ui_Tax
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_MouseEvent_ChangeTaxForSiege = function()
  -- function num : 0_22 , upvalues : taxForSiegeList
...
LordMenu_MouseEvent_PayInfoDescShow = function(isShow)
  -- function num : 0_23 , upvalues : ui_Main
  if isShow == nil then
    return 
  end
...
LordMenu_MouseEvent_TerInfoShow = function()
  -- function num : 0_24 , upvalues : tapIndex, showToggleElements, ui_Ter, ui_Pay, ui_Tax, ui_Main
  tapIndex = 0
  showToggleElements(true, ui_Ter)
  showToggleElements(false, ui_Pay)
  showToggleElements(false, ui_Tax)
...
LordMenu_MouseEvent_PayInfoShow = function()
  -- function num : 0_25 , upvalues : tapIndex, showToggleElements, ui_Ter, ui_Pay, ui_Tax, ui_Main
  tapIndex = 1
...
LordMenu_MouseEvent_TaxInfoShow = function()
  -- function num : 0_26 , upvalues : tapIndex, showToggleElements, ui_Ter, ui_Pay, ui_Tax, ui_Main
  tapIndex = 2
  showToggleElements(false, ui_Ter)
  showToggleElements(false, ui_Pay)
...
LordMenu_Show = function()
  -- function num : 0_27 , upvalues : ui_Main
  local selfPlayer = getSelfPlayer()
  local regionInfoWrapper = getRegionInfoWrapper(selfPlayer:getRegionKeyRaw())
  if regionInfoWrapper == nil then
    return 
...
LordMenu_Hide = function()
  -- function num : 0_28 , upvalues : ui_Main
...
FromClient_NotifyUpdateTownTax = function(regionKeyRow)
  -- function num : 0_29 , upvalues : texFirstNotifyCheck, _transferTaxRate
  ...
  if texFirstNotifyCheck == true then
    ...
    if _transferTaxRate == transferTaxRate then
      return 
    else
      _transferTaxRate = transferTaxRate
