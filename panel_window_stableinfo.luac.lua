...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\x86\window\servant\stable\panel_window_stableinfo.luac 
      ...
      if servantInfo:getVehicleType() == (CppEnums.VehicleType).Type_Horse and servantInfo:getTier() ~= 9 and servantInfo:isPcroomOnly() == false and isContentsStallionEnable then
        ...
        do
          ...
          if servantInfo:getVehicleType() == (CppEnums.VehicleType).Type_Carriage or servantInfo:getVehicleType() == (CppEnums.VehicleType).Type_CowCarriage then
            ...
            if servantInfo:getVehicleType() == (CppEnums.VehicleType).Type_RepairableCarriage then
