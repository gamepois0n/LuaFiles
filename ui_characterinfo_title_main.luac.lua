...
PaGlobal_CharacterInfoTitle = {_filterText = "", _currentCategoryIdx = 0, _currentCategoryCount = 0, 
_category = {_world = 0, _battle = 1, _life = 2, _fish = 3}
, 
_categoryStirng = {[0] = "LUA_CHARACTERINFO_TITLE_LISTALL", [1] = "LUA_CHARACTERINFO_TITLE_LISTCOMBAT", [2] = "LUA_CHARACTERINFO_TITLE_LISTPRODUCT", [3] = "LUA_CHARACTERINFO_TITLE_LISTFISH"}
, 
...
, 
_radioButtonSubCategory = {[0] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "RadioButton_Top_AllRound"), [1] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "RadioButton_Top_Combat"), [2] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "RadioButton_Top_Product"), [3] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "RadioButton_Top_Fish")}
, _Progress2Total_Progress = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "Static_TotalProgress_Progress"), _staticTextTotal_Value = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_TotalProgress_Percent"), 
_staticTextTitle_Value = {[0] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_AllRound_CountValue"), [1] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Combat_CountValue"), [2] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Product_CountValue"), [3] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Fishing_CountValue")}
, 
_staticTextTitle_Percent = {[0] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_AllRound_PercentValue"), [1] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Combat_PercentValue"), [2] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Product_PercentValue"), [3] = (UI.getChildControl)(Panel_Window_CharInfo_TitleInfo, "StaticText_Fishing_PercentValue")}
, 
...
PaGlobal_CharacterInfoTitle.update = function(self)
  ...
  if ((self._ui)._staticText_PartDesc):GetText() == "" or ((self._ui)._staticText_PartDesc):GetText() == nil then
    ((self._ui)._staticText_PartDesc):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CHARACTERINFO_TITLE_PARTDESC"))
  end
