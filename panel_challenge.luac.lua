...
Challenge_Update = function()
  -- function num : 0_9 , upvalues : totalSlotCount, _selectedReward_ChallengeIndex, _selectedReward_SlotIndex, _tapMenu, _tapValue, clearCount, shortClearCount, dailyChallengeValue, remainRewardCountValue, UI_color, _content, _baseReward, _selectReward, challengeType, challengeWrapper, _scrollIndex, baseCount, tapCount, controlValueCount, _scroll, controlCount, _count, maxCount
  totalSlotCount = 0
