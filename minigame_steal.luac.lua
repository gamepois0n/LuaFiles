...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\minigame\minigame_steal.luac 
...
Minigame_Steal_ShowAni = function()
  -- function num : 0_0
...
Minigame_Steal_HideAni = function()
  -- function num : 0_1
...
local ui = {_pocket = (UI.getChildControl)(Panel_MiniGame_Steal, "Static_MyPocket"), _theifHand = (UI.getChildControl)(Panel_MiniGame_Steal, "Static_TheifHand_0"), _myHand = (UI.getChildControl)(Panel_MiniGame_Steal, "Static_MyHand")}
...
local currTime = 0
local stealValue = 0
Minigame_Steal_ScreenResize = function()
  -- function num : 0_2
...
Minigame_Steal_Initialize = function()
  -- function num : 0_3 , upvalues : currTime, stealValue, ui
  currTime = 0
  stealValue = 0
  ;
...
Panel_Minigame_Steal_Start = function()
  -- function num : 0_4 , upvalues : _steal_Icon_Title, _title, ui, currTime, stealValue
  local scrX = getScreenSizeX()
  local scrY = getScreenSizeY()
...
Panel_Minigame_Steal_End = function()
  -- function num : 0_5 , upvalues : ui, currTime, stealValue
  (ui._theifHand):ResetVertexAni()
...
Minigame_Steal_KeyPressTimeCheck = function(deltaTime)
  -- function num : 0_6 , upvalues : currTime, stealValue, ui, UI_ANI_ADV, UI_AH
...
Minigame_Steal_PressKey = function(keyType)
  -- function num : 0_7 , upvalues : MGKT, stealValue, ui
...
Minigame_Steal_Cut = function()
  -- function num : 0_8 , upvalues : currTime, stealValue, ui, UI_ANI_ADV, UI_AH
  currTime = 2.1
  stealValue = 1
  ;
