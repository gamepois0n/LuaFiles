...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\tutorial\tutorial_phase_basicskill_ninjawomen.luac 

-- params : ...
-- function num : 0
PaGlobal_TutorialPhase_BasicSkill_NinjaWomen = {_phaseNo = 6, _currentType = 0, _currentStep = 0, _nextStep = 0, _currentProgress = 1, _updateTime = 0, _isPhaseOpen = true, _isSkippable = true, 
...
PaGlobal_TutorialPhase_BasicSkill_NinjaWomen.startPhaseXXX = function(self, stepNo, typeNo)
  ...
  _PA_LOG("곽민�\176", "PaGlobal_TutorialPhase_BasicSkill_NinjaWomen:startStep() typeNo : " .. tostring(typeNo))
