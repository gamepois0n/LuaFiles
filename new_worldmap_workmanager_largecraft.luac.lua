...
Panel_LargeCraft_WorkManager_ShowAni = function()
...
Panel_LargeCraft_WorkManager_HideAni = function()
...
local houseInfoSS, houseKey, houseParam = nil, nil, nil
local affiliatedTownKey = 0
local defalut_Control = {_title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Title"), _btn_Close = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_Win_Close"), _btn_Question = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_Question"), 
_largCraft_List = {_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_BG"), _Index = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_LargeCraftInfo_Index"), _Slide_Left = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_LargCraftInfo_Slide_Left"), _Slide_Right = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_LargCraftInfo_Slide_Right"), _Btn_Cancel = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_LargCraftInfo_Cancel"), _Icon_BG_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_Result_Icon_BG_1"), _Icon_BG_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_Result_Icon_BG_2"), _Icon = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_Result_Icon"), _Name = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_LargCraftInfo_Name"), _Total_Count = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_LargCraftInfo_TotalCount"), _Current_Count = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_LargCraftInfo_CurrentCount"), _Progress_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_Progress_BG"), _Progress_OutLine = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_LargCraftInfo_Progress_OutLine"), _Progress_OnGoing = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_LargCraftInfo_OnGoing"), _Progress_Complete = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_LargCraftInfo_Complete"), _Guide = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_LargCraftInfo_Guide")}
, 
_subWork_List = {_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkList_BG"), _Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkList_Title"), _Scroll = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Scroll_SubWorkList"), 
_Button = {}
, 
_Progress_OnGoing = {}
, 
...
_Ani_OnGoing = {}
, 
_Template = {_Button = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "RadioButton_SubWork"), _Progress_OnGoing = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_SubWorkList_OnGoing"), _Progress_Complete = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_SubWorkList_Complete"), _CountText_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkList_Count_1"), _CountText_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkList_Count_2"), _Ani_OnGoing = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkList_OnGoingAni"), _rowMax = 7, _row_PosY_Gap = 1}
}
, 
_worker_List = {_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_WorkerList_BG"), _Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_WorkerList_Title"), _Scroll = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Scroll_WorkerList"), _No_Worker = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_NoWorker"), 
_Button = {}
, 
_Progress = {}
, 
_ActionPoint = {}
, 
_Template = {_Button = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "RadioButton_Worker"), _Progress = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_Worker_ActionPoint"), _ActionPoint = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Worker_ActionPoint"), _rowMax = 7, _row_PosY_Gap = 1}
}
, 
_subWork_Info = {_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_BG"), _Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Title"), _Resource_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_Resource_BG"), _Resource_Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Title"), _Resource_Name = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Name"), _Resource_Icon_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Icon_BG"), _Resource_Icon_Border = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Icon_Border"), _Resource_Icon_Over = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Icon_Over"), _Resource_Icon = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Icon"), _Resource_Count = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Resource_Count"), _Resource_Line_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_Resource_Line_1"), _Resource_Line_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_Resource_Line_2"), _OnGoing_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_OnGoing_BG"), _OnGoing_Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_OnGoing_Title"), _OnGoing_Scroll = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Scroll_SubWorkInfo_OnGoing"), _OnGoing_Line_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_OnGoing_Line_1"), _OnGoing_Line_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_OnGoing_Line_2"), _OnGoing_Guide = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_OnGoing_Guide"), _immediately = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_Immediately"), 
_OnGoing_Time = {}
, 
...
_OnGoing_Cancel = {}
, 
_Template = {_OnGoing_Time = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_SubWorkInfo_Ongoing_Time"), _OnGoing_Progress_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_SubWorkInfo_OnGoing_Progress_BG"), _OnGoing_Progress = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Progress2_SubWorkInfo_OnGoing"), _OnGoing_Cancel = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_SubWorkInfo_Cancel"), _rowMax = 4, _row_PosY_Gap = 5}
}
, 
_subWork_Estimated = {_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_BG"), _Title = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_Title"), _Time_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Time_BG"), _Time_Text = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_Time_Text"), _Time_Value = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_Time_Value"), _Time_Count = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_Time_Count"), _Work_Count = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_Estimated_Work_Count"), _Time_Line = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Time_Line"), _Work_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Work_BG"), _Work_Line_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Work_Line_1"), _Work_Line_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Work_Line_2"), _Work_Volume_Text = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_WorkVolum_Text"), _Work_Volume_Value = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_WorkVolum_Value"), _Work_Speed_Text = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_WorkSpeed_Text"), _Work_Speed_Value = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_WorkSpeed_Value"), _Move_BG = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Move_BG"), _Move_Line_1 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Move_Line_1"), _Move_Line_2 = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Static_Estimated_Move_Line_2"), _Move_Distance_Text = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_MoveDistance_Text"), _Move_Distance_Value = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_MoveDistance_Value"), _Move_Speed_Text = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_MoveSpeed_Text"), _Move_Speed_Value = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Estimated_MoveSpeed_Value"), _Button_DoWork = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "Button_doWork"), _Cant_Work = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Cant_Work"), _Finished_Work = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Finished_Work"), _Last_Work = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_Last_Work"), _No_Resource_Work = (UI.getChildControl)(Panel_LargeCraft_WorkManager, "StaticText_noResource")}
}
;
...
, 
_workerList = {}
, _onGoingIndex = nil, _workableType = nil, _currentIndex = 0, _selectedWork = 0, _contentCount = 0, _position = nil}
local SubWork_List = {}
LargCraft_List._setData = function(self, isRefresh)
  -- function num : 0_4 , upvalues : houseParam, houseInfoSS, SubWork_List, houseKey
  ...
  for index = 1, workCount do
    ...
    if esSSW:isSet() then
      ...
      ;
      (self._data_Table)[index] = {_index = index, _level = levelIndex, _workKey = ToClient_getWorkableExchangeKeyByIndex(index - 1), _workIcon = workIcon, _workName = workName, _workVolume = workVolume, _resultKey = resultKey, _resultIcon = resultIcon, _resultName = resultName, _currentCount = 0, _onGoingCount = 0, _totalCount = 0}
      local currentKey = ToClient_getLargeCraftExchangeKeyRaw(houseInfoSS)
      if ((self._data_Table)[index])._workKey == currentKey then
        if self._onGoingIndex == nil then
...
LargCraft_List._updateSlot = function(self)
          ...
          if self._contentCount == 1 then
            ...
            if self._contentCount > 1 then
              if index == 1 then
                ...
                if index == self._contentCount then
...
HandleClick_LargCraft_List_Btn = function(isLeft)
  -- function num : 0_6 , upvalues : LargCraft_List, defalut_Control, SubWork_List
  if isLeft and LargCraft_List._currentIndex > 1 then
    ...
    if isLeft == false and LargCraft_List._currentIndex < LargCraft_List._contentCount then
      Subwork_Progress_List_SetWorkingCount(1)
      ;
      ((defalut_Control._subWork_Estimated)._Time_Count):SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_NEW_WORLDMAP_WORKMANAGER_BUILDING_DEFAULT", "getWorkingCount", Subwork_Progress_List_GetWorkingCount()))
...
LargCraft_Cancel_All = function()
  -- function num : 0_7 , upvalues : houseInfoSS, _Cancel_All
...
HandleClick_LargCraft_Cancel_Btn = function()
  -- function num : 0_8 , upvalues : houseInfoSS, LargCraft_List, UI_PP
  local currentKey = ToClient_getLargeCraftExchangeKeyRaw(houseInfoSS)
...
SubWork_List = {
_data_Table = {}
, _rowMax = ((defalut_Control._subWork_List)._Template)._rowMax, _contentRow = nil, _offsetIndex = nil, _offset_Max = nil, _selected_SubWork = nil, _selected_Index = nil, _over_Index = nil}
SubWork_List._setData = function(self)
  -- function num : 0_9 , upvalues : LargCraft_List, houseInfoSS, affiliatedTownKey
  for index = 1, LargCraft_List._contentCount do
    ...
    if esSSW:isSet() then
      ...
      for idx = 1, eSSCount do
        ...
        if ((self._data_Table)[index])._resource == nil then
        ...
        ;
        (((self._data_Table)[index])._resource)[idx] = {_itemKey = itemKey, _gradeType = gradeType, _itemKeyRaw = itemKeyRaw, _resourceKey = resourceKey, _itemName = itemName, _itemIcon = itemIcon, _subWorkName = subWorkName, _fullCount = fullCount, _haveCount = haveCount, _progressCount = progressCount, _workerList = workerList, _onGoingCount = onGoingCount, _workingCount = tempCount}
...
SubWork_List._setOffset = function(self)
  -- function num : 0_10 , upvalues : LargCraft_List, houseInfoSS, defalut_Control
...
SubWork_List._updateSlot = function(self, isRefresh)
  -- function num : 0_11 , upvalues : LargCraft_List, defalut_Control
  local index = LargCraft_List._currentIndex
  do
    ...
    for idx = 1, self._rowMax do
      ...
      if (((self._data_Table)[index])._resource)[_idx] == nil then
...
SubWork_List_Select = function(index)
  -- function num : 0_12 , upvalues : LargCraft_List, SubWork_List, defalut_Control
  Subwork_Progress_List_SetWorkingCount(1)
  ...
  if (((SubWork_List._data_Table)[workIndex])._resource)[subWorkIndex] == nil then
    return 
  end
  ;
  ((defalut_Control._subWork_Estimated)._Time_Count):SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_NEW_WORLDMAP_WORKMANAGER_BUILDING_DEFAULT", "getWorkingCount", Subwork_Progress_List_GetWorkingCount()))
...
HandleOn_SubWork_List = function(index)
  -- function num : 0_13 , upvalues : SubWork_List, LargCraft_List, defalut_Control
...
HandleOut_SubWork_List = function()
  -- function num : 0_14 , upvalues : SubWork_List
...
HandleOn_SubWork_List_Refresh = function()
  -- function num : 0_15 , upvalues : SubWork_List, defalut_Control
...
SubWork_List_Immediately_CraftItem = function()
  -- function num : 0_16 , upvalues : houseInfoSS, defalut_Control, UI_PP
...
SubWork_List_Immediately_CraftItemYes = function()
  -- function num : 0_17 , upvalues : defalut_Control
...
local Worker_SortByRegionInfo = function()
  -- function num : 0_18 , upvalues : houseInfoSS, Worker_List, LargCraft_List, workingTime, homeWayKey, sortDistanceValue
  local workIndex = 0
  ...
  for index = 1, waitingWorkerCount do
    ...
    if ToClient_isWaitWorker(npcWaitingWorker) == true and workerWrapperLua:getIsAuctionInsert() == false then
      ...
      -- DECOMPILER ERROR at PC99: Confused about usage of register: R21 in 'UnsetPending'

      homeWayKey[possibleWorkerIndex] = ((Worker_List._data_Table)[possibleWorkerIndex])._homeWaypoint
      -- DECOMPILER ERROR at PC101: Confused about usage of register: R21 in 'UnsetPending'
  ...
  local workerDataSwap = function(index, sortCount)
    -- function num : 0_18_0 , upvalues : Worker_List, temp, sortDistanceValue
  ...
  for ii = 1, possibleWorkerCount do
    ...
    for i = possibleWorkerCount, 1, -1 do
      if i > 1 and workingTime[i] < workingTime[i - 1] then
        ...
        -- DECOMPILER ERROR at PC136: Confused about usage of register: R21 in 'UnsetPending'

        ;
        (Worker_List._data_Table)[i] = (Worker_List._data_Table)[i - 1]
        -- DECOMPILER ERROR at PC140: Confused about usage of register: R21 in 'UnsetPending'

        ;
        (Worker_List._data_Table)[i - 1] = temp
        temp = workingTime[i]
        -- DECOMPILER ERROR at PC147: Confused about usage of register: R21 in 'UnsetPending'
        ...
        -- DECOMPILER ERROR at PC160: Confused about usage of register: R21 in 'UnsetPending'
  ...
  do
    ...
    -- function num : 0_18_1 , upvalues : _sortCount, possibleWorkerCount, Worker_List, workerDataSwap, sortDistanceValue
...
Worker_List._setData = function(self)
  -- function num : 0_19 , upvalues : houseInfoSS, defalut_Control, Worker_SortByRegionInfo
  local workIndex = 0
  local esSSW = ToClient_getHouseWorkableItemExchangeByIndex(houseInfoSS, workIndex)
  if esSSW:isSet() then
    local esSS = esSSW:get()
...
Worker_List._updateSlot = function(self)
  -- function num : 0_20 , upvalues : defalut_Control
...
LargeCraft_Worker_List_Select = function(index)
  -- function num : 0_21 , upvalues : Worker_List, affiliatedTownKey, defalut_Control
  Subwork_Progress_List_SetWorkingCount(1)
  if Panel_Window_Exchange_Number:IsShow() then
    Panel_NumberPad_Show(false, (Defines.s64_const).s64_0, 0, nil)
  end
...
HandleOn_LargeCraft_Worker_List = function(index)
  -- function num : 0_22 , upvalues : Worker_List, defalut_Control
...
HandleOut_LargeCraft_Worker_List = function()
  -- function num : 0_23 , upvalues : Worker_List
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R0 in 'UnsetPending'
...
HandleOn_LargerCraft_Worker_List_Refresh = function()
  -- function num : 0_24 , upvalues : Worker_List
  if Worker_List._over_Index ~= nil then
    HandleOut_LargeCraft_Worker_List(Worker_List._over_Index)
  end
end

local Subwork_Progress_List = {_workerList = nil, _workingCount = 1, _onGoingCount = nil, _rowMax = ((defalut_Control._subWork_Info)._Template)._rowMax, _contentRow = nil, _offsetIndex = nil, _offset_Max = nil, _last_offset = nil, 
_workingLeftCount = {}
}
Subwork_Progress_List_SetWorkingCount = function(count)
  -- function num : 0_25 , upvalues : Subwork_Progress_List
...
Subwork_Progress_List_GetWorkingCount = function()
  -- function num : 0_26 , upvalues : Subwork_Progress_List
  return Subwork_Progress_List._workingCount
end

Subwork_Progress_List._updateSlot = function(self)
  -- function num : 0_27
  Subwork_Progress_List_UpdateSlot()
end

Subwork_Progress_List_UpdateSlot = function(isRefresh, isOver)
  -- function num : 0_28 , upvalues : Subwork_Progress_List, LargCraft_List, SubWork_List, defalut_Control
  if Subwork_Progress_List._onGoingCount == 0 and isRefresh ~= true then
    return 
  end
  if isRefresh == true then
    local workIndex = LargCraft_List._currentIndex
    ...
    if Subwork_Progress_List._onGoingCount == 0 then
  ...
  do
    do
      ...
      if Subwork_Progress_List._offset_Max ~= 0 then
...
SubWork_Info_Update = function(isWorkOver)
  -- function num : 0_29 , upvalues : LargCraft_List, SubWork_List, defalut_Control
  local workIndex = LargCraft_List._currentIndex
  local subWorkIndex = SubWork_List._selected_Index
  if isWorkOver then
    subWorkIndex = SubWork_List._over_Index
...
SubWork_Estimated_Update = function(isWorkOver)
  -- function num : 0_30 , upvalues : LargCraft_List, SubWork_List, Worker_List, defalut_Control
  local workIndex = LargCraft_List._currentIndex
  local subWorkIndex = SubWork_List._selected_Index
  ...
  local workSpeed = 0
  local moveSpeed = 0
  if (LargCraft_List._data_Table)[workIndex] ~= nil then
  ...
  if (LargCraft_List._data_Table)[workIndex] ~= nil and (Worker_List._data_Table)[workerIndex] ~= nil then
    local workBaseTime = ToClient_getNpcWorkingBaseTimeForHouse() / 1000
...
HandleScroll_SubWork_List_UpDown = function(isUp)
  -- function num : 0_32 , upvalues : Scroll_UpDown, SubWork_List
  Scroll_UpDown(isUp, SubWork_List)
end

HandleScroll_LargeCraft_Worker_List_UpDown = function(isUp)
  -- function num : 0_33 , upvalues : Scroll_UpDown, Worker_List
  Scroll_UpDown(isUp, Worker_List)
end

HandleScroll_SubWork_Progress_List_UpDown = function(isUp)
  -- function num : 0_34 , upvalues : Scroll_UpDown, Subwork_Progress_List
...
HandleScroll_SubWork_List_OnClick = function()
  -- function num : 0_36 , upvalues : ScrollOnClick, SubWork_List, defalut_Control
  ScrollOnClick(SubWork_List, (defalut_Control._subWork_List)._Scroll)
end

HandleScroll_LargeCraft_Worker_List_OnClick = function()
  -- function num : 0_37 , upvalues : ScrollOnClick, Worker_List, defalut_Control
  ScrollOnClick(Worker_List, (defalut_Control._worker_List)._Scroll)
end

HandleScroll_SubWork_Progress_List_OnClick = function()
  -- function num : 0_38 , upvalues : ScrollOnClick, Subwork_Progress_List, defalut_Control
  ScrollOnClick(Subwork_Progress_List, (defalut_Control._subWork_Info)._OnGoing_Scroll)
end

Item_Tooltip_Show_LargeCraft = function(isResult)
  -- function num : 0_39 , upvalues : LargCraft_List, SubWork_List, defalut_Control
  local workIndex = LargCraft_List._currentIndex
  local subWorkIndex = SubWork_List._selected_Index
...
FGlobal_LargeCraft_WorkManager_Open = function(houseInfoSSWrapper, param)
  -- function num : 0_40 , upvalues : Worker_List, houseInfoSS, houseKey, houseParam, LargCraft_List, SubWork_List, defalut_Control
...
FGlobal_LargeCraft_WorkManager_Close = function()
  -- function num : 0_41
  FGlobal_WorldMapWindowEscape()
end

HandleClick_doWork_LargeCraft = function()
  -- function num : 0_42 , upvalues : Subwork_Progress_List, LargCraft_List, SubWork_List, Worker_List, houseInfoSS, UI_PP, affiliatedTownKey
  ...
  if currentKey ~= selected_Work then
    ...
    do
      if LimitWorkableCount_LargeCraft() > 0 then
...
HandleClick_doWork_LargeCraft_Continue = function()
  -- function num : 0_43 , upvalues : Subwork_Progress_List, LargCraft_List, SubWork_List, Worker_List, houseInfoSS, affiliatedTownKey
  if LimitWorkableCount_LargeCraft() > 0 then
    local workCount = Subwork_Progress_List._workingCount
    local selected_Work = LargCraft_List._selectedWork
    local selected_SubWork = SubWork_List._selected_SubWork
...
LimitWorkableCount_LargeCraft = function()
  -- function num : 0_44 , upvalues : LargCraft_List, SubWork_List, Worker_List
  local workIndex = LargCraft_List._currentIndex
  local subWorkIndex = SubWork_List._selected_Index
...
Set_Workable_Count_LargetCraft = function(inputNumber)
  -- function num : 0_45 , upvalues : Subwork_Progress_List, defalut_Control
  -- DECOMPILER ERROR at PC4: Confused about usage of register: R1 in 'UnsetPending'
...
HandleClicked_WorkCount_LargeCraft = function()
  -- function num : 0_46
...
HandleClick_OnGoing_Cancel_LargeCraft = function(idx)
  -- function num : 0_47 , upvalues : Subwork_Progress_List, worker_StopWork, UI_PP
  local index = Subwork_Progress_List._offsetIndex + idx
  if (Subwork_Progress_List._workerList)[index] ~= nil then
...
HandleClick_OnGoing_Cancel_LargeCraft_Continue = function()
  -- function num : 0_48 , upvalues : worker_StopWork
  ToClient_requestCancelNextWorking(worker_StopWork)
  worker_StopWork = nil
end

FromClient_LargeCraft_WorkManager_StopWorkerWorking = function(workerNo, isUserRequest)
  -- function num : 0_49 , upvalues : _Cancel_All, houseInfoSS
  do
    if _Cancel_All == true then
      local workingCout = ToClient_getHouseWorkingWorkerList(houseInfoSS)
...
FromClient_LargeCraft_WorkManager_WorkerDataUpdate = function(rentHouseWrapper)
  -- function num : 0_50 , upvalues : houseKey
...
FromClient_LargeCraft_WorkManager_ClearLargeCraft = function(characterKey)
  -- function num : 0_51 , upvalues : houseKey, LargCraft_List
...
FromClient_LargeCraft_WorkManager_changeLeftWorking = function(workerNoRaw)
  -- function num : 0_52
  FGlobal_LargeCraft_WorkManager_Refresh()
end

FGlobal_LargeCraft_WorkManager_Refresh = function(dontUpdateWorker)
  -- function num : 0_53 , upvalues : LargCraft_List, SubWork_List, Worker_List
  if Panel_LargeCraft_WorkManager:GetShow() then
    LargCraft_List:_setData()
    SubWork_List:_setData()
    if dontUpdateWorker == false then
      Worker_List:_setData()
    end
    LargCraft_List:_updateSlot()
    SubWork_List:_updateSlot()
...
FromClient_WareHouse_Update_ForLargeCraft = function(_affiliatedTownKey)
  -- function num : 0_54 , upvalues : affiliatedTownKey
  if affiliatedTownKey == _affiliatedTownKey and Panel_LargeCraft_WorkManager:GetShow() == true then
    FGlobal_LargeCraft_WorkManager_Refresh(true)
  end
end
