...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\x86\window\servant\panel_window_servantinfo.luac 
  ...
  if UI_VT.Type_Horse == vehicleType or UI_VT.Type_Camel == vehicleType or UI_VT.Type_Donkey == vehicleType or UI_VT.Type_Elephant == vehicleType or UI_VT.Type_RidableBabyElephant == vehicleType then
    ...
    if UI_VT.Type_Carriage == vehicleType or UI_VT.Type_CowCarriage == vehicleType or UI_VT.Type_Train == vehicleType then
      ...
      if UI_VT.Type_Boat == vehicleType or UI_VT.Type_Raft == vehicleType or UI_VT.Type_FishingBoat == vehicleType then
        ...
        if UI_VT.Type_SailingBoat == vehicleType or UI_VT.Type_TradeShip == vehicleType or UI_VT.Type_PersonTradeShip == vehicleType then
