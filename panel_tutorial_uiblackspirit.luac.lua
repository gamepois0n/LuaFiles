...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tutorial\panel_tutorial_uiblackspirit.luac 

-- params : ...
-- function num : 0
PaGlobal_TutorialUiBlackSpirit = {
_ui = {_obsidian = (UI.getChildControl)(Panel_Tutorial, "Static_Obsidian"), _obsidian_B = (UI.getChildControl)(Panel_Tutorial, "Static_Obsidian_B"), _obsidian_B_Left = (UI.getChildControl)(Panel_Tutorial, "Static_Obsidian_B_Left"), _obsidian_Text = (UI.getChildControl)(Panel_Tutorial, "StaticText_Obsidian_B"), _obsidian_Text_2 = (UI.getChildControl)(Panel_Tutorial, "StaticText_Obsidian_B_2"), _bubbleKey_W = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_W"), _bubbleKey_A = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_A"), _bubbleKey_S = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_S"), _bubbleKey_D = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_D"), _bubbleKey_I = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_I"), _bubbleKey_R = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_R"), _bubbleKey_T = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_T"), _bubbleKey_Shift = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_Shift"), _bubbleKey_Ctrl = (UI.getChildControl)(Panel_Tutorial, "StaticText_BubbleKey_Ctrl"), _mouseBody_L = (UI.getChildControl)(Panel_Tutorial, "Static_MouseBody_L"), _mouseLButton_L = (UI.getChildControl)(Panel_Tutorial, "Static_L_Btn_L"), _mouseLButton_R = (UI.getChildControl)(Panel_Tutorial, "Static_L_Btn_R"), _mouseBody_R = (UI.getChildControl)(Panel_Tutorial, "Static_MouseBody_R"), _mouseRButton_L = (UI.getChildControl)(Panel_Tutorial, "Static_R_Btn_L"), _mouseRButton_R = (UI.getChildControl)(Panel_Tutorial, "Static_R_Btn_R")}
...
PaGlobal_TutorialUiBlackSpirit.setShowMouseL = function(self, bShow)
  -- function num : 0_0
...
PaGlobal_TutorialUiBlackSpirit.setPosMouseL = function(self, posX, posY)
  -- function num : 0_1
...
PaGlobal_TutorialUiBlackSpirit.initialize = function(self)
  -- function num : 0_2
...
PaGlobal_TutorialUiBlackSpirit.getBubbleKeyMargin = function(self)
  -- function num : 0_3
...
PaGlobal_TutorialUiBlackSpirit.eraseEffect = function(self, key)
  -- function num : 0_4
...
PaGlobal_TutorialUiBlackSpirit.addEffect = function(self, key, effectName, isLoop, posX, posY)
  -- function num : 0_5
...
PaGlobal_TutorialUiBlackSpirit.addEffectBlackSpirit = function(self, effectName, isLoop, posX, posY)
  -- function num : 0_6
...
PaGlobal_TutorialUiBlackSpirit.eraseEffectBlackSpirit = function(self)
  -- function num : 0_7
...
PaGlobal_TutorialUiBlackSpirit.resetPosition = function(self)
  -- function num : 0_8
...
PaGlobal_TutorialUiBlackSpirit.setShow = function(self, key, isShow)
  -- function num : 0_9
...
PaGlobal_TutorialUiBlackSpirit.setPosX = function(self, key, posX)
  -- function num : 0_10
...
PaGlobal_TutorialUiBlackSpirit.setPosY = function(self, key, posY)
  -- function num : 0_11
...
PaGlobal_TutorialUiBlackSpirit.getPosX = function(self, key, posX)
  -- function num : 0_12
...
PaGlobal_TutorialUiBlackSpirit.getPosY = function(self, key, posY)
  -- function num : 0_13
...
PaGlobal_TutorialUiBlackSpirit.getSizeY = function(self, key, sizeY)
  -- function num : 0_14
...
PaGlobal_TutorialUiBlackSpirit.setShowBubbleKey = function(self, key, isShow)
  -- function num : 0_15
  ((self._ui)[key]):SetShow(isShow)
end
...
PaGlobal_TutorialUiBlackSpirit.setShowBlackSpirit = function(self, isShow)
  -- function num : 0_16
...
PaGlobal_TutorialUiBlackSpirit.setShowAll = function(self, isShow)
  -- function num : 0_17
...
PaGlobal_TutorialUiBlackSpirit.hideBubbleKey = function(self)
  -- function num : 0_18
...
PaGlobal_TutorialUiBlackSpirit.changeBubbleKeyByKeySetting = function(self)
  -- function num : 0_19
...
PaGlobal_TutorialUiBlackSpirit.showSuggestCallSpiritUi = function(self)
  -- function num : 0_20
...
PaGlobal_TutorialUiBlackSpirit.resetSpiritUiForTutorial = function(self)
  -- function num : 0_21
  self:resetPosition()
  ;
...
PaGlobal_TutorialUiBlackSpirit.setSpiritUiForTutorial = function(self, text1, text2, isLeftSideBubble, spiritPosX, spiritPosY, isIgnore)
  -- function num : 0_22
...
PaGlobal_TutorialUiBlackSpirit.setSpiritUiForTutorialFunctor = function(self, functor)
  -- function num : 0_23
...
PaGlobal_TutorialUiBlackSpirit.doSpiritUiForTutorialFunctor = function(self)
  -- function num : 0_24
  if PaGlobal_TutorialUiBlackSpirit._blackSpiritRestorFunctor == nil then
    return 
  end
  ;
...
PaGlobal_TutorialUiBlackSpirit.addBubbleKey = function(self, ...)
  -- function num : 0_25
...
PaGlobal_TutorialUiBlackSpirit.addOverBubbleKey = function(self, destKey, targetKey)
  -- function num : 0_26
...
PaGlobal_TutorialUiBlackSpirit.getCurrentObsidianBubble = function(self)
  -- function num : 0_27
...
PaGlobal_TutorialUiBlackSpirit.setIgnoreBubble = function(self, bIgnore)
  -- function num : 0_28
...
PaGlobal_TutorialUiBlackSpirit.handleMouseOnBubble = function(self)
  -- function num : 0_29
  local currentBubble = self:getCurrentObsidianBubble()
...
PaGlobal_TutorialUiBlackSpirit.handleMouseOutBubble = function(self)
  -- function num : 0_30
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
PaGlobal_TutorialUiBlackSpirit.handleMouseLDownBubble = function(self)
  -- function num : 0_31
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
PaGlobal_TutorialUiBlackSpirit.handleMouseLUpBubble = function(self)
  -- function num : 0_32
  local currentBubble = self:getCurrentObsidianBubble()
  if currentBubble ~= nil then
    self:changeBubbleTextureForAni(true)
...
FromClient_luaLoadComplete_TutorialUiBlackSpirit = function()
  -- function num : 0_33
  PaGlobal_TutorialUiBlackSpirit:initialize()
end

Tutorial_OnResize = function()
  -- function num : 0_34
...
PaGlobal_TutorialUiBlackSpirit.changeBubbleTextureForAni = function(self, bWhite)
  -- function num : 0_35
