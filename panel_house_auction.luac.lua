...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\auction\panel_house_auction.luac 
...
HandleClickedAuctionPageChange = function()
  -- function num : 0_3 , upvalues : HouseAuctionManager
...
HandleClickedAuctionPrevButton = function()
  -- function num : 0_4 , upvalues : HouseAuctionManager
  for key,value in pairs(HouseAuctionManager._houseAuctionList) do
    (value._editInGold):SetEditText("", true)
  end
  ClearFocusEdit()
...
HandleClickedAuctionNextButton = function()
  -- function num : 0_5 , upvalues : HouseAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
...
FGlobal_AuctionWindow_Hide = function()
  -- function num : 0_6
...
FGlobal_AuctionWindow_Show = function()
  -- function num : 0_7
  local isShow = Panel_Auction:IsShow()
...
HouseAuctionManager.initialize = function(self)
  -- function num : 0_8 , upvalues : maxYCount, maxXCount, styleBG, cancelButton, bidButton, name, nowPrice, aucPrice, myPrice, editInGold, money, styleImage, styleTime, styleArea, styleSpecialService, sizeX, startX, sizeY, startY, gapY, auctionHouseDescFrame
...
HouseAuctionTab = function()
  -- function num : 0_9 , upvalues : HouseAuctionManager
  local self = HouseAuctionManager
  return false
end

HandleClickedAuctionBidHouse = function(index)
  -- function num : 0_10 , upvalues : HouseAuctionManager
...
HouseAuctionManager.updateHouseList = function(self)
  -- function num : 0_11 , upvalues : HouseAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
  local houseCount = myAuctionInfo:getHouseAuctionListCount()
  for index = 0, 5 do
...
HouseAuctionManager.setHouseData = function(self, index)
  -- function num : 0_12 , upvalues : auctionDisplayTime, UI_TM, auctionHouseDescFrame
  local myAuctionInfo = RequestGetAuctionInfo()
  ...
  ;
  (((self._houseAuctionList)[index])._styleArea):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. " " .. tostring(Uint64toUint32(houseAuctionInfo:getGoodsArea())) .. "ãŽ\161")
...
HouseAuctionManager.updateBidList = function(self)
  -- function num : 0_13 , upvalues : HouseAuctionManager
  local myAuctionInfo = RequestGetAuctionInfo()
...
HouseAuctionManager.setBidData = function(self, index)
  -- function num : 0_14 , upvalues : auctionDisplayTime, UI_TM, auctionHouseDescFrame
  local myAuctionInfo = RequestGetAuctionInfo()
  ...
  ;
  (((self._houseAuctionList)[index])._styleArea):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. tostring(Uint64toUint32(bidAuctionInfo:getGoodsArea())) .. "ãŽ\161")
...
FromClient_ResponseAuction_UpdateAuctionList = function()
  -- function num : 0_16 , upvalues : buttonListRight, buttonListLeft, styleListCount, myBidList, HouseAuctionManager
  Panel_Auction:SetShow(true, true)
  local myAuctionInfo = RequestGetAuctionInfo()
  local auctionType = myAuctionInfo:getAuctionType()
