...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tutorial\panel_summonbosstutorial_uiheadlinemessage.luac 

-- params : ...
-- function num : 0
PaGlobal_SummonBossTutorial_UiHeadlineMessage = {
_ui = {_purposeText = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Purpose"), _nextStep_1 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Step_1"), _nextStep_2 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Step_2"), _nextStep_3 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Step_3"), _nextStep_4 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Step_4"), _nextArrow_0 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_NextArrow_0"), _nextArrow_1 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_NextArrow_1"), _nextArrow_2 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_NextArrow_2"), _clearStep_1 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_Clear_Step1"), _clearStep_2 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_Clear_Step2"), _clearStep_3 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_Clear_Step3"), _clearStep_4 = (UI.getChildControl)(Panel_SummonBossTutorial, "Static_Clear_Step4")}
}
-- DECOMPILER ERROR at PC78: Confused about usage of register: R0 in 'UnsetPending'

PaGlobal_SummonBossTutorial_UiHeadlineMessage.setPurposeText = function(self, string)
  -- function num : 0_0
  if string == nil then
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.setShow = function(self, key, isShow)
  -- function num : 0_1
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.setAlpha = function(self, key, value)
  -- function num : 0_2
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.addEffect = function(self, key, effectName, isLoop, posX, posY)
  -- function num : 0_3
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.setShowAll = function(self, isShow)
  -- function num : 0_4
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.setAlphaAll = function(self, value)
  -- function num : 0_5
  for key,value in pairs(self._ui) do
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.setTextPurposeText = function(self, text)
  -- function num : 0_6
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.computePosAll = function(self)
  -- function num : 0_7
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.resetShowAll = function(self)
  -- function num : 0_8
  self:computePosAll()
  ;
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.addClearStepEffect = function(self, clearCount)
  -- function num : 0_9
...
PaGlobal_SummonBossTutorial_UiHeadlineMessage.resetClearStepEffect = function(self)
  -- function num : 0_10
  self:computePosAll()
  ;
  ((self._ui)._nextStep_1):SetFontColor((Defines.Color).C_FFFFFFFF)
