...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\servant\panel_cannon.luac 
...
local fireGuide = {fireGuide_BG = (UI.getChildControl)(Panel_Cannon, "Static_CommandBG"), fireGuide_KeyShift1 = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_Shift1"), fireGuide_KeyShift2 = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_Shift2"), fireGuide_KeyShift3 = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_Shift3"), fireGuide_KeyShift4 = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_Shift4"), fireGuide_KeyW = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_W"), fireGuide_KeyS = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_S"), fireGuide_MouseL = (UI.getChildControl)(Panel_Cannon, "Static_Key_MouseL_0"), fireGuide_MouseR = (UI.getChildControl)(Panel_Cannon, "Static_Key_MouseR_0"), fireGuide_Space = (UI.getChildControl)(Panel_Cannon, "StaticText_Key_Space"), fireGuide_Text_Ready = (UI.getChildControl)(Panel_Cannon, "StaticText_Ready"), fireGuide_Text_High = (UI.getChildControl)(Panel_Cannon, "StaticText_HighAngle"), fireGuide_Text_Low = (UI.getChildControl)(Panel_Cannon, "StaticText_LowAngle"), fireGuide_Text_Fire = (UI.getChildControl)(Panel_Cannon, "StaticText_Fire")}
;
...
local Cannon_Initialize = function()
  -- function num : 0_2 , upvalues : progresssBG, progresss, progresss_Head, arrowProgressBG, arrowProgress, arrowProgress_Head, flameProgressBG, flameProgress, flameProgress_Head, fireGuide
...
local nowCool = 0
local cannon = {}
FromClient_Cannon_ProgressUpdate = function()
  -- function num : 0_3 , upvalues : vehicle_actorKeyRaw, cannon, progresss, flameProgress, arrowProgress
  if vehicle_actorKeyRaw == 0 then
    return 
  end
  ...
  if (CppEnums.VehicleType).Type_Cannon == (cannon:get()):getVehicleType() or (CppEnums.VehicleType).Type_PracticeCannon == (cannon:get()):getVehicleType() then
    ...
    do
      if (CppEnums.VehicleType).Type_ThrowFire == (cannon:get()):getVehicleType() then
        local mp = (cannon:get()):getMp()
        local maxMp = (cannon:get()):getMaxMp()
        local nowCoolTime = mp / maxMp * 100
        ...
        do
          if (CppEnums.VehicleType).Type_ThrowStone == (cannon:get()):getVehicleType() then
            local mp = (cannon:get()):getMp()
            local maxMp = (cannon:get()):getMaxMp()
            local nowCoolTime = mp / maxMp * 100
...
Cannon_GuideShow = function(show, showType)
  -- function num : 0_4 , upvalues : fireGuide
...
FromClient_Cannon_Show = function(actorKeyRaw)
  -- function num : 0_5 , upvalues : Cannon_Initialize, vehicle_actorKeyRaw, progresssBG, progresss, progresss_Head, arrowProgressBG, arrowProgress, arrowProgress_Head, flameProgress, flameProgressBG, flameProgress_Head, cannon
  ...
  if (CppEnums.VehicleType).Type_Cannon == isVehicleType or (CppEnums.VehicleType).Type_PracticeCannon == isVehicleType then
    ...
    do
      if (CppEnums.VehicleType).Type_ThrowStone == isVehicleType then
        Panel_Cannon:SetShow(true, true)
        progresssBG:SetShow(false)
        progresss:SetShow(false)
        progresss_Head:SetShow(false)
        ...
        do
          if (CppEnums.VehicleType).Type_ThrowFire == isVehicleType then
            Panel_Cannon:SetShow(true, true)
            progresssBG:SetShow(false)
            progresss:SetShow(false)
            progresss_Head:SetShow(false)
            ...
            do
              if (CppEnums.VehicleType).Type_Train == isVehicleType then
...
FromClient_Cannon_Hide = function()
  -- function num : 0_6
