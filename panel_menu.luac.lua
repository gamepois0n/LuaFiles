...
GameMenu_Init = function()
  ...
  for index = 1, maxButtonCount do
    ...
    if (CppEnums.CountryType).DEV == getGameServiceType() then
      Panel_Menu:addConsoleUIControl(tempBg, 0, index - 1)
    end
