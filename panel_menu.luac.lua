...
GameMenu_CheckEnAble = function(buttonType)
  ...
  do
    ...
    if not isGameTypeKR2() then
      ...
      if buttonType == MenuButtonId.btn_Twitch or buttonType == MenuButtonId.btn_SavageDefence or buttonType == MenuButtonId.btn_SocialAction then
