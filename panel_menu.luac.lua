...
, 
[MenuButtonId.btn_Mercenary] = {278, 265, 322, 309}
, 
                                            ...
                                            if MenuButtonId.btn_FishEncyclopedia == index then
                                              ...
                                              if MenuButtonId.btn_ColorMix == index then
                                                ...
                                                if MenuButtonId.btn_Event == index then
                                                  ...
                                                  if MenuButtonId.btn_DailyStamp == index then
...
GameMenu_Init = function()
  -- function num : 0_4 , upvalues : maxButtonCount, UI_PUCT, menu_Bg, menuIconBg, menuButtonBG, menuIcon, menuButtonIcon, menuHotkey, menuButtonHotkey, MenuButtonHotKeyID, menuBadge, menuBadgePool, menuText, UI_TM, menuTextPool, MenuButtonTextId
  local posIndex = 1
...
GameMenu_CheckEnAble = function(buttonType)
  -- function num : 0_5 , upvalues : MenuButtonId, isLocalwarOpen, isFreeFight, isTradeEventOpen, webAlbumOpen, isBlackSpiritAdventure, joinCheckOpen, isContentsArsha, isMercenaryOpen, isSavageOpen, photoGalleryOpen, partyListOpen
    ...
    if isGameTypeJapan() then
      ...
      if isGameTypeRussia() then
        ...
        if isGameTypeEnglish() then
          ...
          if isGameTypeThisCountry((CppEnums.ContryCode).eContryCode_CHI) then
            returnValue = true
          else
  ...
  do
    ...
    if buttonType == MenuButtonId.btn_DailyStamp then
