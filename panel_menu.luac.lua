...
, 
[MenuButtonId.btn_TeamDuel] = {370, 357, 414, 401}
, 
...
, 
[MenuButtonId.btn_DropItem] = {370, 311, 414, 355}
, 
[MenuButtonId.btn_ShortCut] = {370, 403, 414, 447}
, 
[MenuButtonId.btn_SaveSetting] = {370, 449, 414, 493}
}
    ...
    ToClient_JoinPvpBattleGround(0)
                                                                                        ...
                                                                                        do
                                                                                          do
                                                                                            ...
                                                                                            if MenuButtonId.btn_TeamDuel == index then
                                                                                                              ...
                                                                                                              if MenuButtonId.btn_Update == index then
                                                                                                                ...
                                                                                                                if MenuButtonId.btn_BSAdventure2 == index then
                                                                                                                  ...
                                                                                                                  if MenuButtonId.btn_Twitch == index then
                                                                                                                    ...
                                                                                                                    if MenuButtonId.btn_SocialAction == index then
                                                                                                                      ...
                                                                                                                      if MenuButtonId.btn_LuxuryAuction == index then
                                                                                                                        ...
                                                                                                                        if MenuButtonId.btn_Copyright == index then
                                                                                                                          ...
                                                                                                                          if MenuButtonId.btn_Memo == index then
                                                                                                                            ...
                                                                                                                            if MenuButtonId.btn_DropItem == index then
                                                                                                                              FGlobal_DropItemWindow_Open()
                                                                                                                            else
                                                                                                                              if MenuButtonId.btn_ShortCut == index then
                                                                                                                                FGlobal_ButtonShortcuts_Open()
                                                                                                                              else
                                                                                                                                if MenuButtonId.btn_SaveSetting == index then
...
GameMenu_CheckEnAble = function(buttonType)
  -- function num : 0_5 , upvalues : MenuButtonId, isLocalwarOpen, isFreeFight, isTeamDuelOpen, isTradeEventOpen, isBlackSpiritAdventure, joinCheckOpen, isContentsArsha, isMercenaryOpen, isSavageOpen, photoGalleryOpen, partyListOpen, isMonsterRanking, isMasterPiece, isBlackSpiritAdventure2, isSiegeEnable, isDropItemOpen, isButtonShortCut, menuNewPool
...
Panel_Menu_ShowToggle = function()
  ...
  do
    ...
    if Panel_Menu:IsShow() == true then
      ...
      if Panel_MiniGame_Find:IsShow() == true then
        return false
      else
...
FGlobal_MenuType_Check = function()
  -- function num : 0_26 , upvalues : isActionUiOpen
  ...
  if (isActionUiOpen or isGameTypeKorea()) and currentMenuType == 0 then
    if userType == 2 then
      (ToClient_getGameUIManagerWrapper()):setLuaCacheDataListNumber((CppEnums.GlobalUIOptionType).MenuType, 2, (CppEnums.VariableStorageType).eVariableStorageType_User)
    else
      ;
