...
local isGuildMatch = isGameServiceTypeDev()
...
, 
[MenuButtonId.btn_GuildMatch] = {324, 127, 368, 171}
}
                                                                                                          ...
                                                                                                          if MenuButtonId.btn_Steam == index then
                                                                                                            ...
                                                                                                            if MenuButtonId.btn_Update == index then
                                                                                                              ...
                                                                                                              if MenuButtonId.btn_BSAdventure2 == index then
                                                                                                                ...
                                                                                                                if MenuButtonId.btn_GuildMatch == index then
...
GameMenu_CheckEnAble = function(buttonType)
  -- function num : 0_5 , upvalues : MenuButtonId, isLocalwarOpen, isFreeFight, isTradeEventOpen, webAlbumOpen, isBlackSpiritAdventure, joinCheckOpen, isContentsArsha, isMercenaryOpen, isSavageOpen, photoGalleryOpen, partyListOpen, isMonsterRanking, isBlackSpiritAdventure2, isGuildMatch
  ...
  do
    ...
    if buttonType == MenuButtonId.btn_GuildMatch then
      if isGuildMatch then
        returnValue = true
      else
        returnValue = false
      end
