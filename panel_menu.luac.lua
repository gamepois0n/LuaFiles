...
, 
[MenuButtonId.btn_TeamDuel] = {324, 403, 368, 447}
, 
    ...
    ToClient_JoinPvpBattleGround(0)
                                                                                        ...
                                                                                        do
                                                                                          do
                                                                                            ...
                                                                                            if MenuButtonId.btn_TeamDuel ~= index or MenuButtonId.btn_Itemmarket == index then
...
GameMenu_CheckEnAble = function(buttonType)
  -- function num : 0_5 , upvalues : MenuButtonId, isLocalwarOpen, isFreeFight, isTeamDuelOpen, isTradeEventOpen, webAlbumOpen, isBlackSpiritAdventure, joinCheckOpen, isContentsArsha, isMercenaryOpen, isSavageOpen, photoGalleryOpen, partyListOpen, isMonsterRanking, isMasterPiece, isBlackSpiritAdventure2, isSiegeEnable, isMemoOpen, isDropItemOpen, menuNewPool
