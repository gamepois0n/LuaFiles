...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\tutorial\tutorial_phase_basicskill_warrior.luac 

-- params : ...
-- function num : 0
PaGlobal_TutorialPhase_BasicSkill_Warrior = {_phaseNo = 6, _currentType = 0, _currentStep = 0, _nextStep = 0, _currentProgress = 1, _updateTime = 0, _isPhaseOpen = true, _isSkippable = true, 
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.checkPossibleForPhaseStart = function(self, stepNo)
  -- function num : 0_0
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.checkSkippablePhase = function(self)
  -- function num : 0_1
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.startPhase = function(self, stepNo, typeNo)
  -- function num : 0_2
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.startPhaseXXX = function(self, stepNo, typeNo)
  -- function num : 0_3 , upvalues : navigationGuideParam
  PaGlobal_TutorialManager:setCurrentPhaseNo(self._phaseNo)
  PaGlobal_TutorialManager:setDoingTutorial(true)
  _PA_LOG("곽민�\176", "PaGlobal_TutorialPhase_BasicSkill_Warrior:startStep() typeNo : " .. tostring(typeNo))
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.endPhase = function(self)
  -- function num : 0_4
  self._currentStep = 0
  self._nextStep = 1
  ;
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.updatePerFrame = function(self, deltaTime)
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.handleChangeStep = function(self, currentStep)
  -- function num : 0_6
  if self._currentType == 1 then
    if self._currentStep == 1 then
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.showUiScoldingTooManyKeyInput = function(self)
  -- function num : 0_7
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.changeStepTryBasicSkill = function(self)
  -- function num : 0_8
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.updateTryBasicSkill = function(self, deltaTime)
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.eventCallUsedSkill_TryBasicSkill = function(self, skillWrapper)
  -- function num : 0_10
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.changeStepTrySkillCombo = function(self)
  -- function num : 0_11
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.updateTrySkillCombo = function(self, deltaTime)
  -- function num : 0_12
  (PaGlobal_TutorialUiManager:getUiKeyButton()):ButtonToggleAll(true)
  if self._totalComboCount <= self._usedComboCount then
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.eventCallUsedSkill_TrySkillCombo = function(self, skillWrapper)
  -- function num : 0_13
  local listNo = 0
  local skillNo = skillWrapper:getSkillNo()
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.changeStepSuggestCallBlackSpirit = function(self)
  -- function num : 0_14
  if self._currentProgress == 1 then
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.eventCallAcceptBlackSpiritQuest = function(self, isAccept, questGroupNo, questId)
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.eventCallAfterBlackSpiritDialogClose = function(self)
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.handleEventQuestUpdateNotify = function(self, isAccept, questNoRaw)
  -- function num : 0_17
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.handleAfterAndPopFlush = function(self)
  -- function num : 0_18
...
PaGlobal_TutorialPhase_BasicSkill_Warrior.handleEventSelfPlayerUsedSkill = function(self, skillWrapper)
  -- function num : 0_19
