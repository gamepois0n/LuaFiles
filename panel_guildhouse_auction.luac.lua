...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\x86\window\auction\panel_guildhouse_auction.luac 
...
GuildHouseAuctionManager.setHouseData = function(self, index)
  ...
  ;
  (((self._houseAuctionList)[index])._area):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. " " .. tostring(Uint64toUint32(houseAuctionInfo:getGoodsArea())) .. "ãŽ\161")
...
GuildHouseAuctionManager.setBidData = function(self, index)
  ...
  ;
  (((self._houseAuctionList)[index])._area):SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HOUSEAUCTION_AREA") .. tostring(Uint64toUint32(bidAuctionInfo:getGoodsArea())) .. "ãŽ\161")
