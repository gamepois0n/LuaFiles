...
do
  ...
  -- function num : 0_22 , upvalues : inGameShopBuy, UI_color, UI_CCC
  local self = inGameShopBuy
  ...
  -- function num : 0_24 , upvalues : inGameShopBuy, contry, UI_CCC, cashIconType
  local self = inGameShopBuy
  ...
  -- function num : 0_42 , upvalues : inGameShopBuy
