...
local dedaMessage_RevivalItemInit = function()
  -- function num : 0_1 , upvalues : maxRevivalItemKindCount, revivalItemControl, revivalItemIcon, _templeateRevivalItem
...
local create_reviveList = function()
  -- function num : 0_2 , upvalues : reviveListCount, reviveBG, reviveListPool
  for idx = 0, reviveListCount - 1 do
    ...
    -- function num : 0_2_2 , upvalues : slot
    ...
    -- function num : 0_2_3 , upvalues : slot
    if isDisable then
...
local fillFortressInfo = function()
  -- function num : 0_3 , upvalues : reviveListCount, reviveListPool
...
deadNodeSelect = function(idx)
  -- function num : 0_4 , upvalues : deadMessage_ClearDropItems
  local temporaryWrapper = getTemporaryInformationWrapper()
...
deadMessage_Resize = function()
  -- function num : 0_6 , upvalues : _bg, _text_Title, _text_ImmediateCount, _button_ItemRevival, _button_NormalRevival, _deadBlackHole, _deadMessage, _regenTime, maxRevivalItemKindCount, revivalItemControl, STATIC_DROP_ITEM
...
local isButtonShow = {_button_ObserverMode = false, _button_Immediate = false, _button_SiegeIng = false, _button_LocalWar = false, _button_SavageOut = false, _button_MoveTown = false, _button_MoveExploration = false, _button_Volunteer = false, _button_AdvancedBase = false, _button_GuildSpawn = false}
deadMessage_ButtonSetPos = function()
  -- function num : 0_7 , upvalues : _button_Immediate, _text_Title, _button_ObserverMode, isButtonShow, _useCashItemBG, _checkBoxUseCache, _text_reviveNotify, _button_SiegeIng, _button_LocalWar, _button_SavageOut, _button_MoveTown, _button_MoveExploration, _button_AdvancedBase, _text_AdvancedBaseAlert, _button_Volunteer, _button_GuildSpawn
  local screenX = getScreenSizeX()
  local screenY = getScreenSizeY()
...
deadMessage_ButtonShow = function()
  -- function num : 0_8 , upvalues : _button_ObserverMode, isButtonShow, _button_Immediate, _button_SiegeIng, _button_LocalWar, _button_SavageOut, _button_MoveTown, _button_MoveExploration, _button_Volunteer, _button_AdvancedBase, _button_GuildSpawn, _text_ImmediateCount
...
deadMessage_RevivalButtonHide = function()
  -- function num : 0_9 , upvalues : _button_ObserverMode, _button_Immediate, _button_SiegeIng, _button_LocalWar, _button_SavageOut, _button_MoveTown, _button_MoveExploration, _button_Volunteer, _button_AdvancedBase, _button_GuildSpawn
...
deadMessage_RevivalKindButtonHide = function()
  -- function num : 0_10 , upvalues : _button_ItemRevival, _button_NormalRevival
...
deadmMessage_RevivalItemListButtonHide = function()
  -- function num : 0_11 , upvalues : maxRevivalItemKindCount, revivalItemControl
  for index = 0, maxRevivalItemKindCount - 1 do
...
deadMessage_ButtonShowAni = function(control)
...
deadMessage_ButtonHideAni = function(control)
...
deadMessage_BackButtonShowAni = function()
  -- function num : 0_14 , upvalues : _button_Back, UI_ANI_ADV, UI_color
...
deadMessage_BackButtonHideAni = function()
  -- function num : 0_15 , upvalues : _button_Back, UI_ANI_ADV, UI_color
  local colorAni = _button_Back:addColorAnimation(0, 0.2, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
  colorAni:SetStartColor(UI_color.C_FFFFFFFF)
  colorAni:SetEndColor(UI_color.C_00FFFFFF)
  colorAni.IsChangeChild = false
...
local deadMessage_Animation = function()
  -- function num : 0_16 , upvalues : _deadBlackHole, UI_ANI_ADV, UI_color, _text_Title, _button_MoveTown, _text_reviveNotify, _button_MoveExploration, _button_ObserverMode, _button_Immediate, _text_ImmediateCount, _button_SiegeIng, _button_AdvancedBase, _text_AdvancedBaseAlert, _button_LocalWar, _button_SavageOut, _button_GuildSpawn, _button_Volunteer, _checkBoxUseCache, _useCashItemBG, _deadMessage, _bg, _regenTime, startTimer
...
deadMessage_AddDropItem = function(itemName, count, enchantLevel, dropType)
  -- function num : 0_19 , upvalues : STATIC_DROP_ITEM, DROP_ITEM_COUNT, undefinedEnchantLevel, UI_color, UI_ANI_ADV
...
deadMessage_WeakEquipCantPushinventory = function(notify)
  -- function num : 0_20 , upvalues : STATIC_DROP_ITEM, DROP_ITEM_COUNT, UI_color, UI_ANI_ADV
  if #STATIC_DROP_ITEM < DROP_ITEM_COUNT then
    return 
  end
  local static = STATIC_DROP_ITEM[DROP_ITEM_COUNT]
...
deadMessage_WeakEquip = function(slotNo)
  -- function num : 0_21 , upvalues : STATIC_DROP_ITEM, DROP_ITEM_COUNT, CPP_slotNoString, UI_color, UI_ANI_ADV
  if #STATIC_DROP_ITEM < DROP_ITEM_COUNT then
    return 
  end
  local static = STATIC_DROP_ITEM[DROP_ITEM_COUNT]
...
deadMessage_DestroyJewel = function(destoryJewel01, destoryJewel02, destoryJewel03, destoryJewel04, destoryJewel05)
  -- function num : 0_22 , upvalues : STATIC_DROP_ITEM, DROP_ITEM_COUNT, UI_color, UI_ANI_ADV
  if #STATIC_DROP_ITEM < DROP_ITEM_COUNT then
    return 
  end
...
deadMessage_ExpDown = function()
  -- function num : 0_23 , upvalues : STATIC_DROP_ITEM, UI_ANI_ADV, UI_color
  local static = STATIC_DROP_ITEM[0]
  static:SetShow(true)
...
deadMessage_ButtonPushed_MoveToVillage = function(useCashItem)
  -- function num : 0_24 , upvalues : isHasRestoreExperience, deadMessage_ClearDropItems
  local selfProxy = getSelfPlayer()
  if selfProxy == nil then
    return 
  end
...
deadMessage_ButtonPushed_MoveExploration = function(useCashItem)
  -- function num : 0_27 , upvalues : isHasRestoreExperience, deadMessage_ClearDropItems
  local selfProxy = getSelfPlayer()
  if selfProxy == nil then
    return 
  end
...
deadMessage_ButtonPushed_Immediate = function()
  -- function num : 0_29 , upvalues : isPvPMatchRevive, deadMessage_ClearDropItems
...
deadMessage_ButtonPushed_SiegeIng = function()
  -- function num : 0_30 , upvalues : deadMessage_ClearDropItems
...
deadMessage_ButtonPushed_GuildSpawn = function(useCashItem)
  -- function num : 0_35 , upvalues : isHasRestoreExperience, deadMessage_ClearDropItems
  local selfProxy = getSelfPlayer()
  if selfProxy == nil then
    return 
  end
...
deadmessage_RevivalItemShow = function(respawnType)
  -- function num : 0_37 , upvalues : CashRevivalData, _text_Title, revivalItemControl, revivalItemIcon, _button_Back, _text_ImmediateCount
  CashRevivalData = {}
...
deadMessage_PopMessageBox = function(respawnType, SelectedItemNo)
  -- function num : 0_39 , upvalues : CashRevivalData
  local do_revival = function()
    -- function num : 0_39_0 , upvalues : respawnType, CashRevivalData, SelectedItemNo
  ...
  local messageboxData = {title = msgTitle, content = msgContent, functionYes = do_revival, functionNo = MessageBox_Empty_function, priority = (CppEnums.PAUIMB_PRIORITY).PAUIMB_PRIORITY_LOW}
  ;
  (MessageBox.showMessageBox)(messageboxData)
end

deadMessage_SimpleTooltips = function(isShow)
  -- function num : 0_40 , upvalues : _useCashItemBG
...
deadMessage_ButtonPushed_ObserverMode = function()
  -- function num : 0_41 , upvalues : ResurrectionTime
...
deadMessage_ResurrectionTimeReturn = function(Rtime)
  -- function num : 0_42 , upvalues : ResurrectionTime, buttonAbleTime
...
deadMessage_ButtonPushed = function(_type)
  -- function num : 0_44 , upvalues : _button_ItemRevival, _button_NormalRevival, _text_Title, _button_Back, _text_ImmediateCount
...
deadMessage_PkPenaltyShow = function()
  -- function num : 0_45 , upvalues : _penaltyIcon
...
deadMessage_PkPenaltyHide = function()
  -- function num : 0_46
  TooltipSimple_Hide()
end

deadMessage_registEventHandler = function()
  -- function num : 0_47 , upvalues : _button_MoveTown, _button_MoveExploration, _button_Immediate, _button_SiegeIng, _button_AdvancedBase, _button_LocalWar, _button_SavageOut, _button_GuildSpawn, _useCashItemBG, _button_ObserverMode, _button_Volunteer, _button_Back, _penaltyIcon
