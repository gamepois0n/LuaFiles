...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tooltip\panel_tooltip_guild_introduce.luac 
...
local uiTextGroup = {_uiName = _uiName, _uiMaster = _uiMaster, _styleIntro = _styleIntro}
...
TooltipGuild_Show = function(control, guildNo_S64, guildName, guildMaster, guildIntro)
  -- function num : 0_2 , upvalues : _uiIcon, _uiName, UI_TM, _uiMaster, _styleIntro, getMaxRightPos, getMaxBottomPos
    ...
    if isSet == false then
      ...
      do
        do
          ...
          if guildIntro == nil or guildIntro == "" then
