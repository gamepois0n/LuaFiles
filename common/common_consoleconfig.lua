local PaGlobal_PanelList1 = {
  ...
  Panel_Window_HorseRace,
  Panel_Chat_SocialMenu,
  Panel_Chatting_Macro,
  Panel_CheckedQuest,
  Panel_MainQuest
}
local PaGlobal_PanelList = {
  Panel_UIMain,
  Panel_QuickSlot,
  Panel_MyHouseNavi,
  Panel_Window_PetIcon,
...
function FromClient_luaLoadComplete_ConsoleConfig()
  ...
  for _, panel in pairs(PaGlobal_PanelList) do
    ToClient_addIgnorePanelForGDC(panel)
  end
end
FromClient_luaLoadComplete_ConsoleConfig()
registerEvent("FromClient_luaLoadComplete", "FromClient_luaLoadComplete_ConsoleConfig")
