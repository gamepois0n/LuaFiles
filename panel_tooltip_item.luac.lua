...
Panel_Tooltip_Item_Show = function(itemStaticStatus, uiBase, isSSW, isItemWrapper, chattingLinkedItem, index, isItemMarket, invenSlotNo, TooltipType, indexForNaming)
  -- function num : 0_5 , upvalues : Panel_Tooltip_Item_DataObject, normalTooltip, equippedTooltip
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R10 in 'UnsetPending'
  ...
  if TooltipType ~= nil and indexForNaming ~= nil then
    if TooltipType == "Dye" then
      itemNamingStr = getItemNaming(getTItemNoBySlotNo(indexForNaming, true))
    else
      if TooltipType == "Improve" then
        itemNamingStr = getItemNaming(getTItemNoBySlotNo(indexForNaming, false))
      else
        if TooltipType == "InventoryBag" then
          itemNamingStr = getItemNaming(indexForNaming)
        else
          if TooltipType == "WeaponChange" then
            itemNamingStr = getItemNaming(getTItemNoBySlotNo(indexForNaming, false))
          else
            if TooltipType == "Delivery" then
              itemNamingStr = getItemNaming(indexForNaming)
            end
          end
        end
            ...
            do
              ...
              do
                ...
                if itemSSW:getItemType() == 1 and enchantLevel > 15 then
                  ...
                  if itemNamingStr ~= nil and isEnchantLevel5 == true then
                      ...
                      do
                        ...
                        do
                          ...
                          if Panel_Tooltip_Item_DataObject.inventory == true and isItemLock == true and not Panel_Tooltip_Item_equipped:GetShow() then
                            ...
                            do
                              if true == EquipItem_Lock.equipment then
                                        ...
                                        if not bEmpty then
                                          ...
                                          do
                                            do
                                              ...
                                              -- DECOMPILER ERROR at PC2414: LeaveBlock: unexpected jumping out DO_STMT

                                              -- DECOMPILER ERROR at PC2414: LeaveBlock: unexpected jumping out IF_ELSE_STMT

                                              -- DECOMPILER ERROR at PC2414: LeaveBlock: unexpected jumping out IF_STMT
