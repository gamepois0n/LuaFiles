...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\dye\panel_dyepreview.luac 
...
local ui = {_btn_WinClose = (UI.getChildControl)(Panel_DyePreview, "Button_Win_Close"), _btn_Question = (UI.getChildControl)(Panel_DyePreview, "Button_Question"), _btn_Close = (UI.getChildControl)(Panel_DyePreview, "Button_Close"), _viewer = (UI.getChildControl)(Panel_DyePreview, "Static_Viewer")}
Panel_DyePreview_ShowAni = function()
...
Panel_DyePreview_HideAni = function()
  -- function num : 0_1
