...
function registerClosePanelList()
  ...
  registerCloseLuaEvent(Panel_Window_PetInfo_Renew, closeTypeBitSet.default, "FGlobal_PetInfo_Close()")
  registerCloseLuaEvent(Panel_Window_PetExchange_Renew, closeTypeBitSet.default, "PaGlobalFunc_PetExchange_Close()")
  ...
  registerCloseLuaEvent(Panel_Window_CharInfo_Status, closeTypeBitSet.default, "PaGlobal_CharacterInfo:hideWindow()")
  ...
  registerCloseLuaEvent(Panel_Window_Enchant, closeTypeBitSet.default, "Enchant_Close()")
