...
AlchemyStone_CheckButtonTooltip = function(isShow)
  -- function num : 0_1 , upvalues : equip
  if not isShow then
    TooltipSimple_Hide()
    return 
  end
...
equip_checkUseableSlot = function(index)
  -- function num : 0_2 , upvalues : UnUsedEquipNo_01
...
equip.initControl = function(self)
  -- function num : 0_3 , upvalues : EquipNoMin, EquipNoMax, awakenWeaponContentsOpen, equip, isKR2ContentsEnable
...
Equipment_updateSlotData = function()
  ...
  do
    ...
    if ToClient_IsContentsGroupOpen("324") == true and Panel_MiniGame_Find:GetShow() == true then
