...
FromClient_EscapeEtcClose = function()
  -- function num : 0_96 , upvalues : Panel_LowLevelGuide_Value_IsCheckMoviePlay
...
close_WindowMinigamePanelList = function()
  -- function num : 0_102 , upvalues : panel_MinigameList
