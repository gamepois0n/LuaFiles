...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\chatting\panel_chatting_color.luac 
...
local chatColor = {_btnConfirm = (UI.getChildControl)(Panel_Chatting_Color, "Button_Confirm"), _btnWinClose = (UI.getChildControl)(Panel_Chatting_Color, "Button_WinClose"), _btnClose = (UI.getChildControl)(Panel_Chatting_Color, "Button_Cancle"), _plateColor = (UI.getChildControl)(Panel_Chatting_Color, "Static_Color"), _tempBG = (UI.getChildControl)(Panel_Chatting_Color, "Static_ColorBoxBG"), 
colorBtnList = {}
, boxStartX = 5, boxStartY = 5, boxGapX = 37, boxGapY = 37, _boxsCols = 11, savedChatType = nil, savedPanelIndex = nil, savedColorIndex = nil, totalColorCount = 88}
...
ChattingColor_Init = function()
  -- function num : 0_0 , upvalues : colorList, chatColor, colorSelected
...
ChattingColor_Update = function(panelIndex, chatType)
  -- function num : 0_1 , upvalues : colorList, colorSelected
  for btnIdx = 0, #colorList do
  ...
  if chatColorIndex ~= -1 and chatType ~= 5 then
    ((colorSelected[chatColorIndex]).colorSelector):SetCheck(true)
  end
  if chatColorSystemIndex ~= -1 and chatType == 5 then
    ((colorSelected[chatColorSystemIndex]).colorSelector):SetCheck(true)
  end
end

FGlobal_ChattingColor_Show = function(panelIndex, chatType)
  -- function num : 0_2
...
ChattingColor_Hide = function()
  -- function num : 0_3
  Panel_Chatting_Color:SetShow(false)
  Panel_ChatOption:SetSpanSize(0, 0)
end

ChattingColor_SelectColor = function(index)
  -- function num : 0_4 , upvalues : chatColor
  local self = chatColor
  self.savedColorIndex = index
end

FGlobal_ChattingColor_SetColor = function(panelIndex, chatType, chatButtonType, isSystem)
  -- function num : 0_5 , upvalues : chatColor
  local self = chatColor
  if self.savedColorIndex == nil then
...
FGlobal_ChattingColor_GetColor = function(panelIndex, chatType, chatButtonType, isSystem)
  -- function num : 0_6 , upvalues : chatColor
  local self = chatColor
...
ChattingColor_ClickedEvent = function()
  -- function num : 0_7 , upvalues : chatColor
...
ChattingColor_RegisterEvent = function()
  -- function num : 0_8
end
