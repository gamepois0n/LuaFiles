...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\widget\tutorial\panel_summonbosstutorial_uikeybutton.luac 

-- params : ...
-- function num : 0
local UI_color = Defines.Color
PaGlobal_SummonBossTutorial_UiKeyButton = {
_ui = {_button_Q = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_Q"), _button_W = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_W"), _button_A = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_A"), _button_S = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_S"), _button_D = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_D"), _button_E = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_E"), _button_F = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_F"), _button_T = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_T"), _button_Tab = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_Tab"), _button_Shift = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_Shift"), _button_Space = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_Space"), _button_Ctrl = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Btn_Ctrl"), _m0 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_M0"), _m1 = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_M1"), _mBody = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Mouse_Body"), _buttonLock = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_Button_Lock"), _m0_Lock = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_M0_Lock"), _m1_Lock = (UI.getChildControl)(Panel_SummonBossTutorial, "StaticText_M1_Lock")}
, 
_uvSet = {
_button_Q = {
on = {1, 1, 63, 65}
...
PaGlobal_SummonBossTutorial_UiKeyButton.changeActionKeyByKeySetting = function(self)
  -- function num : 0_0
...
PaGlobal_SummonBossTutorial_UiKeyButton.setShowAll = function(self, isShow)
  -- function num : 0_1
...
PaGlobal_SummonBossTutorial_UiKeyButton.computePosAll = function(self)
  -- function num : 0_2
...
PaGlobal_SummonBossTutorial_UiKeyButton.resetVertexAniAll = function(self)
  -- function num : 0_3
...
PaGlobal_SummonBossTutorial_UiKeyButton.disappearAll = function(self)
  -- function num : 0_4
  self:resetVertexAniAll()
  ;
...
PaGlobal_SummonBossTutorial_UiKeyButton.setAlphaAll = function(self, value)
  -- function num : 0_5
...
PaGlobal_SummonBossTutorial_UiKeyButton.setShow = function(self, key, isShow)
  -- function num : 0_6
...
PaGlobal_SummonBossTutorial_UiKeyButton.setAlpha = function(self, key, value)
  -- function num : 0_7
...
PaGlobal_SummonBossTutorial_UiKeyButton.setPrevUsingKey = function(self, key, isPrevUsing)
  -- function num : 0_8
...
PaGlobal_SummonBossTutorial_UiKeyButton.setPrevUsingKeyMany = function(self, isPrevUsing, ...)
  -- function num : 0_9
...
PaGlobal_SummonBossTutorial_UiKeyButton.setPrevUsingKeyAll = function(self, isPrevUsing)
  -- function num : 0_10
...
PaGlobal_SummonBossTutorial_UiKeyButton.ButtonToggleAll = function(self, isOn)
  -- function num : 0_11
...
PaGlobal_SummonBossTutorial_UiKeyButton.addEffect = function(self, key, effectName, isLoop, posX, posY)
  -- function num : 0_12
...
PaGlobal_SummonBossTutorial_UiKeyButton.eraseEffectAll = function(self)
  -- function num : 0_13
  for key,value in pairs(self._ui) do
...
PaGlobal_SummonBossTutorial_UiKeyButton.ButtonToggle = function(self, key, isOn)
