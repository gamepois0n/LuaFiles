...
_ui = {_btnClose = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Button_Close"), _btnCheckBoxPopUp = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "CheckButton_PopUp"), _staticTradeEventBG = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Static_TradeEventDescBG"), _btnTradeEventNavi = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Button_TradeEvent_Navi"), _staticTextTradeEventDesc = nil, _staticTradeEventDown = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Static_TradeEventDown"), _radioBtnShowIcon = nil, _radioBtnShowName = nil, _staticTextSupply = nil, _staticTextSupplyAlert = nil, _staticSupplyBG = nil, _staticTextSupplyTown = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "StaticText_TerritorySupply_Town"), _staticSupplyItemBG = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Static_ItemSlotBG"), _staticSupplyItem = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "Static_ItemSlot"), _staticTextSupplyItemName = (UI.getChildControl)(Panel_TradeEventNotice_Renewal, "StaticText_TerritorySupply_ItemName"), 
...
, 
_tradeEventNpcRegionKey = {[40010] = 5, [40028] = 9, [40715] = 88, [41051] = 32, [41090] = 52, [42005] = 310, [42013] = 311, [42026] = 312, [42301] = 120, [43010] = 107, [44010] = 202, [44110] = 221, [40025] = 16, [41223] = 56, [43449] = 313, [50418] = 110, [50493] = 212}
, 
_supplyNpcRegionKey = {}
, 
_territoryName = {}
, _prevTab = _icon, _supplySpawnType = (CppEnums.SpawnType).eSpawnType_TerritorySupply, _columnNum = 2, _nameColumnNum = 2, _territoryCount = 2, _maxItemCount = 6, _needTradeEventUpdate = true, _needSupplyUpdate = true, _lineGapY = nil, 
_supplyItemCount = {}
, 
_supplyItemKeyList = {}
}
...
PaGlobal_TradeEventNotice_Renewal.InitializeCreateUI = function(self)
  ...
  for terrIndex = 0, self._territoryCount - 1 do
    ...
    for itemIndex = 0, self._maxItemCount - 1 do
      ...
      -- DECOMPILER ERROR at PC227: Confused about usage of register: R13 in 'UnsetPending'
      ...
      -- DECOMPILER ERROR at PC280: Confused about usage of register: R15 in 'UnsetPending'
...
PaGlobal_TradeEventNotice_Renewal.UpdateSupplyInfo = function(self)
  ...
  for terrIndex = 0, self._territoryCount - 1 do
    ...
    if (self._supplyItemCount)[terrIndex] > 0 then
  ...
  if supplyItemWrapper ~= nil then
    ...
    if supplyItemSSW ~= nil then
      if (self._ETabState)._icon == tabState then
        ...
        if (self._ETabState)._name == tabState then
...
PaGlobal_TradeEventNotice_Renewal.HandleClicked_Tab = function(self, tabState)
  ...
  if (self._ETabState)._icon == tabState and (self._ETabState)._icon ~= self._prevTab then
    ...
    do
      if (self._ETabState)._name == tabState and (self._ETabState)._name ~= self._prevTab then
...
FromClient_UpdateTradeEventInfo_TradeEventNotice_Renewal = function()
  -- function num : 0_21
...
FromClient_UpdateSupplyInfo_TradeEventNotice_Renewal = function()
  -- function num : 0_22
  -- DECOMPILER ERROR at PC1: Confused about usage of register: R0 in 'UnsetPending'
...
FromClient_Resize_TradeEventNotice_Renewal = function()
  -- function num : 0_23
  PaGlobal_TradeEventNotice_Renewal:Resize()
end

FGlobal_TradeEventNotice_Renewal_Show = function()
  -- function num : 0_24
  PaGlobal_TradeEventNotice_Renewal:Show()
end

FGlobal_TradeEventNotice_Renewal_Close = function()
  -- function num : 0_25
  PaGlobal_TradeEventNotice_Renewal:Close()
end

FGlobal_TradeEventNotice_Renewal_GetTerritorySupplyIndex = function(itemKey)
  -- function num : 0_26
