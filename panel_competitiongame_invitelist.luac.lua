...
-- Command line: D:\BDO_PazGameData\Unpacked\luacscript\ui_data\x86\window\competitiongame\panel_competitiongame_invitelist.luac 
...
local competitionGame_InviteList = {_btn_Close = (UI.getChildControl)(Panel_CompetitionGame_InviteList, "Button_Close"), _list2 = (UI.getChildControl)(Panel_CompetitionGame_InviteList, "List2_GamescomInviteList")}
CompetitionGame_InviteList_Init = function()
  -- function num : 0_0 , upvalues : competitionGame_InviteList
  local self = competitionGame_InviteList
  ;
  (self._list2):changeAnimationSpeed(10)
  ;
  (self._list2):registEvent((CppEnums.PAUIList2EventType).luaChangeContent, "CompetitionGame_InviteListUpdate")
  ;
...
local selectedKey = -1
CompetitionGame_InviteListUpdate = function(contents, key)
...
CompetitionGame_InviteList_SelectedUpdate = function()
  -- function num : 0_2 , upvalues : competitionGame_InviteList
  local self = competitionGame_InviteList
...
FGlobal_CompetitionGame_InviteList_Open = function()
  -- function num : 0_3 , upvalues : competitionGame_InviteList
  local self = competitionGame_InviteList
  Panel_CompetitionGame_InviteList:SetShow(true)
  CompetitionGame_InviteList_SelectedUpdate()
end

FGlobal_CompetitionGame_InviteList_Close = function()
  -- function num : 0_4
  Panel_CompetitionGame_InviteList:SetShow(false)
end

HandleClicked_CompetitionGame_JoinDecision = function(idx, isAccept)
  -- function num : 0_5
  if idx == nil then
    return 
  end
...
FromClient_UpdateJoinRequesterList = function()
  -- function num : 0_6 , upvalues : competitionGame_InviteList
  local self = competitionGame_InviteList
  CompetitionGame_InviteList_SelectedUpdate()
end

CompetitionGame_InviteList_Event = function()
  -- function num : 0_7
