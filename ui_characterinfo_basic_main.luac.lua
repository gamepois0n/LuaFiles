...
PaGlobal_CharacterInfoBasic = {_player = nil, _playerGet = nil, 
_craftTable = {}
, 
_sortCraftTable = {}
, _requestRank = false, _toolTipCount = 0, 
_fitness = {_stamina = 0, _strength = 1, _health = 2}
, 
_regist = {_sturn = 0, _down = 1, _capture = 2, _knockBack = 3}
, 
_familyPoint = {_family = 0, _combat = 1, _life = 2, _etc = 3}
, 
_potential = {_moveSpeed = 0, _attackSpeed = 1, _critical = 2, _fishTime = 3, _product = 4, _dropChance = 5}
, 
_status = {_health = 0, _mental = 1, _weight = 2}
, 
_ui = {_staticTextPlayerName_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_PlayerName_Value"), _staticTextZodiac_Title = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Zodiac_Title"), _staticTextZodiac_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Zodiac_Value"), _staticTextTendency_Title = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Tendency_Title"), _staticTextTendency_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Tendency_Value"), _staticTextMental_Title = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Mental_Title"), _staticTextMental_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Mental_Value"), _staticTextSkillPoint_Title = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Skill_Title"), _staticTextSkillPoint_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Skill_Value"), _staticTextContribution_Title = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Contribution_Title"), _staticTextContribution_Value = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_Contribution_Value"), 
_staticStatus_Title = {}
, 
_staticStatus_Value = {}
, 
...
, _templetePotentialGradeBg = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Static_PotentialSlotBG"), _templetePotentialPlusGrade = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Static_PotentialSlot"), _templetePotentialMinusGrade = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Static_PotentialMinusSlot"), 
_staticTextFitness_Title = {}
, 
_staticTextFitness_Level = {}
, 
_progress2Fitness = {}
, _staticPlayTimeIcon = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Static_SelfTimerIcon"), _staticTextPlayTime = nil, _multilineEditIntroduce = nil, _buttonIntroduce = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Button_Introduce"), _staticIntroduceBG = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Static_IntroduceBg"), _staticIntroduceBG_Text = nil, _staticTextIntroduce_Title = nil, _multilineEdit = nil, _buttonSetIntroduce = nil, _buttonResetIntroduce = nil, _buttonCloseIntroduce = nil, 
_staticTextFamilyPoints = {}
, _buttonFacePhoto = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Button_FacePhoto"), _staticTextCharacterLevel = nil, _staticCharSlot = nil, _staticClassSymbol = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_ClssIconandLevel"), _staticTextNormalStack = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "StaticText_NormalStack"), _buttonRanker = (UI.getChildControl)(Panel_Window_CharInfo_BasicStatus, "Button_Ranker"), 
_staticCraftIcon = {}
, 
...
PaGlobal_CharacterInfoBasic.initialize = function(self)
  ...
  for index = 0, 10 do
    ...
    (self._craftTable)[index + 1] = {_type = index, _level = 1, _exp = 0, _maxExp = 1}
  end
  ;
...
[CombatType.CombatType_MP] = {"LUA_CHARACTERINFO_TEXT_MP", 2, 64, 232, 69}
, 
[CombatType.CombatType_FP] = {"LUA_CHARACTERINFO_TEXT_FP", 2, 57, 232, 62}
, 
[CombatType.CombatType_EP] = {"LUA_CHARACTERINFO_TEXT_EP", 2, 71, 232, 76}
, 
[CombatType.CombatType_BP] = {"LUA_SELFCHARACTERINFO_BP", 2, 250, 232, 255}
}
  ...
  if UI_Class.ClassType_DarkElf == classType then
    ...
    x1 = setTextureUV_Func(((self._ui)._progress2Status)[(self._status)._mental], 1, 1, 255, 6)
  else
    ...
    -- DECOMPILER ERROR at PC232: Overwrote pending register: R10 in 'AssignReg'

    -- DECOMPILER ERROR at PC233: Overwrote pending register: R9 in 'AssignReg'

    x1 = setTextureUV_Func(((self._ui)._progress2Status)[(self._status)._mental], Texture[2], Texture[3], Texture[4], Texture[5])
  end
  do
    ;
